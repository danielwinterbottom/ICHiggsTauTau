...
opts.register('file', 'file:outputFULLVBFmatchingmJJmany.root', parser.VarParsing.multiplicity.singleton,
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string("EventTreeManyOnlyVBFMatchingMJJ.root"),
...
if release in ['80XMINIAOD']:
  ...
  if isReHLT:
    process.icTriggerPathProducer.input = cms.InputTag("TriggerResults","","TEST")
...
# HOOK
###########
process.icVBFObjectProducer = producers.icTriggerObjectProducer.clone(
   input = cms.InputTag("patTriggerEvent"),
   branch = cms.string("triggerObjectsVBF"),
