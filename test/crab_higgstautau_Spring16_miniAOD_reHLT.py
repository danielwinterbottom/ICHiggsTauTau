...
config.JobType.pyCfgParams = ['release=80XMINIAOD','isData=0','doHT=0', 'globalTag=80X_mcRun2_asymptotic_2016_miniAODv2_v1','isReHLT=1', 'LHEWeights=False']
...
if __name__ == '__main__':
    ...
    for task in tasks:
        ...
        if "GluGluToHToTauTau_M-125" in task[1] or "VBFHToTauTau_M-125" in task[1]:
            config.JobType.pyCfgParams = ['release=80XMINIAOD','isData=0','doHT=0', 'globalTag=80X_mcRun2_asymptotic_2016_miniAODv2_v1','isReHLT=1', 'LHEWeights=True']
        else:
            config.JobType.pyCfgParams = ['release=80XMINIAOD','isData=0','doHT=0', 'globalTag=80X_mcRun2_asymptotic_2016_miniAODv2_v1','isReHLT=1', 'LHEWeights=False']
