...
process.icHLT_DiJet110_35_Mjj650_PFMET110ObjectProducer = producers.icTriggerObjectProducer.clone(
      input   = cms.InputTag("patTriggerEvent"),
      branch = cms.string("triggerObjectsHLT_DiJet110_35_Mjj650_PFMET110_v"),
      hltPath = cms.string("HLT_DiJet110_35_Mjj650_PFMET110_v"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False)
      )  
process.icTriggerObjectSequence += cms.Sequence(
      process.icHLT_DiJet110_35_Mjj650_PFMET110ObjectProducer+
