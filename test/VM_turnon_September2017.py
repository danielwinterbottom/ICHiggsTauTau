...
process.icPFMET120_PFMHT120_IDTightObjectProducer = producers.icTriggerObjectProducer.clone(
    input   = cms.InputTag("selectedPatTrigger"),
    branch = cms.string("PFMET120_PFMHT120_IDTight"),
    hltPath = cms.string("HLT_PFMET120_PFMHT120_IDTight_v"),
    inputIsStandAlone = cms.bool(True),
    storeOnlyIfFired = cms.bool(False)
    )
process.icPFMETNoMu120_PFMHTNoMu120_IDTightObjectProducer = producers.icTriggerObjectProducer.clone(
    input   = cms.InputTag("selectedPatTrigger"),
    branch = cms.string("PFMETNoMu120_PFMHTNoMu120_IDTight"),
    hltPath = cms.string("HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_v"),
    inputIsStandAlone = cms.bool(True),
    storeOnlyIfFired = cms.bool(False)
    )
process.icDiJet110_35_Mjj650_PFMET110ObjectProducer = producers.icTriggerObjectProducer.clone(
    input   = cms.InputTag("selectedPatTrigger"),
    branch = cms.string("DiJet110_35_Mjj650_PFMET110"),
    hltPath = cms.string("HLT_DiJet110_35_Mjj650_PFMET110_v"),
    inputIsStandAlone = cms.bool(True),
    storeOnlyIfFired = cms.bool(False)
    )
process.icTripleJet110_35_35_Mjj650_PFMET110ObjectProducer = producers.icTriggerObjectProducer.clone(
    input   = cms.InputTag("selectedPatTrigger"),
    branch = cms.string("TripleJet110_35_35_Mjj650_PFMET110"),
    hltPath = cms.string("HLT_TripleJet110_35_35_Mjj650_PFMET110_v"),
    inputIsStandAlone = cms.bool(True),
    storeOnlyIfFired = cms.bool(False)
    )
process.icTriggerObjectSequence += cms.Sequence(
    process.icIsoMu27ObjectProducer+
    process.icPFMET120_PFMHT120_IDTightObjectProducer+
    process.icPFMETNoMu120_PFMHTNoMu120_IDTightObjectProducer+
    process.icDiJet110_35_Mjj650_PFMET110ObjectProducer+
    process.icTripleJet110_35_35_Mjj650_PFMET110ObjectProducer
    )
