# /users/adow/VBF_trigger/HLT_VBF_new/V9 (CMSSW_8_0_24)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/adow/VBF_trigger/HLT_VBF_new/V9')
)
...
process.hltCaloJetsCorrectedMatchedToL1 = cms.EDProducer( "HLTCaloJetL1TMatchProducer",
    jetsInput = cms.InputTag( "hltAK4CaloJetsCorrected" ),
...
process.hltPFDoubleJetLooseIDOpen = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( 5.2 ),
...
process.HLT_VBFDiJetExoTau = cms.Path( process.HLTBeginSequence + process.hltL1DiJetVBF + process.hltPreVBFDiJetExoTau + process.HLTAK4CaloJetsSequence + process.hltCaloJetsCorrectedMatchedToL1 + process.hltDoubleJetOpen + process.HLTAK4PFJetsSequence + process.hltPFDoubleJetLooseIDOpen + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_VBFDiJetExoTau, process.HLTriggerFinalPath ))
