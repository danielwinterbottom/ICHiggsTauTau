...
#root://xrootd.unl.edu/
opts.register('file', 'root://xrootd.unl.edu//store/mc/RunIISummer20UL16MiniAOD/VBFHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v13-v3/40000/A08F56AA-BC37-FB40-829C-DBF2C4C8F41C.root', parser.VarParsing.multiplicity.singleton,
...
process.p = cms.Path(
  process.icEventProducer+ # in 12_4 if we dont add EventProducer first then there is a bug where the electrons get added to the next event - not sure how to fix properly but seems to work as long as it comes first in the path - put this first
