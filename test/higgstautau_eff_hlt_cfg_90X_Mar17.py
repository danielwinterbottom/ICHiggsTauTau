...
opts.register('file', 'root://xrootd.grid.hep.ph.ic.ac.uk//store/user/adow/92X_LooseIsosANDREALLYDiTauPath_83XSignalSamples/VBFHToTauTau_M125_13TeV_powheg_pythia8/92X_LooseIsosANDREALLYDiTauPath_83XSignalSamples/170627_161546/0000/outputFULL_291.root', parser.VarParsing.multiplicity.singleton,
...
process.icVBF = producers.icTriggerObjectProducer.clone(
      ...
      hltPath = cms.string("HLT_VBF_LooseChargedIsoPFTau20_Trk1_eta2p1_Reg_v1"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False),
      inputTriggerResults = cms.InputTag("TriggerResults", "", "HLTX")
      )

process.icVBFThree = producers.icTriggerObjectProducer.clone(
      input   = cms.InputTag("patTriggerEvent"),
      branch = cms.string("triggerVBFThree"),
      hltPath = cms.string("HLT_VBF_ThreeJets_LooseChargedIsoPFTau20_Trk1_eta2p1_Reg_v1"),
      #hltPath = cms.string("HLT_VBF_LooseChargedIsoPFTau20_Trk1_TightID_eta2p1_Reg_v1"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False),
      inputTriggerResults = cms.InputTag("TriggerResults", "", "HLTX")
      )
...
process.icHLTDoubleMediumIsoPFTau35 = producers.icTriggerObjectProducer.clone(
      ...
      hltPath = cms.string("HLT_DoubleMediumChargedIsoPFTau35_Trk1_eta2p1_Reg_v3"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False),
      inputTriggerResults = cms.InputTag("TriggerResults", "", "HLTX")
      )
