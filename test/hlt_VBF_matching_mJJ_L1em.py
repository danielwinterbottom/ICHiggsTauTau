# /users/adow/VBF_trigger/HLT_VBF_new/V10 (CMSSW_8_0_24)
...
process.HLT_VBFDiJetExoTau = cms.Path( process.HLTBeginSequence + process.hltL1DiJetVBF + process.hltPreVBFDiJetExoTau + process.HLTAK4CaloJetsSequence + process.hltCaloJetsCorrectedMatchedToL1 + process.hltDoubleJetOpen + process.HLTAK4PFJetsSequence + process.hltDiPFJetOpenMJJOpen + process.HLTEndSequence )
