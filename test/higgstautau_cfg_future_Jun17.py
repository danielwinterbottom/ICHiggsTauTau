...
####'root://cms-xrd-global.cern.ch//store/mc/PhaseIITDRSpring17MiniAOD/VBFHToTauTau_M125_14TeV_powheg_pythia8/MINIAODSIM/noPU_91X_upgrade2023_realistic_v3-v1/10000/1002117D-FA58-E711-9FA5-48FD8E282475.root', parser.VarParsing.multiplicity.singleton,
...
opts.register('file', 'file:out_miniAOD_prod_100.root', parser.VarParsing.multiplicity.singleton,
...
opts.register('globalTag', '91X_upgrade2023_realistic_v3', parser.VarParsing.multiplicity.singleton,
...
#    cms.PSet(
#      record = cms.string('JetCorrectionsRecord'),
#      tag = cms.string('JetCorrectorParametersCollection_PhaseIISummer16_25nsV3_MC_AK4PFchs'),
#      label = cms.untracked.string('AK4PFchs')
#      ),
#    cms.PSet(
#      record = cms.string('JetCorrectionsRecord'),
#      tag = cms.string('JetCorrectorParametersCollection_PhaseIISummer16_25nsV3_MC_AK4PF'),
#      label = cms.untracked.string('AK4PF')
#      ),
#    ),
#    connect = cms.string('sqlite:PhaseIISummer16_25nsV3_MC.db')
#  )
...
#  process.selectedVertices.src = cms.InputTag("offlineSlimmedPrimaryVertices")
  ...
  process.selectedTausOrg = cms.EDFilter("PATTauRefSelector",
      src = cms.InputTag("slimmedTausOrg"),
      cut = cms.string('pt > 18.0 & abs(eta) < 5 & tauID("decayModeFindingNewDMs") > 0.5')
      )
...
if release in ['80XMINIAOD']:
  ...
  process.icTauProducerOrg = cms.EDProducer("ICPFTauFromPatProducer",
    branch                  = cms.string("tausOrg"),
    input                   = cms.InputTag("selectedTausOrg"),
    inputVertices           = vtxLabel,
    includeVertexIP         = cms.bool(True),
    requestTracks           = cms.bool(False),
    tauIDs = cms.PSet(),
...
#     process.pfchs+
     ...
     #process.patJetCorrFactorsUpdatedJECPuppi+
     #process.updatedPatJetsUpdatedJEC+
     #process.updatedPatJetsUpdatedJECPuppi+
...
#runMetCorAndUncFromMiniAOD(process, isData=False,metType='Puppi',postfix='puppi')
...
#                           )
  ...
  process.icGenMetProducer = producers.icMetFromPatProducer.clone(
                           branch = cms.string("GenMetFromSlimmed"),
                           getUncorrectedMet=cms.bool(False),
...
process.icPfMetSequence = cms.Sequence(
  process.pfMetRe+
  #process.runMetCorAndUncFromMiniAOD+ 
