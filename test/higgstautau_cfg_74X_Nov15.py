...
#opts.register('file',
'root://xrootd.unl.edu//store/mc/RunIISpring15MiniAODv2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/MINIAODSIM/74X_mcRun2_asymptotic_v2-v1/50000/02CD8A95-736F-E511-B76E-00266CFFBF34.root',parser.VarParsing.multiplicity.singleton,
...
process.icEle22GsfObjectProducer = producers.icTriggerObjectProducer.clone(
      ...
      hltPath = cms.string("HLT_Ele22_eta2p1_WP75_Gsf_v"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False)
      )
...
process.icIsoMu16CaloMetObjectProducer = producers.icTriggerObjectProducer.clone(
      ...
      hltPath = cms.string("HLT_IsoMu16_eta2p1_CaloMET30_v"),
      inputIsStandAlone = cms.bool(False),
      storeOnlyIfFired = cms.bool(False)
      )
