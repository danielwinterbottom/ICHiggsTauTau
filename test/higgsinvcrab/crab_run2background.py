...
config.General.workArea='Apr14/MC'
#config.General.requestName = 'Apr14/MC'
config.section_('JobType')
config.JobType.psetName = '/vols/cms04/pjd12/invcmssws/CMSSW_7_2_2/src/UserCode/ICHiggsTauTau/test/new_7_2_X_cfg.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['EventTree.root']
config.JobType.pyCfgParams = ['isData=0', 'release=53X']
...
if __name__ == '__main__':
    ...
    tasks=list()
    tasks.append(('Powheg-Htoinv-mH125','/VBF_HToInv_M-125_13TeV_powheg-pythia6/Phys14DR-AVE30BX50_tsg_PHYS14_ST_V1-v2/MINIAODSIM'))
