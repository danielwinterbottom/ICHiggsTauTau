...
prod ='160704'     #!!TO BE UPDATED ON EACH PROCESSING
...
#            crabCommand('status')
    ...
    ### inclusiveDecays version exixts as well but *not* for ST_t-channel_top_4f_ , so i decided to take only leptonDecays 
    ...
    tasks.append(('TT-powheg','/TT_TuneCUETP8M1_13TeV-powheg-pythia8/RunIISpring16MiniAODv2-PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext4-v1/MINIAODSIM'))
...
## check frequently if v2-2 is available
...
## check frequently if v2-2 is available     
    ...
    # ZJetsToNuNu
    tasks.append(('ZJetsToNuNu-mg-ht100to200','/ZJetsToNuNu_HT-100To200_13TeV-madgraph/RunIISpring16MiniAODv2-PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext1-v1/MINIAODSIM'))
