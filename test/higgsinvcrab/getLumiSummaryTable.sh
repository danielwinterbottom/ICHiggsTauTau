...
do
    brilcalc lumi --normtag /afs/cern.ch/user/l/lumipro/public/normtag_file/moriond16_normtag.json -i $PROD/DATA/crab_${DATASET}-2015D-$era/results/lumiSummary.json -u /pb > lumiSummary_${PROD}_${DATASET}_${era}.txt
...
#/afs/cern.ch/user/l/lumipro/public/normtag_file/OfflineNormtagV2.json
...
do
    ...
    for era in 16Dec-v1 #05Oct-v1 PromptReco-v4;
    do
	brilcalc lumi --normtag /afs/cern.ch/user/l/lumipro/public/normtag_file/moriond16_normtag.json -i $PROD/DATA/crab_${DATASET}-2015D-$era/results/lumiSummary.json -u /pb --hltpath ${TRIG}"*" > lumiSummary_${PROD}_${DATASET}_${era}_${TRIG}.txt
