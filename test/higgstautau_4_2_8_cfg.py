...
if (release == '42X'):
  ...
  process.metAnalysisSequence=cms.Sequence(process.pfCandsNotInJet+process.pfJetMETcorr+process.pfCandMETcorr+process.pfType1CorrectedMet)
addPfMET(process, 'PF')
...
if release == '42X':
  ...
  process.extra42XSequence += (process.ak5PFJets+process.kt6PFJets+process.recoTauClassicHPSSequence+process.metAnalysisSequence)
