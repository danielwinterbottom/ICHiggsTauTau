...
#print process.pileupJetIdUpdated.dumpConfig() ##WHY IS THIS HERE?
...
process.icL1JetProducer = cms.EDProducer('ICL1TObjectProducer<l1t::Jet>',
  ...
  input = cms.InputTag("caloStage2Digis","Jet","HLT2"),
  doBXloop = cms.bool(v_doBXloop)
)
