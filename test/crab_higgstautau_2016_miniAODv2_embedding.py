...
config.JobType.pyCfgParams = ['release=102XMINIAOD','isData=0', 'globalTag=80X_dataRun2_2016SeptRepro_v7','isReHLT=1','isEmbed=True']
...
if __name__ == '__main__':
    ...
    for task in tasks:
        ...
        if "Run2016H" in task[1]:
            config.JobType.pyCfgParams = ['release=102XMINIAOD','isData=0','globalTag=80X_dataRun2_Prompt_v16','isReHLT=1','isEmbed=True']
        else:
            config.JobType.pyCfgParams = ['release=102XMINIAOD','isData=0','globalTag=80X_dataRun2_2016SeptRepro_v7','isReHLT=1','isEmbed=True']
