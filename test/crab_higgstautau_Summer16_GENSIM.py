...
config.General.workArea='Oct03_MC_80X'
config.section_('JobType')
config.JobType.psetName = 'higgstautau_cfg_80X_GENSIM_Oct17.py'
...
config.Data.outLFNDirBase='/store/user/dwinterb/Oct03_MC_80X/'
