...
config.General.workArea='ICNtuples92xHLT_turnon'
config.section_('JobType')
config.JobType.psetName = 'VM_turnon_September2017.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['EventTree.root']
#config.JobType.inputFiles = ['Spring16_25nsV3_MC.db']
config.JobType.pyCfgParams = ['release=92XMINIAOD','isData=1','doHT=0', 'globalTag=92X_dataRun2_Prompt_v9']
...
config.Data.runRange = '301461,301448,301447,301392'
...
#config.Site.blacklist = ['T2_US_*','T2_UK_London_IC']
...
if __name__ == '__main__':
    ...
    tasks.append(('VBF_HInv_HLT_Turnon','/SingleMuon/Run2017C-PromptReco-v3/MINIAOD'))
