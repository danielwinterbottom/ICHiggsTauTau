...
config.General.workArea='Oct26_MC_80X'
...
config.Data.outLFNDirBase='/store/user/dwinterb/Oct26_MC_80X/'
...
if __name__ == '__main__':
    ...
    # check 120, 130 samples i thik these are called differently for some reason
    ...
    tasks.append(('VBFHToWWTo2L2Nu_M-125','/VBFHToWWTo2L2Nu_M125_13TeV_powheg_JHUgen_pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM/MINIAODSIM'))
