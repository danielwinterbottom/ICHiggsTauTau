# /users/adow/VBF_trigger/HLT_VBF_new/V5 (CMSSW_8_0_24)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/adow/VBF_trigger/HLT_VBF_new/V5')
)
...
process.HLT_VBFDiJetExoTau = cms.Path( process.HLTBeginSequence + process.hltL1DiJetVBF + process.hltPreVBFDiJetExoTau + process.HLTAK4CaloJetsSequence + process.hltDoubleJetOpen + process.HLTAK4PFJetsSequence + process.hltPFDoubleJetLooseIDOpen + process.HLTEndSequence )
