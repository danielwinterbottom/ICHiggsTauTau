...
config.General.workArea='Mar05_Data_76X'
...
config.JobType.pyCfgParams = ['release=76XMINIAOD','isData=1','doHT=0', 'globalTag=76X_dataRun2_16Dec2015_v0']
...
config.Data.outLFNDirBase='/store/user/adewit/Mar05_Data_76X/'
