  ...
  if (fs_ && write_plots_) {
    ...
    if(is_embedded_) {
      ...
      if(channel_==channel::tt) {
        ...
        if(era_ == era::data_2022_preEE || era_ == era::data_2022_postEE) scale_str = "(x-y)*0.885 + y*(1.+-0.004)";
      } else if (channel_==channel::et){
        ...
        if(era_ == era::data_2022_preEE || era_ == era::data_2022_postEE) scale_str = "(x-y)*0.954 + y*(1.+-0.007)";
      } else if (channel_==channel::mt){
        ...
        if(era_ == era::data_2022_preEE || era_ == era::data_2022_postEE) scale_str = "(x-y)*0.952 + y*(1.+0.001)";      
      } else if (channel_==channel::em){
        ...
        if(era_ == era::data_2022_preEE || era_ == era::data_2022_postEE) scale_str = "(x-y)*1.000 + y*(1.+0.000)";      
      }
    } //else {
