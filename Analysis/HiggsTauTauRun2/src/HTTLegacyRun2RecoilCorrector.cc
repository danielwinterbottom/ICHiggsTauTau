#include "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/interface/HTTLegacyRun2RecoilCorrector.h"
...
namespace ic {
  ...
  int HTTLegacyRun2RecoilCorrector::PreAnalysis() {
    ...
    if (strategy_ ==strategy::fall15){
      ...
      if (use_puppimet_) {
        process_file = "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/input/recoilfits/Type1_PuppiMET_2016.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/input/recoilfits/PuppiMETSys_2016.root";
      }
      ...
      if(met_label_ == "pfMET"){
        ...
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/input/recoilfits/PFMETSys_2018.root"; 
      }
      if (use_puppimet_){
        process_file = "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/input/recoilfits/Type1_PuppiMET_2018.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/input/recoilfits/PuppiMETSys_2018.root";
      }
    } else{
