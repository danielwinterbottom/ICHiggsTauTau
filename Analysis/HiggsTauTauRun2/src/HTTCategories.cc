...
namespace ic {
  ...
  int HTTCategories::PreAnalysis() {
	...
	outtree_->Branch("wt_tau_trg_mvadm1_down",  &wt_tau_trg_mvadm1_down_);
     ...
     if(do_qcd_scale_wts_){
      ...
      outtree_->Branch("wt_vlq_gU_0p1",&wt_vlq_gU_0p1_);
      outtree_->Branch("wt_vlq_gU_0p2",&wt_vlq_gU_0p2_);
      outtree_->Branch("wt_vlq_gU_0p3",&wt_vlq_gU_0p3_);
      outtree_->Branch("wt_vlq_gU_0p4",&wt_vlq_gU_0p4_);
      outtree_->Branch("wt_vlq_gU_0p5",&wt_vlq_gU_0p5_);
      outtree_->Branch("wt_vlq_gU_0p6",&wt_vlq_gU_0p6_);
      outtree_->Branch("wt_vlq_gU_0p7",&wt_vlq_gU_0p7_);
      outtree_->Branch("wt_vlq_gU_0p8",&wt_vlq_gU_0p8_);
      outtree_->Branch("wt_vlq_gU_0p9",&wt_vlq_gU_0p9_);
      outtree_->Branch("wt_vlq_gU_1p0",&wt_vlq_gU_1p0_);
      outtree_->Branch("wt_vlq_gU_1p1",&wt_vlq_gU_1p1_);
      outtree_->Branch("wt_vlq_gU_1p2",&wt_vlq_gU_1p2_);
      outtree_->Branch("wt_vlq_gU_1p3",&wt_vlq_gU_1p3_);
      outtree_->Branch("wt_vlq_gU_1p4",&wt_vlq_gU_1p4_);
      outtree_->Branch("wt_vlq_gU_1p5",&wt_vlq_gU_1p5_);
      outtree_->Branch("wt_vlq_gU_1p6",&wt_vlq_gU_1p6_);
      outtree_->Branch("wt_vlq_gU_1p7",&wt_vlq_gU_1p7_);
      outtree_->Branch("wt_vlq_gU_1p8",&wt_vlq_gU_1p8_);
      outtree_->Branch("wt_vlq_gU_1p9",&wt_vlq_gU_1p9_);
      outtree_->Branch("wt_vlq_gU_2p0",&wt_vlq_gU_2p0_);
      outtree_->Branch("wt_vlq_gU_2p1",&wt_vlq_gU_2p1_);
      outtree_->Branch("wt_vlq_gU_2p2",&wt_vlq_gU_2p2_);
      outtree_->Branch("wt_vlq_gU_2p3",&wt_vlq_gU_2p3_);
      outtree_->Branch("wt_vlq_gU_2p4",&wt_vlq_gU_2p4_);
      outtree_->Branch("wt_vlq_gU_2p5",&wt_vlq_gU_2p5_);
      outtree_->Branch("wt_vlq_gU_2p6",&wt_vlq_gU_2p6_);
      outtree_->Branch("wt_vlq_gU_2p7",&wt_vlq_gU_2p7_);
      outtree_->Branch("wt_vlq_gU_2p8",&wt_vlq_gU_2p8_);
      outtree_->Branch("wt_vlq_gU_2p9",&wt_vlq_gU_2p9_);
      outtree_->Branch("wt_vlq_gU_3p0",&wt_vlq_gU_3p0_);
      outtree_->Branch("wt_vlq_gU_3p1",&wt_vlq_gU_3p1_);
      outtree_->Branch("wt_vlq_gU_3p2",&wt_vlq_gU_3p2_);
      outtree_->Branch("wt_vlq_gU_3p3",&wt_vlq_gU_3p3_);
      outtree_->Branch("wt_vlq_gU_3p4",&wt_vlq_gU_3p4_);
      outtree_->Branch("wt_vlq_gU_3p5",&wt_vlq_gU_3p5_);
      outtree_->Branch("wt_vlq_gU_3p6",&wt_vlq_gU_3p6_);
      outtree_->Branch("wt_vlq_gU_3p7",&wt_vlq_gU_3p7_);
      outtree_->Branch("wt_vlq_gU_3p8",&wt_vlq_gU_3p8_);
      outtree_->Branch("wt_vlq_gU_3p9",&wt_vlq_gU_3p9_);
      outtree_->Branch("wt_vlq_gU_4p0",&wt_vlq_gU_4p0_);
      outtree_->Branch("wt_vlq_gU_5p0",&wt_vlq_gU_5p0_);
      outtree_->Branch("wt_vlq_gU_10p0",&wt_vlq_gU_10p0_);
      outtree_->Branch("wt_vlq_2320",&wt_vlq_2320_);
      outtree_->Branch("wt_vlq_2319",&wt_vlq_2319_);
      ...
      outtree_->Branch("deepTauVsJet_iso_1",       &deepTauVsJet_iso_1_);
      outtree_->Branch("deepTauVsJet_iso_2",       &deepTauVsJet_iso_2_);
  ...
  int HTTCategories::Execute(TreeEvent *event) {
   ...
   if(do_qcd_scale_wts_){
    ...
    if(event->Exists("count_s")) count_s_ = event->Get<int>("count_s");
   ...
   if (event->Exists("svfitMT")){
    ...
    //  deepTauVsJet_iso_1_      = muon1->HasTauID("byDeepTau2017v2p1VSjetraw")      ? muon1->GetTauID("byDeepTau2017v2p1VSjetraw"):      0.;
    //  deepTauVsEle_iso_1_       = muon1->HasTauID("byDeepTau2017v2p1VSeraw")        ? muon1->GetTauID("byDeepTau2017v2p1VSeraw"):        0.;
    //  deepTauVsMu_iso_1_        = muon1->HasTauID("byDeepTau2017v2p1VSmuraw")       ? muon1->GetTauID("byDeepTau2017v2p1VSmuraw"):        0.;
    //  deepTauVsJet_iso_2_      = muon2->HasTauID("byDeepTau2017v2p1VSjetraw")      ? muon2->GetTauID("byDeepTau2017v2p1VSjetraw"):      0.;
    //  deepTauVsEle_iso_2_       = muon2->HasTauID("byDeepTau2017v2p1VSeraw")        ? muon2->GetTauID("byDeepTau2017v2p1VSeraw"):        0.;
    //  deepTauVsMu_iso_2_        = muon2->HasTauID("byDeepTau2017v2p1VSmuraw")       ? muon2->GetTauID("byDeepTau2017v2p1VSmuraw"):        0.;
    //}
    ...
    wt_vlq_betaL32_1sigma_down_=1.; wt_vlq_betaL23_2sigma_up_=1.; wt_vlq_betaL23_2sigma_down_=1.;
    wt_vlq_betaR33_0_=1.; wt_vlq_betaR33_minus1_=1.;
    wt_vlq_gU_0p1_=1.; wt_vlq_gU_0p2_=1.; wt_vlq_gU_0p3_=1.; wt_vlq_gU_0p4_=1.; wt_vlq_gU_0p5_=1.;
    wt_vlq_gU_0p6_=1.; wt_vlq_gU_0p7_=1.; wt_vlq_gU_0p8_=1.; wt_vlq_gU_0p9_=1.; wt_vlq_gU_1p0_=1.;
    wt_vlq_gU_1p1_=1.; wt_vlq_gU_1p2_=1.; wt_vlq_gU_1p3_=1.; wt_vlq_gU_1p4_=1.; wt_vlq_gU_1p5_=1.;
    wt_vlq_gU_1p6_=1.; wt_vlq_gU_1p7_=1.; wt_vlq_gU_1p8_=1.; wt_vlq_gU_1p9_=1.; wt_vlq_gU_2p0_=1.;
    wt_vlq_gU_2p1_=1.; wt_vlq_gU_2p2_=1.; wt_vlq_gU_2p3_=1.; wt_vlq_gU_2p4_=1.; wt_vlq_gU_2p5_=1.;
    wt_vlq_gU_2p6_=1.; wt_vlq_gU_2p7_=1.; wt_vlq_gU_2p8_=1.; wt_vlq_gU_2p9_=1.; wt_vlq_gU_3p0_=1.;
    wt_vlq_gU_3p1_=1.; wt_vlq_gU_3p2_=1.; wt_vlq_gU_3p3_=1.; wt_vlq_gU_3p4_=1.; wt_vlq_gU_3p5_=1.;
    wt_vlq_gU_3p6_=1.; wt_vlq_gU_3p7_=1.; wt_vlq_gU_3p8_=1.; wt_vlq_gU_3p9_=1.; wt_vlq_gU_4p0_=1.;
    wt_vlq_gU_5p0_=1.; wt_vlq_gU_10p0_=1.; wt_vlq_2320_=1.; wt_vlq_2319_=1;
    ...
    if(eventInfo->weight_defined("off_diag_0")) {
      ...
      if(eventInfo->weight_defined("gU_0p1")) wt_vlq_gU_0p1_ = eventInfo->weight("gU_0p1");
      if(eventInfo->weight_defined("gU_0p2")) wt_vlq_gU_0p2_ = eventInfo->weight("gU_0p2");
      if(eventInfo->weight_defined("gU_0p3")) wt_vlq_gU_0p3_ = eventInfo->weight("gU_0p3");
      if(eventInfo->weight_defined("gU_0p4")) wt_vlq_gU_0p4_ = eventInfo->weight("gU_0p4");
      if(eventInfo->weight_defined("gU_0p5")) wt_vlq_gU_0p5_ = eventInfo->weight("gU_0p5");
      if(eventInfo->weight_defined("gU_0p6")) wt_vlq_gU_0p6_ = eventInfo->weight("gU_0p6");
      if(eventInfo->weight_defined("gU_0p7")) wt_vlq_gU_0p7_ = eventInfo->weight("gU_0p7");
      if(eventInfo->weight_defined("gU_0p8")) wt_vlq_gU_0p8_ = eventInfo->weight("gU_0p8");
      if(eventInfo->weight_defined("gU_0p9")) wt_vlq_gU_0p9_ = eventInfo->weight("gU_0p9");
      if(eventInfo->weight_defined("gU_1p0")) wt_vlq_gU_1p0_ = eventInfo->weight("gU_1p0");
      if(eventInfo->weight_defined("gU_1p1")) wt_vlq_gU_1p1_ = eventInfo->weight("gU_1p1");
      if(eventInfo->weight_defined("gU_1p2")) wt_vlq_gU_1p2_ = eventInfo->weight("gU_1p2");
      if(eventInfo->weight_defined("gU_1p3")) wt_vlq_gU_1p3_ = eventInfo->weight("gU_1p3");
      if(eventInfo->weight_defined("gU_1p4")) wt_vlq_gU_1p4_ = eventInfo->weight("gU_1p4");
      if(eventInfo->weight_defined("gU_1p5")) wt_vlq_gU_1p5_ = eventInfo->weight("gU_1p5");
      if(eventInfo->weight_defined("gU_1p6")) wt_vlq_gU_1p6_ = eventInfo->weight("gU_1p6");
      if(eventInfo->weight_defined("gU_1p7")) wt_vlq_gU_1p7_ = eventInfo->weight("gU_1p7");
      if(eventInfo->weight_defined("gU_1p8")) wt_vlq_gU_1p8_ = eventInfo->weight("gU_1p8");
      if(eventInfo->weight_defined("gU_1p9")) wt_vlq_gU_1p9_ = eventInfo->weight("gU_1p9");
      if(eventInfo->weight_defined("gU_2p0")) wt_vlq_gU_2p0_ = eventInfo->weight("gU_2p0");
      if(eventInfo->weight_defined("gU_2p1")) wt_vlq_gU_2p1_ = eventInfo->weight("gU_2p1");
      if(eventInfo->weight_defined("gU_2p2")) wt_vlq_gU_2p2_ = eventInfo->weight("gU_2p2");
      if(eventInfo->weight_defined("gU_2p3")) wt_vlq_gU_2p3_ = eventInfo->weight("gU_2p3");
      if(eventInfo->weight_defined("gU_2p4")) wt_vlq_gU_2p4_ = eventInfo->weight("gU_2p4");
      if(eventInfo->weight_defined("gU_2p5")) wt_vlq_gU_2p5_ = eventInfo->weight("gU_2p5");
      if(eventInfo->weight_defined("gU_2p6")) wt_vlq_gU_2p6_ = eventInfo->weight("gU_2p6");
      if(eventInfo->weight_defined("gU_2p7")) wt_vlq_gU_2p7_ = eventInfo->weight("gU_2p7");
      if(eventInfo->weight_defined("gU_2p8")) wt_vlq_gU_2p8_ = eventInfo->weight("gU_2p8");
      if(eventInfo->weight_defined("gU_2p9")) wt_vlq_gU_2p9_ = eventInfo->weight("gU_2p9");
      if(eventInfo->weight_defined("gU_3p0")) wt_vlq_gU_3p0_ = eventInfo->weight("gU_3p0");
      if(eventInfo->weight_defined("gU_3p1")) wt_vlq_gU_3p1_ = eventInfo->weight("gU_3p1");
      if(eventInfo->weight_defined("gU_3p2")) wt_vlq_gU_3p2_ = eventInfo->weight("gU_3p2");
      if(eventInfo->weight_defined("gU_3p3")) wt_vlq_gU_3p3_ = eventInfo->weight("gU_3p3");
      if(eventInfo->weight_defined("gU_3p4")) wt_vlq_gU_3p4_ = eventInfo->weight("gU_3p4");
      if(eventInfo->weight_defined("gU_3p5")) wt_vlq_gU_3p5_ = eventInfo->weight("gU_3p5");
      if(eventInfo->weight_defined("gU_3p6")) wt_vlq_gU_3p6_ = eventInfo->weight("gU_3p6");
      if(eventInfo->weight_defined("gU_3p7")) wt_vlq_gU_3p7_ = eventInfo->weight("gU_3p7");
      if(eventInfo->weight_defined("gU_3p8")) wt_vlq_gU_3p8_ = eventInfo->weight("gU_3p8");
      if(eventInfo->weight_defined("gU_3p9")) wt_vlq_gU_3p9_ = eventInfo->weight("gU_3p9");
      if(eventInfo->weight_defined("gU_4p0")) wt_vlq_gU_4p0_ = eventInfo->weight("gU_4p0");
      if(eventInfo->weight_defined("gU_5p0")) wt_vlq_gU_5p0_ = eventInfo->weight("gU_5p0");
      if(eventInfo->weight_defined("gU_10p0")) wt_vlq_gU_10p0_ = eventInfo->weight("gU_10p0");
      if(eventInfo->weight_defined("2320")) wt_vlq_2320_ = eventInfo->weight("2320");
      if(eventInfo->weight_defined("2319")) wt_vlq_2319_ = eventInfo->weight("2319");
