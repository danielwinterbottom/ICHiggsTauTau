...
namespace ic {
  ...
  int HTTFakeFactorWeights::PreAnalysis() {
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16 || strategy_ == strategy::cpdecays17 ) && channel_==channel::tt) {
      ...
      if(strategy_==strategy::legacy16) mssm_file_ = "input/fake_factors/fakefactors_ws_tt_mssm_2016_v3.root";
      if(strategy_==strategy::cpdecays17) mssm_file_ = "input/fake_factors/fakefactors_ws_tt_mssm_2017_v3.root";
      if(strategy_==strategy::cpdecays18) mssm_file_ = "input/fake_factors/fakefactors_ws_tt_mssm_2018_v3.root";
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16||strategy_==strategy::cpdecays17) && (channel_==channel::mt)) {
      ...
      std::string mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2016_v3.root";
      if(strategy_==strategy::legacy16) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2016_v3.root";
      if(strategy_==strategy::cpdecays17) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2017_v3.root";
      if(strategy_==strategy::cpdecays18) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2018_v3.root";
      TFile f_mssm((baseDir+"UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/"+mssm_file_).c_str());
