#include "UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/interface/HTTFakeFactorWeights.h"
...
namespace ic {
  ...
  int HTTFakeFactorWeights::PreAnalysis() {
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16 || strategy_ == strategy::cpdecays17 ) && channel_==channel::tt) {
      ...
      // load HPS DM binned fake factors

      std::string hps_file_ = "input/fake_factors/fakefactors_ws_tt_hps_lite_2016.root";
      if(strategy_==strategy::cpdecays17) hps_file_ = "input/fake_factors/fakefactors_ws_tt_hps_lite_2017.root";
      if(strategy_==strategy::cpdecays18) hps_file_ = "input/fake_factors/fakefactors_ws_tt_hps_lite_2018.root";
      TFile f_dm((baseDir+"UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/"+hps_file_).c_str());

      ff_ws_dm_ = std::shared_ptr<RooWorkspace>((RooWorkspace*)gDirectory->Get("w"));
      f_dm.Close();
      ...
      systs_mssm_ = {"","_qcd_syst_up", "_qcd_syst_down","_wjets_syst_up", "_wjets_syst_down", "_ttbar_syst_up", "_ttbar_syst_down",
                     "_qcd_stat_dR_unc1_up", "_qcd_stat_dR_unc1_down", "_qcd_stat_dR_unc2_up", "_qcd_stat_dR_unc2_down", "_qcd_stat_pt_unc1_up", "_qcd_stat_pt_unc1_down", "_qcd_stat_pt_unc2_up", "_qcd_stat_pt_unc2_down","_qcd_stat_njet0_jet_pt_low_unc1_up","_qcd_stat_njet0_jet_pt_low_unc1_down","_qcd_stat_njet0_jet_pt_low_unc2_up","_qcd_stat_njet0_jet_pt_low_unc2_down","_qcd_stat_njet0_jet_pt_low_unc3_up","_qcd_stat_njet0_jet_pt_low_unc3_down","_qcd_stat_njet0_jet_pt_high_unc1_up","_qcd_stat_njet0_jet_pt_high_unc1_down","_qcd_stat_njet0_jet_pt_high_unc2_up","_qcd_stat_njet0_jet_pt_high_unc2_down","_qcd_stat_njet0_jet_pt_high_unc3_up","_qcd_stat_njet0_jet_pt_high_unc3_down","_qcd_stat_njet1_jet_pt_low_unc1_up","_qcd_stat_njet1_jet_pt_low_unc1_down","_qcd_stat_njet1_jet_pt_low_unc2_up","_qcd_stat_njet1_jet_pt_low_unc2_down","_qcd_stat_njet1_jet_pt_low_unc3_up","_qcd_stat_njet1_jet_pt_low_unc3_down","_qcd_stat_njet1_jet_pt_high_unc1_up","_qcd_stat_njet1_jet_pt_high_unc1_down","_qcd_stat_njet1_jet_pt_high_unc2_up","_qcd_stat_njet1_jet_pt_high_unc2_down","_qcd_stat_njet1_jet_pt_high_unc3_up","_qcd_stat_njet1_jet_pt_high_unc3_down","_qcd_stat_njet0_jet_pt_med_unc1_up","_qcd_stat_njet0_jet_pt_med_unc1_down","_qcd_stat_njet0_jet_pt_med_unc2_up","_qcd_stat_njet0_jet_pt_med_unc2_down","_qcd_stat_njet0_jet_pt_med_unc3_up","_qcd_stat_njet0_jet_pt_med_unc3_down","_qcd_stat_njet1_jet_pt_med_unc1_up","_qcd_stat_njet1_jet_pt_med_unc1_down","_qcd_stat_njet1_jet_pt_med_unc2_up","_qcd_stat_njet1_jet_pt_med_unc2_down","_qcd_stat_njet1_jet_pt_med_unc3_up","_qcd_stat_njet1_jet_pt_med_unc3_down",
      "_syst_alt_func_up","_syst_alt_func_down","_qcd_syst_pt_2_closure_up","_qcd_syst_pt_2_closure_down","_qcd_syst_met_closure_up","_qcd_syst_met_closure_down","_qcd_syst_dr_closure_up","_qcd_syst_dr_closure_down"
};
      ...
      for(auto s : systs_mssm_) {
        fns_["ff_total"+s] = std::shared_ptr<RooFunctor>(
              ff_ws_mssm_->function(("ff_total"+s).c_str())->functor(ff_ws_mssm_->argSet("pt,jetpt,njets,nbjets,dR,os,pt_2,met")));
      }
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16||strategy_==strategy::cpdecays17) && (channel_==channel::mt)) {
      ...
      systs_dm_ = {"","_wjets_syst_up","_wjets_syst_down","_wjets_met_up","_wjets_met_down","_wjets_l_pt_up","_wjets_l_pt_down","_wjets_stat_unc1_njet0_dm0_up","_wjets_stat_unc2_njet0_dm0_up","_wjets_stat_unc1_njet0_dm0_down","_wjets_stat_unc2_njet0_dm0_down","_wjets_stat_unc1_njet1_dm0_up","_wjets_stat_unc2_njet1_dm0_up","_wjets_stat_unc1_njet1_dm0_down","_wjets_stat_unc2_njet1_dm0_down","_wjets_stat_unc1_njet2_dm0_up","_wjets_stat_unc2_njet2_dm0_up","_wjets_stat_unc1_njet2_dm0_down","_wjets_stat_unc2_njet2_dm0_down","_wjets_stat_unc1_njet0_dm1_up","_wjets_stat_unc2_njet0_dm1_up","_wjets_stat_unc1_njet0_dm1_down","_wjets_stat_unc2_njet0_dm1_down","_wjets_stat_unc1_njet1_dm1_up","_wjets_stat_unc2_njet1_dm1_up","_wjets_stat_unc1_njet1_dm1_down","_wjets_stat_unc2_njet1_dm1_down","_wjets_stat_unc1_njet2_dm1_up","_wjets_stat_unc2_njet2_dm1_up","_wjets_stat_unc1_njet2_dm1_down","_wjets_stat_unc2_njet2_dm1_down","_wjets_stat_unc1_njet0_dm10_up","_wjets_stat_unc2_njet0_dm10_up","_wjets_stat_unc1_njet0_dm10_down","_wjets_stat_unc2_njet0_dm10_down","_wjets_stat_unc1_njet1_dm10_up","_wjets_stat_unc2_njet1_dm10_up","_wjets_stat_unc1_njet1_dm10_down","_wjets_stat_unc2_njet1_dm10_down","_wjets_stat_unc1_njet2_dm10_up","_wjets_stat_unc2_njet2_dm10_up","_wjets_stat_unc1_njet2_dm10_down","_wjets_stat_unc2_njet2_dm10_down","_wjets_stat_unc1_njet0_dm11_up","_wjets_stat_unc2_njet0_dm11_up","_wjets_stat_unc1_njet0_dm11_down","_wjets_stat_unc2_njet0_dm11_down","_wjets_stat_unc1_njet1_dm11_up","_wjets_stat_unc2_njet1_dm11_up","_wjets_stat_unc1_njet1_dm11_down","_wjets_stat_unc2_njet1_dm11_down","_wjets_stat_unc1_njet2_dm11_up","_wjets_stat_unc2_njet2_dm11_up","_wjets_stat_unc1_njet2_dm11_down","_wjets_stat_unc2_njet2_dm11_down","_qcd_syst_up","_qcd_syst_down","_qcd_met_up","_qcd_met_down","_qcd_l_pt_up","_qcd_l_pt_down","_qcd_stat_unc1_njet0_dm0_up","_qcd_stat_unc2_njet0_dm0_up","_qcd_stat_unc1_njet0_dm0_down","_qcd_stat_unc2_njet0_dm0_down","_qcd_stat_unc1_njet1_dm0_up","_qcd_stat_unc2_njet1_dm0_up","_qcd_stat_unc1_njet1_dm0_down","_qcd_stat_unc2_njet1_dm0_down","_qcd_stat_unc1_njet2_dm0_up","_qcd_stat_unc2_njet2_dm0_up","_qcd_stat_unc1_njet2_dm0_down","_qcd_stat_unc2_njet2_dm0_down","_qcd_stat_unc1_njet0_dm1_up","_qcd_stat_unc2_njet0_dm1_up","_qcd_stat_unc1_njet0_dm1_down","_qcd_stat_unc2_njet0_dm1_down","_qcd_stat_unc1_njet1_dm1_up","_qcd_stat_unc2_njet1_dm1_up","_qcd_stat_unc1_njet1_dm1_down","_qcd_stat_unc2_njet1_dm1_down","_qcd_stat_unc1_njet2_dm1_up","_qcd_stat_unc2_njet2_dm1_up","_qcd_stat_unc1_njet2_dm1_down","_qcd_stat_unc2_njet2_dm1_down","_qcd_stat_unc1_njet0_dm10_up","_qcd_stat_unc2_njet0_dm10_up","_qcd_stat_unc1_njet0_dm10_down","_qcd_stat_unc2_njet0_dm10_down","_qcd_stat_unc1_njet1_dm10_up","_qcd_stat_unc2_njet1_dm10_up","_qcd_stat_unc1_njet1_dm10_down","_qcd_stat_unc2_njet1_dm10_down","_qcd_stat_unc1_njet2_dm10_up","_qcd_stat_unc2_njet2_dm10_up","_qcd_stat_unc1_njet2_dm10_down","_qcd_stat_unc2_njet2_dm10_down","_qcd_stat_unc1_njet0_dm11_up","_qcd_stat_unc2_njet0_dm11_up","_qcd_stat_unc1_njet0_dm11_down","_qcd_stat_unc2_njet0_dm11_down","_qcd_stat_unc1_njet1_dm11_up","_qcd_stat_unc2_njet1_dm11_up","_qcd_stat_unc1_njet1_dm11_down","_qcd_stat_unc2_njet1_dm11_down","_qcd_stat_unc1_njet2_dm11_up","_qcd_stat_unc2_njet2_dm11_up","_qcd_stat_unc1_njet2_dm11_down","_qcd_stat_unc2_njet2_dm11_down","_ttbar_syst_up","_ttbar_syst_down","_ttbar_met_up","_ttbar_met_down"};
      ...
      std::string hps_file_ = "input/fake_factors/fakefactors_ws_mt_hps_lite_2016.root";
      if(strategy_==strategy::cpdecays17) hps_file_ = "input/fake_factors/fakefactors_ws_mt_hps_lite_2017.root";
      if(strategy_==strategy::cpdecays18) hps_file_ = "input/fake_factors/fakefactors_ws_mt_hps_lite_2018.root";
      TFile f_dm((baseDir+"UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/"+hps_file_).c_str());
      ...
      for(auto s : systs_dm_) {
        fns_["ff_lt_medium_dmbins"+s] = std::shared_ptr<RooFunctor>(
              ff_ws_dm_->function(("ff_mt_medium_dmbins"+s).c_str())->functor(ff_ws_dm_->argSet("pt,dm,njets,m_pt,os,met_var_qcd,met_var_w,mt,m_iso,pass_single,mvis,WpT,wjets_frac,qcd_frac,ttbar_frac")));
      }
      ...
      if(strategy_==strategy::legacy16) {
        if(era_ == era::data_2016) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2016_v6.root";
        if(era_ == era::data_2016UL_preVFP) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_UL_2016_preVFP.root";
        if(era_ == era::data_2016UL_postVFP) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_UL_2016_postVFP.root";
      }
      if(strategy_==strategy::cpdecays17) {
        if(era_ == era::data_2017) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_mssm_2017_v6.root";
        if(era_ == era::data_2017UL) mssm_file_ = "input/fake_factors/fakefactors_ws_mt_UL_2017.root";
      }
      if(strategy_==strategy::cpdecays18) {
...
//              ff_ws_->function(("ff_et_medium_mvadmbins"+s).c_str())->functor(ff_ws_->argSet("pt,mvadm,ipsig,njets,e_pt,os,met_var_qcd,met_var_w,mt,e_iso,pass_single,mvis,wjets_frac,qcd_frac,ttbar_frac")));   
      ...
      std::string hps_file_ = "input/fake_factors/fakefactors_ws_et_hps_lite_2016.root";
      if(strategy_==strategy::cpdecays17) hps_file_ = "input/fake_factors/fakefactors_ws_et_hps_lite_2017.root";
      if(strategy_==strategy::cpdecays18) hps_file_ = "input/fake_factors/fakefactors_ws_et_hps_lite_2018.root";
      TFile f_dm((baseDir+"UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/"+hps_file_).c_str());
      ...
      for(auto s : systs_dm_) {
        fns_["ff_lt_medium_dmbins"+s] = std::shared_ptr<RooFunctor>(
              ff_ws_dm_->function(("ff_et_medium_dmbins"+s).c_str())->functor(ff_ws_dm_->argSet("pt,dm,njets,e_pt,os,met_var_qcd,met_var_w,mt,e_iso,pass_single,mvis,WpT,wjets_frac,qcd_frac,ttbar_frac")));
      }
      fns_["ff_lt_medium_mvadmbins_qcd"] = std::shared_ptr<RooFunctor>(
      ...
      if(strategy_==strategy::legacy16) {
        if(era_ == era::data_2016) mssm_file_ = "input/fake_factors/fakefactors_ws_et_mssm_2016_v6.root";
        if(era_ == era::data_2016UL_preVFP) mssm_file_ = "input/fake_factors/fakefactors_ws_et_UL_2016_preVFP.root";
        if(era_ == era::data_2016UL_postVFP) mssm_file_ = "input/fake_factors/fakefactors_ws_et_UL_2016_postVFP.root";
      }
      if(strategy_==strategy::cpdecays17) {
        if(era_ == era::data_2017) mssm_file_ = "input/fake_factors/fakefactors_ws_et_mssm_2017_v6.root";
        if(era_ == era::data_2017UL) mssm_file_ = "input/fake_factors/fakefactors_ws_et_UL_2017.root";
      }
      if(strategy_==strategy::cpdecays18) {
  ...
  int HTTFakeFactorWeights::Execute(TreeEvent *event) {
    ...
    m_vis_ = ditau->M();
    mt_1_ = MT(lep1, met);
    mt_tot_ = sqrt(pow(MT(lep1, met),2) + pow(MT(lep2, met),2) + pow(MT(lep1, lep2),2));

    double met_var_qcd = met->pt()*cos(ROOT::Math::VectorUtil::DeltaPhi(met->vector(),lep2->vector()))/pt_2_;
    double met_var_qcd_tt = met->pt()*cos(ROOT::Math::VectorUtil::DeltaPhi(met->vector(),lep1->vector()))/pt_1_;
      ...
      if(channel_ == channel::et || channel_ == channel::mt){
        ...
        if(strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays18 || strategy_ == strategy::legacy16) {
          ...
          if(channel_==channel::mt) {
            ...
            if(strategy_==strategy::legacy16) {
              if(pt_1_<23) pass_single=0.;
            } else {
              if(pt_1_<25) pass_single=0.;
            }
          }
          ...
          event->Add("w_frac",  w_frac);
          event->Add("qcd_frac",  qcd_frac);
          event->Add("ttbar_frac",  ttbar_frac);
          ...
          //auto args_ttbar = std::vector<double>{pt_2_,mva_dm_2_,ipsig,n_jets_,met_var_w};
          ...
          auto args_mssm = std::vector<double>{pt_2_, jet_pt_2_, n_prebjets_, n_deepbjets_, os, pt_1_, met_var_qcd, met_var_w, mt_1_, iso_1_,mt_tot_};
        ...
        if(strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays18 || strategy_ == strategy::legacy16) { 
          ...
          double dR = std::fabs(ROOT::Math::VectorUtil::DeltaR(lep1->vector(),lep2->vector())); 

          auto args_dm = std::vector<double>{pt_1_,tau_decaymode_1_,n_jets_,os,met_var_qcd_tt,dR};
          ff_nom = fns_["ff_tt_medium_dmbins"]->eval(args_dm.data());
          event->Add("wt_ff_dmbins_1",  ff_nom);
          auto args_dm_2 = std::vector<double>{pt_2_,tau_decaymode_2_,n_jets_,0.,met_var_qcd_tt,dR}; // we are using this FF only for W and ttbar contributions so we set this to false as we want to take the same-sign value in this case 
          ff_nom_2 = fns_["ff_tt_medium_dmbins"]->eval(args_dm_2.data());
          event->Add("wt_ff_dmbins_2",  ff_nom_2);

         auto args_mssm = std::vector<double>{pt_1_, jet_pt_1_, n_prebjets_, n_deepbjets_, dR, os, pt_2_, met_};
         ff_nom = fns_["ff_total"]->eval(args_mssm.data());
         event->Add("wt_ff_mssm_1",  ff_nom);
