...
dywt = 6077.22/97808057.


channels = ['mt','tt','et','em']
counter = 0
path = "/vols/cms/ks1021/ditau/trees/btag/2018tight_0109/"

#channels = ['em']


#tt_had_sf = 377.96/132202627.
tt_had_sf = 377.96/344533884.
#tt_semilep_sf = 365.34/96514045.
tt_semilep_sf = 365.34/1371034.
#tt_lep_sf = 88.29/132202627.
tt_lep_sf = 88.29/146036026.
...
outfile = ROOT.TFile("tagging_efficiencies_deepJet_2018UL_medium.root","RECREATE")
