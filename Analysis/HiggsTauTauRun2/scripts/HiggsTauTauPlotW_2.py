...
if options.analysis in ['sm','cpprod','cpdecay']:
    if options.channel == 'mt':
        ...
        if options.era in ['smsummer16','cpsummer16','cpdecay16',"legacy16",'mvadm2016']: 
          cats['baseline'] = '(iso_1<0.15 && deepTauVsJets_medium_2>0.5 && deepTauVsEle_vvloose_2>0.5 && deepTauVsMu_tight_2>0.5 && !leptonveto && ((trg_mutaucross&&pt_2>22)||(trg_singlemuon&&pt_1>23)))'
        ...
        if options.era in ['cpsummer17','cp18']:
          cats['baseline'] = '(iso_1<0.15 && deepTauVsJets_medium_2>0.5 && deepTauVsEle_vvloose_2>0.5 && deepTauVsMu_tight_2>0.5 && !leptonveto && ((trg_mutaucross&&pt_2>20)||(trg_singlemuon&&pt_1>25)) && wt<2 && mva_dm_2>=0)'
        ...
        if options.era in ['smsummer16','cpsummer16','cpdecay16',"legacy16",'cpsummer17','mvadm2016','cp18']:
          if ff_syst_weight is not None and 'ff_sub_syst' not in add_name: fake_factor_wt_string = ff_syst_weight+'_1'
            ...
            if options.analysis == 'cpprod': 
              ...
              #fake_factor_wt_string = "wt_ff_wjets_1"
# for 2018
...
#              fake_factor_wt_string = '((trg_singlemuon&&pt_1>25)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.486839*TMath::Landau(min(pt_2,140.),29.704014,7.235638)+0.155614)+(mva_dm_2==0&&ip_sig_2>=1.5)*(39.082987*TMath::Landau(min(pt_2,140.),-20.370033,3.259939)+0.166101)+(mva_dm_2==1)*(0.195693*TMath::Landau(min(pt_2,140.),37.609805,6.847309)+0.192385)+(mva_dm_2==2)*(0.284812*TMath::Landau(min(pt_2,140.),55.050309,19.924587)+0.068550)+(mva_dm_2==10)*(0.457457*TMath::Landau(min(pt_2,140.),57.815624,20.466217)+0.056877)+(mva_dm_2==11)*(0.082608*TMath::Landau(min(pt_2,140.),47.475066,11.809907)+0.048189)) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1.5)*(8.184068*TMath::Landau(min(pt_2,140.),-79.408199,11.047362)+0.089316)+(mva_dm_2==0&&ip_sig_2>=1.5)*(2.405580*TMath::Landau(min(pt_2,140.),28.729336,23.877075)+-0.131370)+(mva_dm_2==1)*(0.270478*TMath::Landau(min(pt_2,140.),38.126801,6.534556)+0.153119)+(mva_dm_2==2)*(0.674905*TMath::Landau(min(pt_2,140.),98.254508,67.774479)+-0.013688)+(mva_dm_2==10)*(0.246208*TMath::Landau(min(pt_2,140.),53.937906,11.950789)+0.079627)+(mva_dm_2==11)*(0.309853*TMath::Landau(min(pt_2,140.),90.079866,62.245171)+-0.000003)) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1.5)*(8.369828*TMath::Landau(min(pt_2,140.),-41.195868,7.034604)+0.076911)+(mva_dm_2==0&&ip_sig_2>=1.5)*(1.189556*TMath::Landau(min(pt_2,140.),26.996812,6.808805)+0.114629)+(mva_dm_2==1)*(0.317610*TMath::Landau(min(pt_2,140.),39.717412,6.236482)+0.131114)+(mva_dm_2==2)*(0.210849*TMath::Landau(min(pt_2,140.),54.686529,12.328631)+0.047630)+(mva_dm_2==10)*(0.646343*TMath::Landau(min(pt_2,140.),120.321186,71.977940)+-0.000002)+(mva_dm_2==11)*(0.240475*TMath::Landau(min(pt_2,140.),1179.265209,5524.208060)+0.000914))) + ((trg_singlemuon&&pt_1>25)==0)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.412761+-0.000587*min(min(pt_2,140.),80.))+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.505901+0.002068*min(min(pt_2,140.),80.))+(mva_dm_2==1)*(0.262336+0.002178*min(min(pt_2,140.),80.))+(mva_dm_2==2)*(0.186106+-0.001043*min(min(pt_2,140.),80.))+(mva_dm_2==10)*(0.043272+0.002266*min(min(pt_2,140.),80.))+(mva_dm_2==11)*(-0.025989+0.002380*min(min(pt_2,140.),80.))) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.200499+0.001032*min(min(pt_2,140.),80.))+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.408903+0.003660*min(min(pt_2,140.),80.))+(mva_dm_2==1)*(0.253343+0.000639*min(min(pt_2,140.),80.))+(mva_dm_2==2)*(0.097429)+(mva_dm_2==10)*(0.087308+0.001570*min(min(pt_2,140.),80.))+(mva_dm_2==11)*(-0.025459+0.001892*min(min(pt_2,140.),80.))) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.226700)+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.539876)+(mva_dm_2==1)*(0.180500)+(mva_dm_2==2)*(0.145704)+(mva_dm_2==10)*(0.259275+-0.002195*min(min(pt_2,140.),80.))+(mva_dm_2==11)*(0.039061))))'
#              fake_factor_wt_string += '*((n_jets==0)*(0.471096*TMath::Erf((max(min(newmet*cos(newmet_dphi_2)/pt_2,5),-5)--1.62065)/0.721186)+0.891275) + (n_jets==1)*(0.278753*TMath::Erf((max(min(newmet*cos(newmet_dphi_2)/pt_2,5),-5)--2.02585)/2.22587)+0.868478) + (n_jets>=2)*(7.10432*TMath::Erf((max(min(newmet*cos(newmet_dphi_2)/pt_2,5),-5)--13.399)/7.84898)+-5.88692))*((pt_1>25)*((n_jets==0)*(0.892622+0.0147846*pow(min(pt_1,90.),1)+-0.000355976*pow(min(pt_1,90.),2)+2.08061e-06*pow(min(pt_1,90.),3)) + (n_jets==1)*(1.05964+-0.00105633*pow(min(pt_1,90.),1)) + (n_jets>=2)*(1.02705+-0.00081152*pow(min(pt_1,90.),1))) + (pt_1<25))'
