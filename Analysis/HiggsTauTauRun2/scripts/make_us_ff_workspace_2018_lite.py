...
xtrg_pt=33 # change this pT cut depending on what pT range uses cross trigger
...
f = ROOT.TFile('us_fakefactors/ff_files_et_2018/uncorrected_fakefactors_et.root')
func = f.Get('rawFF_et_qcd_0jetSSloose')

loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTau/us_fakefactors/ff_files_et_2018/' % vars()
...
w.Print()
w.writeToFile('fakefactors_us_ws_et_lite_2018.root')
w.Delete()
