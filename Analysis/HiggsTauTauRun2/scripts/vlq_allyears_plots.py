...
channels = ['et','mt','tt']
cats = []
variables = ['fabs_dphi', 'mt_tot', 'pt_1+pt_2+met+jpt_1', 'n_jets', 'jpt_1', 'jpt_2', 'met', 'pt_1', 'pt_2', 'ip_sig_1', 'ip_sig_2', 'ip_mag_1', 'ip_mag_2']

directory='vlq_distributions_v4'
...
for chan in channels:
    for var in variables:
      ...
      for cat in cats:
        ...
        file_name='%(directory)s/%(chan)s/all/datacard_%(var)s_%(cat)s_%(var_alt)s_%(chan)s_all.root' % vars()
#mt/2018/datacard_fabs_dphi_Nbtag0_NjetsGt1_STMET400to800_fabsdphi_qcd_ff_closure_mt_2018.root
