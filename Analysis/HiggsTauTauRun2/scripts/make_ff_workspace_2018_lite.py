...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/mvadm_ff_deeptauV2p1_2018_et/' % vars()
...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/mvadm_ff_deeptauV2p1_2018_tt_ip0p5_nopu/' % vars()
