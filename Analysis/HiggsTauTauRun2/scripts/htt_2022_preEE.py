...
parser.add_option("--config", dest="config", type='string', default='scripts/config_2022_preEE.json',
                  help="Config file")
...
if os.path.isfile("./jobs/files_per_sample_2022_preEE.txt"):
    os.system("mv ./jobs/files_per_sample_2022_preEE.txt ./jobs/files_per_sample_2022_preEE-%(BACKUPNAME)s.txt"%vars())

file_persamp = open("./jobs/files_per_sample_2022_preEE.txt", "w")
