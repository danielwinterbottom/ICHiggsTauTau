...
#            wt = "--add_wt=\'wt_tau_trg_mssm*wt_tau_id_mssm\'"
          ...
          if year in ["2016","2017"]:
            wt = "--add_wt=\'wt_tau_trg_mssm*wt_prefire\'"
          else:
            wt = "--add_wt=\'wt_tau_trg_mssm\'"
          ...
          if not args.dry_run:
            if 'w_dr' in job_file or 'qcd_dr' in job_file or not args.add_systs or not ((year in ["2017","2018"]) and (channel in ['mt','et'])):
