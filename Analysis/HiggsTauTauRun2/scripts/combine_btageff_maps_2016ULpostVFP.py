...
other_effs = [other_eff_dy]

#ttbarwt = float(831.76/76628591)
#dywt = float(5765.4/49064064)
ttbarwt = 1
dywt = 6077.22/104133207.

channels = ['mt','tt','et','em']
counter = 0
path = "/vols/cms/ks1021/ditau/trees/btag/2016postVFPtight_0109/"

#channels = ['em']


tt_had_sf = 377.96/111680750.
tt_semilep_sf = 365.34/157404843.
tt_lep_sf = 88.29/47777071.
...
for ch in channels:
    ...
    #ftt = ROOT.TFile("{}/{}_{}_2016.root".format(path, bc_eff, ch))

    fdy = ROOT.TFile("{}/{}_{}_2016.root".format(path, other_eff_dy, ch))
    # fdyext = ROOT.TFile("{}/{}_{}_2016.root".format(path, other_eff_dyext, ch))
...
outfile = ROOT.TFile("tagging_efficiencies_deepJet_2016ULpostVFP_medium.root","RECREATE")
