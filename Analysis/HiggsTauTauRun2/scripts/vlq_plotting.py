...
add_options = '--ratio_range=\'0,2\' --signal_scale=100 --log_y'
  ...
  for channel in channels:
    ...
    for cat in categories_list:
      for var in variables:
        ...
        run_list = [run_cmd_0_gU1,run_cmd_0_gU2,run_cmd_0_gU3,run_cmd_minus1_gU1,run_cmd_minus1_gU2,run_cmd_minus1_gU3]
        
        for cmd in run_list:
        
          if "gU1" in cmd and "betaRd33_0" in cmd: 
            add_name = '_betaRd33_0_gU1'
          elif "gU2" in cmd and "betaRd33_0" in cmd:
            add_name = '_betaRd33_0_gU2'
          elif "gU3" in cmd and "betaRd33_0" in cmd:
            add_name = '_betaRd33_0_gU3'
          elif "gU1" in cmd and "betaRd33_minus1" in cmd:
            add_name = '_betaRd33_minus1_gU1'
          elif "gU2" in cmd and "betaRd33_minus1" in cmd:
            add_name = '_betaRd33_minus1_gU2'
          elif "gU3" in cmd and "betaRd33_minus1" in cmd:
            add_name = '_betaRd33_minus1_gU3'
