...
parser.add_option("--config", dest="config", type='string', default='scripts/config_2022_postEE.json',
                  help="Config file")
...
CONFIG='scripts/config_2022_postEE.json'
...
if options.proc_data or options.proc_all or options.calc_lumi:
    ...
    DATAFILELIST="./filelists/May0223_2022-postEE_Data_102X"

    if options.calc_lumi:
        for sa in data_samples:
            JOB='%s_postEE_2022' % (sa)
            user='irandreo'
            prefix='May0223_Data_124X_2022-postEE'
