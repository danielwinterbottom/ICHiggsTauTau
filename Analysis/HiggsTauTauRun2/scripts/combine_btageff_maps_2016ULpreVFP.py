...
ttbarwt = 1
dywt = 6077.22/92023543.

channels = ['mt','tt','et','em']
counter = 0
path = "/vols/cms/ks1021/ditau/trees/btag/2016preVFPloose_0109/"

#channels = ['em']


tt_had_sf = 377.96/92046787.
tt_semilep_sf = 365.34/124579435.
tt_lep_sf = 88.29/36056407.
...
outfile = ROOT.TFile("tagging_efficiencies_deepJet_2016ULpreVFP_loose.root","RECREATE")
