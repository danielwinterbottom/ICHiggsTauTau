...
if options.analysis == "vlq":
  vlq_samples = {
    ...
    "VLQ_betaRd33_minus1_matched_M_500":"VectorLQToTauTau_betaRd33_minus1_mU500_gU1_matched",
    "VLQ_betaRd33_minus1_matched_M_1000":"VectorLQToTauTau_betaRd33_minus1_mU1000_gU1_matched",
    "VLQ_betaRd33_minus1_matched_M_2000":"VectorLQToTauTau_betaRd33_minus1_mU2000_gU1_matched",
    "VLQ_betaRd33_minus1_matched_M_3000":"VectorLQToTauTau_betaRd33_minus1_mU3000_gU1_matched",
    "VLQ_betaRd33_minus1_matched_M_4000":"VectorLQToTauTau_betaRd33_minus1_mU4000_gU1_matched",
    "VLQ_betaRd33_minus1_matched_M_5000":"VectorLQToTauTau_betaRd33_minus1_mU5000_gU1_matched",
    "VLQ_betaRd33_0_matched_interference_M_500":["VectorLQToTauTau_betaRd33_0_lowM_mU500_gU1_matched_interference","VectorLQToTauTau_betaRd33_0_highM_mU500_gU1_matched_interference"],
    ...
    "VLQ_betaRd33_minus1_matched_interference_M_2000":["VectorLQToTauTau_betaRd33_minus1_lowM_mU2000_gU1_matched_interference","VectorLQToTauTau_betaRd33_minus1_highM_mU2000_gU1_matched_interference"],
...
if options.syst_eff_b != '':
    ...
    #systematics['syst_b_up'] = ('BTAG_UP', '_'+options.syst_eff_b+'Up', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww'], False)
    #systematics['syst_b_down'] = ('BTAG_DOWN', '_'+options.syst_eff_b+'Down', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww'], False)
    systematics['syst_b_up'] = ('BTAG_UP', '_'+options.syst_eff_b+'Up', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww','ZTT','ZL','ZLL','VVT','VVJ','TTT','TTJ'], False)
    systematics['syst_b_down'] = ('BTAG_DOWN', '_'+options.syst_eff_b+'Down', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww','ZTT','ZL','ZLL','VVT','VVJ','TTT','TTJ'], False)
if options.syst_fake_b != '':
    ...
    systematics['syst_fake_b_up'] = ('BFAKE_UP', '_'+options.syst_fake_b+'Up', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww','ZTT','ZL','ZLL','VVT','VVJ','TTT','TTJ'], False)
    systematics['syst_fake_b_down'] = ('BFAKE_DOWN', '_'+options.syst_fake_b+'Down', 'wt', ['EmbedZTT','ZJ','EWKZ','jetFakes','W','QCD','qqH_hww','ggH_hww','ZTT','ZL','ZLL','VVT','VVJ','TTT','TTJ'], False)
...
if options.syst_scale_met != '':
    ...
    if options.embedding and options.analysis in ['mssmrun2','vlq'] and not '$NJET' in hist_name: 
