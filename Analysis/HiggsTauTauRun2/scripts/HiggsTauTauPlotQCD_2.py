...
import argparse
import ConfigParser
import UserCode.ICHiggsTauTau.plotting_qcd as plotting
...
if options.analysis in ['sm','cpprod','cpdecay']:
    if options.channel == 'mt':
        ...
        if options.era in ['smsummer16','cpsummer16','cpdecay16',"legacy16",'mvadm2016']: 
          cats['baseline'] = '(iso_1<0.15 && deepTauVsJets_medium_2>0.5 && deepTauVsEle_vvloose_2>0.5 && deepTauVsMu_tight_2>0.5 && !leptonveto && ((trg_mutaucross&&pt_2>25&&pt_1<23)||(trg_singlemuon&&pt_1>23)) &&mva_dm_2>=0)'
...
#              fake_factor_wt_string+='*((n_jets==0)*(1.20538 + 0.364895*max(min((met*cos(met_dphi_2)/pt_2),1.5),-2.5))  + (n_jets>0))'
#              fake_factor_wt_string+='*((n_jets==0)*(6.18424e+00*TMath::Landau(min(pt_1,50), 2.53230e+01, 1.16584e+01)) + (n_jets>0)*1.10371 -0.00267569*min(pt_1,70))'

#              fake_factor_wt_string+='*((n_jets==0)*(1.19955+ + 0.364412*max(min((met*cos(met_dphi_2)/pt_2),1.5),-2.5))  + (n_jets>0))'

#              fake_factor_wt_string+='*((n_jets==0&&pt_1>25)*(1.01633e+02*TMath::Landau(min(pt_1,50), -4.53585e+01, 6.93721e+00)) + ((n_jets==0&&pt_1>25)==0))'
#   1  Constant     1.01633e+02   5.96147e+01   1.58091e+00  -4.41907e-02
#   2  MPV         -4.53585e+01   9.30273e+00  -2.93916e-02  -1.11248e-01
#   3  Sigma        6.93721e+00   1.99994e+00  -1.37583e-03  -4.83971e+01
#   1  Constant     6.18424e+00   1.22125e-01   1.42582e-04  -3.98341e-04
#   2  MPV          2.53230e+01   1.99983e+00   1.62987e-03  -6.74058e-05
#   3  Sigma        1.16584e+01   1.63515e+00   3.73232e-05  -5.24937e-03


#Minimizer is Linear
#Chi2                      =      27.8934
#NDf                       =           14
#p0                        =      1.48407   +/-   0.0431758   
#p1                        =   -0.0153216   +/-   0.00140412


#              fake_factor_wt_string = '((trg_singlemuon&&pt_1>25)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(1.087900*TMath::Landau(min(pt_2,100.),45.619820,21.262291)+-0.041129)+(mva_dm_2==0&&ip_sig_2>=1)*(2.981253*TMath::Landau(min(pt_2,100.),53.422521,45.994985)+-0.329226)+(mva_dm_2==1)*(0.984334*TMath::Landau(min(pt_2,100.),64.290799,29.430780)+-0.013762)+(mva_dm_2==2)*(1.999455*TMath::Landau(min(pt_2,100.),112.731374,82.346025)+-0.237705)+(mva_dm_2==10)*(0.370230*TMath::Landau(min(pt_2,100.),63.028358,16.592774)+0.051386)+(mva_dm_2==11)*(0.334748*TMath::Landau(min(pt_2,100.),107.903933,54.800854)+0.000001)) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.717214*TMath::Landau(min(pt_2,100.),68.943909,943.634597)+0.000427)+(mva_dm_2==0&&ip_sig_2>=1)*(23.264868*TMath::Landau(min(pt_2,100.),-23.009613,3.567393)+0.101239)+(mva_dm_2==1)*(0.105098+0.000529*min(pt_2,100.))+(mva_dm_2==2)*(0.140396*TMath::Landau(min(pt_2,100.),32.620777,3.869156)+0.053509)+(mva_dm_2==10)*(0.357405*TMath::Landau(min(pt_2,100.),130.823273,45.133757)+0.062595)+(mva_dm_2==11)*(0.020999+0.000588*min(pt_2,100.))) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.474135*TMath::Landau(min(pt_2,100.),26.079841,3.825657)+0.027251)+(mva_dm_2==0&&ip_sig_2>=1)*(5.907736*TMath::Landau(min(pt_2,100.),12.313428,1.083427)+0.126052)+(mva_dm_2==1)*(0.091757+0.000575*min(pt_2,100.))+(mva_dm_2==2)*(0.487584*TMath::Landau(min(pt_2,100.),394.755155,259.314297)+0.000006)+(mva_dm_2==10)*(7.592831*TMath::Landau(min(pt_2,100.),550.555601,191.085301)+0.031977)+(mva_dm_2==11)*(0.032124+-0.000033*min(pt_2,100.)))) + ((trg_singlemuon&&pt_1>25)==0)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(0.283435)+(mva_dm_2==0&&ip_sig_2>=1)*(0.454540+0.000959*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.321156)+(mva_dm_2==2)*(0.070482+0.002200*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.032369+0.003436*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.023178+0.001242*min(min(pt_2,100.),80.))) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.200949+0.000007*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1)*(0.531046+-0.003072*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.124421+0.003728*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.123253)+(mva_dm_2==10)*(0.043340+0.002985*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.063666)) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.345604+-0.002870*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1)*(0.439138+-0.001498*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.217718)+(mva_dm_2==2)*(0.165065+-0.000719*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.130495+0.000332*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.056859))))'

              #fake_factor_wt_string = '((trg_singlemuon&&pt_1>25)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1.5)*(1.107681*TMath::Landau(min(pt_2,100.),44.242289,19.827780)+-0.035362)+(mva_dm_2==0&&ip_sig_2>=1.5)*(1.185813*TMath::Landau(min(pt_2,100.),43.216768,28.642520)+0.000008)+(mva_dm_2==1)*(2.571226*TMath::Landau(min(pt_2,100.),92.391054,66.493572)+-0.277467)+(mva_dm_2==2)*(3.535231*TMath::Landau(min(pt_2,100.),109.877275,102.648609)+-0.523601)+(mva_dm_2==10)*(0.370230*TMath::Landau(min(pt_2,100.),63.028358,16.592774)+0.051386)+(mva_dm_2==11)*(0.334748*TMath::Landau(min(pt_2,100.),107.903933,54.800854)+0.000001)) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.762921*TMath::Landau(min(pt_2,100.),58.123411,61.470307)+0.000015)+(mva_dm_2==0&&ip_sig_2>=1.5)*(84.332415*TMath::Landau(min(pt_2,100.),-50.129096,4.157612)+0.000049)+(mva_dm_2==1)*(0.114884+0.000386*min(pt_2,100.))+(mva_dm_2==2)*(1.411318*TMath::Landau(min(pt_2,100.),96.273117,80.284008)+-0.165830)+(mva_dm_2==10)*(0.357405*TMath::Landau(min(pt_2,100.),130.823273,45.133757)+0.062595)+(mva_dm_2==11)*(0.020999+0.000588*min(pt_2,100.))) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1.5)*(3.906913*TMath::Landau(min(pt_2,100.),-7.920669,3.667094)+0.045361)+(mva_dm_2==0&&ip_sig_2>=1.5)*(6.266831*TMath::Landau(min(pt_2,100.),5.298186,2.268921)+0.120249)+(mva_dm_2==1)*(0.093919+0.000547*min(pt_2,100.))+(mva_dm_2==2)*(0.318614*TMath::Landau(min(pt_2,100.),118.339411,130.571867)+0.000003)+(mva_dm_2==10)*(7.592831*TMath::Landau(min(pt_2,100.),550.555601,191.085301)+0.031977)+(mva_dm_2==11)*(0.032124+-0.000033*min(pt_2,100.)))) + ((trg_singlemuon&&pt_1>25)==0)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.324207)+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.588688+0.000939*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.313619)+(mva_dm_2==2)*(0.065844+0.002316*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.032369+0.003436*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.023178+0.001242*min(min(pt_2,100.),80.))) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.184856+0.000627*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.915928+-0.011252*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.151748+0.002496*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.120376)+(mva_dm_2==10)*(0.043340+0.002985*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.063666)) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1.5)*(0.270952+-0.001669*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1.5)*(0.774488+-0.007370*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.214300)+(mva_dm_2==2)*(0.165834+-0.000772*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.130495+0.000332*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.056859))))'

#              fake_factor_wt_string += '*((n_jets==0)*(1.18633+0.349581*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)) + (n_jets>=1)*(1.04882+0.0972055*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)))*((pt_1>25)*((n_jets==0)*(111.15*TMath::Landau(min(pt_1,50.),-46.4148,6.73391)) + (n_jets>=1)*(1.08223+-0.00224797*pow(min(pt_1,70.),1))) + (pt_1<25))'
              #fake_factor_wt_string += '*((n_jets==0)*(1.18633+0.349581*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)) + (n_jets>=1)*(1.04882+0.0972055*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)))'

#              if options.era=='cpsummer17':
#                fake_factor_wt_string = '((trg_singlemuon&&pt_1>25)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(0.329929*TMath::Landau(min(pt_2,100.),33.503799,3.604519)+0.104716)+(mva_dm_2==0&&ip_sig_2>=1)*(1.242215*TMath::Landau(min(pt_2,100.),69.156951,41.344114)+-0.000003)+(mva_dm_2==1)*(4.566246*TMath::Landau(min(pt_2,100.),123.507594,113.120751)+-0.627741)+(mva_dm_2==2)*(1.348749*TMath::Landau(min(pt_2,100.),119.056505,75.794293)+-0.120461)+(mva_dm_2==10)*(1.170529*TMath::Landau(min(pt_2,100.),66.369747,38.867105)+-0.110949)+(mva_dm_2==11)*(5810.593274*TMath::Landau(min(pt_2,100.),1086.648786,4565.076065)+-1049.662730)) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.130057)+(mva_dm_2==0&&ip_sig_2>=1)*(1.054627*TMath::Landau(min(pt_2,100.),25.754945,3.513572)+0.103086)+(mva_dm_2==1)*(1.934961*TMath::Landau(min(pt_2,100.),2413.024294,1845.368880)+-0.127515)+(mva_dm_2==2)*(0.483126*TMath::Landau(min(pt_2,100.),73.801665,34.439602)+0.000002)+(mva_dm_2==10)*(0.323996*TMath::Landau(min(pt_2,100.),60.682023,15.393661)+0.059967)+(mva_dm_2==11)*(1.104034*TMath::Landau(min(pt_2,100.),91.143185,82.138366)+-0.146370)) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.097552)+(mva_dm_2==0&&ip_sig_2>=1)*(0.994846*TMath::Landau(min(pt_2,100.),28.000068,5.163454)+0.050879)+(mva_dm_2==1)*(1.407718*TMath::Landau(min(pt_2,100.),69.367596,41.179761)+-0.099873)+(mva_dm_2==2)*(0.192791*TMath::Landau(min(pt_2,100.),58.911214,13.340912)+0.040493)+(mva_dm_2==10)*(2.945545*TMath::Landau(min(pt_2,100.),95.050283,90.259866)+-0.431598)+(mva_dm_2==11)*(4073.800502*TMath::Landau(min(pt_2,100.),-51071.285337,141.497262)+0.000005))) + ((trg_singlemuon&&pt_1>25)==0)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(0.056818+0.005479*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1)*(0.304048+0.002857*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.107264+0.004709*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.091659+0.000923*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.100290+0.001602*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.045573+0.000814*min(min(pt_2,100.),80.))) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.141762)+(mva_dm_2==0&&ip_sig_2>=1)*(0.404515+-0.001943*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.202079+0.001075*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.083003+0.000906*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.069900+0.001838*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.082004+-0.000430*min(min(pt_2,100.),80.))) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.229636)+(mva_dm_2==0&&ip_sig_2>=1)*(0.297953+0.000163*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.157082)+(mva_dm_2==2)*(0.106502+-0.000391*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.147896+0.000536*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.097731+-0.001253*min(min(pt_2,100.),80.)))))'
#                fake_factor_wt_string += '*((pt_1>25)*((n_jets==0)*(191.972*TMath::Landau(min(pt_1,50.),-43.7028,4.9407)) + (n_jets>=1)*(1.1552+-0.00432135*pow(min(pt_1,70.),1))) + (pt_1<25))*((n_jets==0)*(1.17642+0.290871*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)) + (n_jets>=1)*(1.00414+0.0465974*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)))'
#
#
#              if options.era=='legacy16':
#
#                fake_factor_wt_string = '((trg_singlemuon&&pt_1>23)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(0.309363*TMath::Landau(min(pt_2,100.),40.255825,6.291895)+0.117525)+(mva_dm_2==0&&ip_sig_2>=1)*(6.439057*TMath::Landau(min(pt_2,100.),-4.488169,2.563026)+0.195163)+(mva_dm_2==1)*(2.629650*TMath::Landau(min(pt_2,100.),86.780337,70.027857)+-0.314961)+(mva_dm_2==2)*(0.022891+0.001069*min(pt_2,100.))+(mva_dm_2==10)*(2.434856*TMath::Landau(min(pt_2,100.),88.364885,70.242475)+-0.326008)+(mva_dm_2==11)*(0.887404*TMath::Landau(min(pt_2,100.),78.848576,54.284693)+-0.104168)) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.472436*TMath::Landau(min(pt_2,100.),28.153647,9.318309)+0.044835)+(mva_dm_2==0&&ip_sig_2>=1)*(2.224297*TMath::Landau(min(pt_2,100.),24.891198,9.319273)+-0.043566)+(mva_dm_2==1)*(0.210598*TMath::Landau(min(pt_2,100.),38.947281,5.487314)+0.097094)+(mva_dm_2==2)*(3.708174*TMath::Landau(min(pt_2,100.),161.081094,176.727291)+-0.574283)+(mva_dm_2==10)*(0.028833+0.000849*min(pt_2,100.))+(mva_dm_2==11)*(0.447832*TMath::Landau(min(pt_2,100.),157.823545,125.167463)+-0.032778)) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.118441+-0.000455*min(pt_2,100.))+(mva_dm_2==0&&ip_sig_2>=1)*(21.552963*TMath::Landau(min(pt_2,100.),-5.796807,2.502515)+0.101778)+(mva_dm_2==1)*(1.614330*TMath::Landau(min(pt_2,100.),497.126223,254.849961)+0.000003)+(mva_dm_2==2)*(0.533639*TMath::Landau(min(pt_2,100.),1657.918373,999.141436)+-0.010091)+(mva_dm_2==10)*(0.034230+0.000624*min(pt_2,100.))+(mva_dm_2==11)*(0.024236+0.000077*min(pt_2,100.)))) + ((trg_singlemuon&&pt_1>23)==0)*((n_jets==0)*((mva_dm_2==0&&ip_sig_2<1)*(0.228213+0.000114*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1)*(0.394417+0.000549*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.164361+0.001710*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.081301+0.000205*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.094430+0.000686*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.044026+0.000410*min(min(pt_2,100.),80.))) + (n_jets==1)*((mva_dm_2==0&&ip_sig_2<1)*(0.277264+-0.000896*min(min(pt_2,100.),80.))+(mva_dm_2==0&&ip_sig_2>=1)*(0.660150+-0.008502*min(min(pt_2,100.),80.))+(mva_dm_2==1)*(0.208897+-0.001018*min(min(pt_2,100.),80.))+(mva_dm_2==2)*(0.106085+-0.000808*min(min(pt_2,100.),80.))+(mva_dm_2==10)*(0.113863+-0.000043*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.049311+0.000248*min(min(pt_2,100.),80.))) + (n_jets>1)*((mva_dm_2==0&&ip_sig_2<1)*(0.152631)+(mva_dm_2==0&&ip_sig_2>=1)*(0.246429)+(mva_dm_2==1)*(0.130136)+(mva_dm_2==2)*(0.072205)+(mva_dm_2==10)*(0.106046+-0.000353*min(min(pt_2,100.),80.))+(mva_dm_2==11)*(0.053057))))'
#
#                fake_factor_wt_string += '*((pt_1>23)*((n_jets==0)*(10.349*TMath::Landau(min(pt_1,50.),-0.70291,13.7493)) + (n_jets>=1)*(1.17534+-0.00530965*pow(min(pt_1,70.),1))) + (pt_1<23))*((n_jets==0)*(1.20772+0.348067*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)) + (n_jets>=1)*(1.03537+0.0431856*pow(max(min(met*cos(met_dphi_2)/pt_2,1.5),-2.5),1)))' 
        ...
        f2 = GetSubtractNode(ana,'',plot,plot_unmodified,wt+sub_wt,sel,ff_cat,ff_cat_data,8,1.0,get_os,True)
    ...
    if options.channel == 'tt':
        ...
        if options.ff_ss_closure:
          ...
          f2_total_node = SummedNode('total_bkg')
          #f2_total_node.AddNode(GetSubtractNode(ana,'_1',plot,plot_unmodified,wt_1+sub_wt,sel+'*(gen_match_1<6)',ff_cat_1,ff_cat_1_data,8,1.0,get_os,True))
          f2_total_node.AddNode(GetSubtractNode(ana,'_1',plot,plot_unmodified,wt_1+sub_wt,sel,ff_cat_1,ff_cat_1_data,8,1.0,get_os,True))
          f2_total_node.AddNode(GetSubtractNode(ana,'_2',plot,plot_unmodified,wt_2+sub_wt,sel,ff_cat_2,ff_cat_2_data,8,1.0,get_os,True))
