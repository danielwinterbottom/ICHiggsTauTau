...
CONFIG='scripts/config_mssm_2017_met.json'
...
FILELIST='filelists/Jan11_MC_102X'
...
if options.proc_data or options.proc_all or options.calc_lumi:  
  ...
  DATAFILELIST="./filelists/Jan11_Data_102X"
#  DATAPREFIX = DATAFILELIST.split("/")[2]
  DATAPREFIX = 'Jan11_Data_102X_2017'
...
if options.proc_embed or options.proc_all:        
  ...
  EMBEDFILELIST="./filelists/Jan11_MC_102X"
  #EMBEDPREFIX = EMBEDFILELIST.split("/")[2]
  EMBEDPREFIX='Jan11_MC_102X_2017'
