...
ttbarwt = 1
dywt = 6077.22/103265734.

channels = ['mt','tt','et','em']
counter = 0
path = "/vols/cms/ks1021/ditau/trees/btag/2017tight_0109/"

#channels = ['em']


tt_had_sf = 377.96/246951349.
tt_semilep_sf = 365.34/352728952.
tt_lep_sf = 88.29/106075124.
...
outfile = ROOT.TFile("tagging_efficiencies_deepJet_2017UL_tight.root","RECREATE")
