...
#for i in ["CMS_htt_mistag_b_$ERA"]:
  ...
  ## Do signal
  json_dict[i] = {}
  sig_masses = ["60","80","95","100","120","125","130","140","160","180","200","250","300","350","400","450","500","600","700","800","900","1000","1200","1400","1600","1800","2000","2300","2600","2900","3200","3500"]
          ...
          for year in ["2016","2017","2018"]:
            ...
            for j in loop:
              if ch == "em":
                ...
                file_input = "mssm_dc_btag_eff/%(year)s/%(ch)s/htt_all.inputs-mssm-vs-sm-Run%(year)s-mt_tot_puppi.root" % vars()
