...
var_input     = "mtt_mass[0,100,200,300,400,500,600,700,800,900,1100,1300,1500,1700,1900,2100,2300,2500,2700,2900]"
x_label       = "mass"
y_label       = "dN/dmass"
z_label       = "Events"
sel           = "wt*(n_bjets>0 && mtt_mass>400)"
do_ratio      = False
ratio_file    = "Nominal"
logx          = False
logy          = False
...
gU            = 1
horiz_line    = 1.
#under_legend_1= "g_{U} = %(gU)s, m_{U} = 1 TeV" % vars()
under_legend_1=""
under_legend_2= ""
under_legend_3= ""
#under_legend_2= "Off diagonal terms 0"
#under_legend_3= "400 < m_{vis} < 600 GeV, N_{jets} = 0"

### Input files ###

files = {
         "Nominal": ["VectorLQToTauTau_betaRd33_0_lowM_mU1000_gU1_matched_interference_tt_2017.root","VectorLQToTauTau_betaRd33_0_highM_mU1000_gU1_matched_interference_tt_2017.root"],
         "Up"     : ["VectorLQToTauTau_betaRd33_0_lowM_mU1000_gU1_matched_xqcut_up_interference_tt_2017.root","VectorLQToTauTau_betaRd33_0_highM_mU1000_gU1_matched_xqcut_up_interference_tt_2017.root"], 
         "Down"   : ["VectorLQToTauTau_betaRd33_0_lowM_mU1000_gU1_matched_xqcut_down_interference_tt_2017.root","VectorLQToTauTau_betaRd33_0_highM_mU1000_gU1_matched_xqcut_down_interference_tt_2017.root"],
        }

#files = {
#         "Nominal": ["VectorLQToTauTau_betaRd33_0_mU1000_gU1_matched_tt_2017.root"],
#         "Up"     : ["VectorLQToTauTau_betaRd33_0_mU1000_gU1_matched_xqcut_up_tt_2017.root"], 
#         "Down"   : ["VectorLQToTauTau_betaRd33_0_mU1000_gU1_matched_xqcut_down_tt_2017.root"],
#        }
