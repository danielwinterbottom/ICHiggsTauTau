...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="pt_1(25,0,100)" \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  ...
  --x_axis_label="p_{T}(#tau_{h}) [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" $ET_INC_SHIFT
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="eta_2(30,-3,3)" --extra_pad=2.0 \
  --x_axis_label="Tau #eta" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" $ET_INC_SHIFT
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="m_2(20,0,2)" --extra_pad=1.1 \
  --x_axis_label="Tau Mass [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" $ET_INC_SHIFT
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et  \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --set_alias="sel:1" --var="mt_1(40,0,160)" \
  --x_axis_label="m_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=1.1 $ET_BAND_ONLY \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --set_alias="sel:1" --var="mt_1(40,0,160)" \
  --x_axis_label="m_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=1.1 $MT_BAND_ONLY \
  --background_scheme="mt_with_zmm"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=em --set_alias="sel:1" \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="pzeta(48,-100,100)" --extra_pad=1.5 $EM_BAND_ONLY \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=em --set_alias="sel:1" \
 ...
 ./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=em --set_alias="sel:1" \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="pzetamiss(25,-100,100)"  $EM_BAND_ONLY \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="n_vtx(30,0,30)" $ET_INC_SHIFT \
  --x_axis_label="Number of Vertices" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=1.8 \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="n_vtx(30,0,30)" $MT_INC_SHIFT \
  --x_axis_label="Number of Vertices" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=1.8 \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="tau_decay_mode(3,-4,11)" $ET_INC_SHIFT \
  --x_axis_label="Tau Decay Mode" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=2.0 \
  --background_scheme="et_default"\
  --x_axis_bin_labels="1 Prong 0 #pi^{0}:1 Prong 1 #pi^{0}:3 Prong" 

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="tau_decay_mode(3,-4,11)" $MT_INC_SHIFT \
  --x_axis_label="Tau Decay Mode" --datacard="jpt1_20_jpt2_20_no-tag" --extra_pad=2.0 \
  --background_scheme="mt_with_zmm"\
  --x_axis_bin_labels="1 Prong 0 #pi^{0}:1 Prong 1 #pi^{0}:3 Prong" 
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jpt_1(20,0,200)" $ET_1JET_SHIFT \
  --x_axis_label="Leading Jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" --extra_pad=1.2

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jpt_1(20,0,200)" $MT_1JET_SHIFT \
  --x_axis_label="Leading Jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jeta_1(20,-5,5)" --extra_pad=2.0 $ET_1JET_SHIFT \
  --x_axis_label="Leading Jet #eta [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jeta_1(20,-5,5)" --extra_pad=1.9 $MT_1JET_SHIFT \
  --x_axis_label="Leading Jet #eta [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jpt_2(20,0,200)" $ET_2JET_SHIFT \
  --x_axis_label="Subleading Jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" --extra_pad=1.2

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jpt_2(20,0,200)" $MT_2JET_SHIFT \
  --x_axis_label="Subleading Jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="mt_with_zmm" --extra_pad=1.2
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jeta_2(20,-5,5)" --extra_pad=1.9 $ET_2JET_SHIFT \
  --x_axis_label="Subleading Jet #eta [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="jeta_2(20,-5,5)" --extra_pad=1.9 $MT_2JET_SHIFT \
  --x_axis_label="Subleading Jet #eta [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_med-tag" --var="bpt_1(20,0,200)" $ET_BTAG_SHIFT \
  --x_axis_label="Leading b-tagged jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_med-tag" \
  --background_scheme="et_default" --extra_pad=1.3

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_med-tag" --var="bpt_1(20,0,200)" \
  --x_axis_label="Leading b-tagged jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_med-tag" $MT_BTAG_SHIFT \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_med-tag" --var=$BETA_BINS --extra_pad=2.0 $ET_BTAG_SHIFT \
  --x_axis_label="Leading b-tagged jet #eta" --datacard="jpt1_20_jpt2_20_med-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_med-tag" --var=$BETA_BINS --extra_pad=2.0 \
  --x_axis_label="Leading b-tagged jet #eta" --datacard="jpt1_20_jpt2_20_med-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_twomed-tag" --var="bpt_2(20,0,200)" $ET_BTAG_SHIFT \
  --x_axis_label="Subleading b-tagged jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_twomed-tag" \
  --background_scheme="et_default" --extra_pad=1.3

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_twomed-tag" --var="bpt_2(20,0,200)" \
  --x_axis_label="Subleading b-tagged jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_twomed-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm" --extra_pad=1.3
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_twomed-tag" --var=$BETA_BINS --extra_pad=2.0 $ET_BTAG_SHIFT \
  --x_axis_label="Subleading b-tagged jet #eta" --datacard="jpt1_20_jpt2_20_twomed-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_twomed-tag" --var=$BETA_BINS --extra_pad=2.0 \
  --x_axis_label="Subleading b-tagged jet #eta" --datacard="jpt1_20_jpt2_20_twomed-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetpt_1(20,0,200)" $ET_BTAG_SHIFT \
  --x_axis_label="Leading selected jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" --extra_pad=1.3

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetpt_1(20,0,200)" \
  --x_axis_label="Leading selected jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm" --extra_pad=1.3
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var=$BETA_BINS --extra_pad=2.0 $ET_BTAG_SHIFT \
  --x_axis_label="Leading selected jet #eta" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var=$BETA_BINS --extra_pad=2.0 \
  --x_axis_label="Leading selected jet #eta" --datacard="jpt1_20_jpt2_20_no-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetpt_2(20,0,200)" $ET_BTAG_SHIFT \
  --x_axis_label="Subleading selected jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" --extra_pad=1.3

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetpt_2(20,0,200)" \
  --x_axis_label="Subleading selected jet p_{T} [GeV]" --datacard="jpt1_20_jpt2_20_no-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm" --extra_pad=1.3
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var=$BETA_BINS --extra_pad=2.0 $ET_BTAG_SHIFT \
  --x_axis_label="Subleading selected jet #eta" --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var=$BETA_BINS --extra_pad=2.0 \
  --x_axis_label="Subleading selected jet #eta" --datacard="jpt1_20_jpt2_20_no-tag" $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm"
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  ...
  --x_axis_label="Leading selected jet CSV" --datacard="jpt1_20_jpt2_20_no-tag"  $ET_BTAG_SHIFT \
  --background_scheme="et_default" --extra_pad=1.2

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetbcsv_1(25,0,1)" \
  --x_axis_label="Leading selected jet CSV" --datacard="jpt1_20_jpt2_20_no-tag"  $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm" --extra_pad=1.2
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  ...
  --x_axis_label="Subleading selected jet CSV" --datacard="jpt1_20_jpt2_20_no-tag"  $ET_BTAG_SHIFT \
  --background_scheme="et_default" --extra_pad=1.2

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjetbcsv_2(25,0,1)" \
  --x_axis_label="Subleading selected jet CSV" --datacard="jpt1_20_jpt2_20_no-tag"  $MT_BTAG_SHIFT \
  --background_scheme="mt_with_zmm" --extra_pad=1.2
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjet_deta(20,0,10)" $ET_2JET_SHIFT \
  --x_axis_label="#Delta#eta_{jj}" \
  --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="et_default" --extra_pad=1.2

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=mt --set_alias="sel:mt_1<30." \
  --method=8 --cat="jpt1_20_jpt2_20_no-tag" --var="prebjet_deta(20,0,10)" $MT_2JET_SHIFT \
  --x_axis_label="#Delta#eta_{jj}" \
  --datacard="jpt1_20_jpt2_20_no-tag" \
  --background_scheme="mt_with_zmm" --extra_pad=1.2
