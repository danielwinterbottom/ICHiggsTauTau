...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --var="m_vis"["$MSSMBINS"] --cat="sasha" \
  --x_axis_label="M_{#tau#tau}^{vis} [GeV]" $ET_INC_SHIFT \
...
./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --var="m_vis"["$MSSMBINS"] --cat="jpt1_20_jpt2_20_med-tag" \
  --x_axis_label="M_{#tau#tau}^{vis} [GeV]" $ET_INC_SHIFT \
  --norm_bins=true --datacard="jpt1_20_jpt2_20_med-tag"  \
  --custom_y_axis_min=true --y_axis_min=0.0099 \
  --blind=false --x_blind_min=110 --x_blind_max=2000 \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --var="m_vis"["$MSSMBINS"] --cat="jpt1_30_jpt2_20_med-tag" \
  --x_axis_label="M_{#tau#tau}^{vis} [GeV]" $ET_INC_SHIFT \
  --norm_bins=true --datacard="jpt1_30_jpt2_20_med-tag"  \
  --custom_y_axis_min=true --y_axis_min=0.0099 \
  --blind=false --x_blind_min=110 --x_blind_max=2000 \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --var="m_vis"["$MSSMBINS"] --cat="jpt1_40_jpt2_20_med-tag" \
  --x_axis_label="M_{#tau#tau}^{vis} [GeV]" $ET_INC_SHIFT \
  --norm_bins=true --datacard="jpt1_40_jpt2_20_med-tag"  \
  --custom_y_axis_min=true --y_axis_min=0.0099 \
  --blind=false --x_blind_min=110 --x_blind_max=2000 \
  --background_scheme="et_default"

./bin/HiggsHTohhPlot --cfg=scripts/new_plot_"$ANA"_"$YEAR".cfg --channel=et --set_alias="sel:mt_1<30." \
  --method=8 --var="m_vis"["$MSSMBINS"] --cat="jpt1_40_jpt2_30_med-tag" \
  --x_axis_label="M_{#tau#tau}^{vis} [GeV]" $ET_INC_SHIFT \
  --norm_bins=true --datacard="jpt1_40_jpt2_30_med-tag"  \
  --custom_y_axis_min=true --y_axis_min=0.0099 \
  --blind=false --x_blind_min=110 --x_blind_max=2000 \
  --background_scheme="et_default"
...
#  --background_scheme="mt_default" $ET_INC_SHIFT 
