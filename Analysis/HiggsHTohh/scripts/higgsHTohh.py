...
if options.proc_data or options.proc_all:
  for ch in channels:
    if '0' in scales:
      ...
      os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s --output_name=%(JOB)s.root &> jobs/%(JOB)s.log" jobs/%(JOB)s.sh' % vars())
      os.system('%(JOBSUBMIT)s jobs/%(JOB)s.sh' % vars())

    if ch in ['et', 'mt']:
      for sc in scales:
        JOB='Embedded_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_Embedded_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s '
    ...
    #    os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_RecHit_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s '
    ...
    if ch in ['et', 'mt']:
      if '0' in scales:
        JOB='Data_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_2_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s'
    ...
    if ch in ['et', 'mt']  and (PRODUCTION == 'June6' or PRODUCTION == 'Apr11'):
      if '0' in scales:
        JOB='Data_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_4_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s'
    ...
    if ch in ['em']:
      if '0' in scales:
        JOB='Data_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_20_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
        ...
        JOB='Data_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_21_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
        ...
        JOB='Data_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_22_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
        ...
        if PRODUCTION == 'Feb20' or PRODUCTION == 'Apr11' or PRODUCTION == 'June6':
          JOB='Data_%s_%s' % (ch,YR)
          os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_23_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
          ...
          JOB='Data_%s_%s' % (ch,YR)
          os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_24_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
          ...
          JOB='Data_%s_%s' % (ch,YR)
          os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --filelist=%(FILELIST)s_Special_25_Data_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
          --special_mode=23 --output_name=%(JOB)s.root &> jobs/Special_23_%(JOB)s.log" jobs/Special_23_%(JOB)s.sh' % vars())
          os.system('%(JOBSUBMIT)s jobs/Special_23_%(JOB)s.sh' % vars())
      ...
      if '0' in scales:
        JOB='Embedded_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=2 --filelist=%(FILELIST)s_Embedded_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
...
#        JOB='RecHit_%s_%s' % (ch,YR)
#        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=2 --filelist=%(FILELIST)s_RecHit_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
#          --is_embedded=true --output_name=%(JOB)s.root &> jobs/%(JOB)s-2.log" jobs/%(JOB)s-2.sh' % vars())
#        os.system('%(JOBSUBMIT)s jobs/%(JOB)s-2.sh' % vars())

      if '1' in scales:
        JOB='Embedded_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=1 --filelist=%(FILELIST)s_Embedded_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
...
#        JOB='RecHit_%s_%s' % (ch,YR)
#        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=1 --filelist=%(FILELIST)s_RecHit_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
#          --is_embedded=true --output_name=%(JOB)s.root &> jobs/%(JOB)s-1.log" jobs/%(JOB)s-1.sh' % vars())
#        os.system('%(JOBSUBMIT)s jobs/%(JOB)s-1.sh' % vars())

      if '2' in scales:
        JOB='Embedded_%s_%s' % (ch,YR)
        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=3 --filelist=%(FILELIST)s_Embedded_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
...
#        JOB='RecHit_%s_%s' % (ch,YR)
#        os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXDATA)s --mass_scale_mode=3 --filelist=%(FILELIST)s_RecHit_%(ERA)s_%(ch)s_skim.dat --channel=%(ch)s \
#          --is_embedded=true --output_name=%(JOB)s.root &> jobs/%(JOB)s-3.log" jobs/%(JOB)s-3.sh' % vars())
#        os.system('%(JOBSUBMIT)s jobs/%(JOB)s-3.sh' % vars())
    ...
    for ch in channels:
      ...
      for sc in scales:
        if ch in ['et', 'mt']:
          ...
          for sp in soups:  
            if options.do_2011 and ERA=='Total':
              ...
              os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_DYJetsToTauTau%(sp)s_%(ch)s_skim.dat --channel=%(ch)s'
                ' --ztautau_mode=1 --output_name=%(JOB)s.root &> jobs/%(JOB)s-%(sc)s.log" jobs/%(JOB)s-%(sc)s.sh' % vars())
              os.system('%(JOBSUBMIT)s jobs/%(JOB)s-%(sc)s.sh' % vars())
            else:
              JOB='DYJetsToTauTau%s_%s_%s' % (sp,ch,YR)
              os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_DYJetsToLL%(sp)s_%(ch)s_skim.dat --channel=%(ch)s'
          ...
          if sc in ['0']:
            ...
            os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_DYJetsToLL_%(ch)s_skim.dat --channel=%(ch)s'
        ...
        if ch in ['em'] and sc in ['0']:
          ...
          for sp in soups: 
            JOB='DYJetsToTauTau%s_%s_%s' % (sp,ch,YR)
            os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=0 --filelist=%(FILELIST)s_DYJetsToLL%(sp)s_%(ch)s_skim.dat --channel=%(ch)s'
              ' --ztautau_mode=1 --output_name=%(JOB)s.root &> jobs/%(JOB)s-%(sc)s.log" jobs/%(JOB)s-%(sc)s.sh' % vars())
            os.system('%(JOBSUBMIT)s jobs/%(JOB)s-%(sc)s.sh' % vars())
            if sc in ['0']:
              JOB='DYJetsToLL%s_%s_%s' % (sp,ch,YR)
        ...
        for sa in central_samples:
          if sc in ['0']:
            ...
            os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_%(sa)s_%(ch)s_skim.dat --channel=%(ch)s'
        ...
        if ch in ['et', 'mt']  and (PRODUCTION == 'June6' or PRODUCTION == 'Apr11'):
          if sc in ['0']:
            ...
            os.system('%(JOBWRAPPER)s "./bin/HiggsHTohh --cfg=%(CONFIG)s %(PREFIXMC)s --tau_scale_mode=%(sc)s --filelist=%(FILELIST)s_Special_5_WJetsToLNuSoup_%(ch)s_skim.dat --channel=%(ch)s'
