...
#
#  JOB="$i"_et_skim
#  $JOBWRAPPER "./bin/HiggsHTohh --is_data=1 --cfg=$CONFIG --filelist="$FILELIST"_"$i".dat --channel=et --output_folder=./ --output_name=Dummy_$JOB.root \
...
#
#  JOB="$i"_mt_skim
#  $JOBWRAPPER "./bin/HiggsHTohh --is_data=1 --cfg=$CONFIG --filelist="$FILELIST"_"$i".dat --channel=mt --output_folder=./ --output_name=Dummy_$JOB.root \
...
#
#   JOB="$i"_et_skim
#   $JOBWRAPPER "./bin/HiggsHTohh --is_data=0 --cfg=$CONFIG --filelist="$FILELIST"_"$i".dat --channel=et --output_folder=./ --output_name=Dummy_$JOB.root \
#   --do_skim=true --skim_path=$SKIMPATH/et_skim/$i/ --input_prefix=$PREFIX &> jobs/$JOB.log ; \
#   ./scripts/hadd_and_filelist.sh $SKIMPATH et_skim/"$i" "$FILELIST"_"$JOB".dat" jobs/$JOB.sh
#   $JOBSUBMIT jobs/$JOB.sh
# done
...
#
#   JOB="$i"_mt_skim
#   $JOBWRAPPER "./bin/HiggsHTohh --is_data=0 --cfg=$CONFIG --filelist="$FILELIST"_"$i".dat --channel=mt --output_folder=./ --output_name=Dummy_$JOB.root \
#   --do_skim=true --skim_path=$SKIMPATH/mt_skim/$i/ --input_prefix=$PREFIX &> jobs/$JOB.log ; \
#   ./scripts/hadd_and_filelist.sh $SKIMPATH mt_skim/"$i" "$FILELIST"_"$JOB".dat" jobs/$JOB.sh
#   $JOBSUBMIT jobs/$JOB.sh
# done
