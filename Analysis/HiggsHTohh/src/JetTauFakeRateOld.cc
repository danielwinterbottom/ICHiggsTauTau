#include "UserCode/ICHiggsTauTau/Analysis/HiggsHTohh/interface/JetTauFakeRateOld.h"
...
namespace ic {
	...
	JetTauFakeRateOld::JetTauFakeRateOld(std::string const& name) : ModuleBase(name) { 
	...
	JetTauFakeRateOld::~JetTauFakeRateOld() {
		;
	}

	int JetTauFakeRateOld::PreAnalysis() {
		std::cout << "-------------------------------------" << std::endl;
		std::cout << "JetTauFakeRateOld" << std::endl;
		std::cout << "-------------------------------------" << std::endl;    
		if (fs_) {
	...
	int JetTauFakeRateOld::Execute(TreeEvent *event) {
...
/*						standard_tau_histos_["dm_taupt_match"]->Fill(jets.at(jetit)->pt());
	...
	int JetTauFakeRateOld::PostAnalysis() {
		std::cout << "-------------------------------------" << std::endl;
		std::cout << "JetTauFakeRateOld" << std::endl;
		std::cout << "-------------------------------------" << std::endl;      
		return 0;
	}
	void JetTauFakeRateOld::PrintInfo() {
		;
	}
}
