...
namespace ic {
	...
	JetTauFakeRateNew::JetTauFakeRateNew(std::string const& name) : ModuleBase(name) { 
	...
	JetTauFakeRateNew::~JetTauFakeRateNew() {
		;
	}

	int JetTauFakeRateNew::PreAnalysis() {
		std::cout << "-------------------------------------" << std::endl;
	...
	int JetTauFakeRateNew::Execute(TreeEvent *event) {
	...
	int JetTauFakeRateNew::PostAnalysis() {
		std::cout << "-------------------------------------" << std::endl;
		std::cout << "JetTauFakeRate" << std::endl;
		std::cout << "-------------------------------------" << std::endl;      
		return 0;
	}
	void JetTauFakeRateNew::PrintInfo() {
		;
	}
}
