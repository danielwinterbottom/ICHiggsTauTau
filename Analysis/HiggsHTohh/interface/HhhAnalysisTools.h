#ifndef ICHiggsTauTau_HiggsHTohh_HhhAnalysisTools_h
#define ICHiggsTauTau_HiggsHTohh_HhhAnalysisTools_h
#include <iostream>
#include <vector>
#include <map>
...
namespace ic {
  ...
  class HhhAnalysis {
    ...
    public:
      ...
      HhhAnalysis(ic::channel ch, std::string year, int verbosity);
      ...
      */
      ...
      double KolmogorovTest(std::string const& variable,
                              ...
                              std::string const& weight);
      double WTTTemplateFit(TH1F* data, TH1F* W, TH1F* TT, double mt_min);
