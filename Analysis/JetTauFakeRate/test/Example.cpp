...
//Add our example module which reads in the filtered taus and jets and writes some variables to a flat tree

 ExampleModule exampleModule = ExampleModule("exampleModule")
 ...
 //Add modules to the analysis sequence 
  analysis.AddModule(&JetFilter); 
  analysis.AddModule(&TauFilter); 
	analysis.AddModule(&exampleModule);
