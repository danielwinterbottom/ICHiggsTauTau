#ifndef ICHiggsTauTau_Module_ZPassOffline_h
#define ICHiggsTauTau_Module_ZPassOffline_h
...
class ZPassOffline : public ModuleBase {
   public:
      ZPassOffline(std::string const& name, std::string channel, fwlite::TFileService *fs, L1Cuts l1Cuts, std::string L1MuTag, std::string subDirName, int option);
      virtual ~ZPassOffline(); 
