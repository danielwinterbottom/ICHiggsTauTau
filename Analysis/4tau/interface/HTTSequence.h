#ifndef ICHiggsTauTau_4tau_HTTSequence_h
#define ICHiggsTauTau_4tau_HTTSequence_h
...
class HTTSequence {
 private:
  ...
  double lead_tau_pt, lead_min_taus;
 ...
 public:
  ...
  void BuildSequence();
  void BuildTTTTProducts();
  void BuildMTTTProducts();
  void BuildETTTProducts();
