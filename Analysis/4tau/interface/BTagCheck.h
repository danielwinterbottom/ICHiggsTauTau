...
class BTagCheck : public ModuleBase {
 private:
  ...
  CLASS_MEMBER(BTagCheck, bool, use_deep_jet)
  CLASS_MEMBER(BTagCheck, std::string, wp_to_check)
...
//      BTagCalibration calib("csvv2","UserCode/ICHiggsTauTau/Analysis/4tau/input/btag_sf/CSVv2.csv");
