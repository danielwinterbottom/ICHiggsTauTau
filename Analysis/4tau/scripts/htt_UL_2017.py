...
# python scripts/htt_UL_2017.py --bkg --data --jetmetuncerts --scales="default,scale_t_0pi,scale_t_1pi,scale_t_3prong,scale_t_3prong1pi0,scale_efake_0pi,scale_efake_1pi,scale_mufake_0pi,scale_mufake_1pi,scale_e" --submit='./scripts/submit_ic_batch_job.sh "hep.q -l h_rt=0:180:0 -l h_vmem=24G"' --parajobs
...
if options.proc_sig:
    ...
    for sa in signal_mc:
        ...
        #user='guttley'
        SIG_DIR = 'Nov09_Signal_106X_2017'
        SIG_FILELIST = "filelists/Nov09_2017_MC_106X"
        user='ksavva'
        JOB='%s_2017' % (sa)
