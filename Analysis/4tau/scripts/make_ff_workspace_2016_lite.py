...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/mvadm_ff_deeptauV2p1_2016_et/' % vars()
  ...
  for dm in dm_bins:
    ...
    for njet in ['0_crosstrg','1_crosstrg','2_crosstrg']:
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_qcd_fit("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_qcd_fit_uncert1_up("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_qcd_fit_uncert2_up("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_qcd_fit_uncert_nom("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_wjets_fit("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_wjets_fit_uncert1_up("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_wjets_fit_uncert2_up("0*@0",pt[0])' % vars())
      w.factory('expr::et_%(dm)s_njets%(njet)s_%(wp)s_wjets_fit_uncert_nom("0*@0",pt[0])' % vars())
    for njet in ['0','1','2']:#,'0_crosstrg','1_crosstrg','2_crosstrg']:
      ...
      hist_w_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2016.root:%(dm)s_njets%(njet)s_pt_2_ff_wjets_uncert' % vars())
      hist_qcd_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2016.root:%(dm)s_njets%(njet)s_pt_2_ff_qcd_uncert' % vars())
...
# systematic shifts for ttbar
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    w.factory('expr::et_%(dmname)s_%(wp)s_wjets_e_pt_corr("(@4<25)+(@4>25)*((@0==0)*(@1) + (@0==1)*(@2) + (@0>1)*(@3))",njets[0],et_%(dmname)s_%(wp)s_wjets_e_pt_corr_njet0,et_%(dmname)s_%(wp)s_wjets_e_pt_corr_njet1,et_%(dmname)s_%(wp)s_wjets_e_pt_corr_njet2,e_pt[0])' % vars())
    ...
    for njet in ['0','1','2']:
      func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2016.root:%(dmtype)s_WpT_corr_njet%(njet)s_wjets_mc_fit' % vars())
      corr_str = str(func.GetExpFormula('p')).replace('x','@0').replace(',false','')
...
# new from here
    ...
    for njet in ['0','1']:
      for pt in ['20to30','30to40','gt40']:
        func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2016.root:%(dmtype)s_pt_1_closure_njet%(njet)s_taupt%(pt)s_qcd_fit' % vars())
        corr_str = str(func.GetExpFormula('p')).replace('x','@0').replace(',false','')
    ...
    w.factory('expr::et_%(dmname)s_%(wp)s_qcd_e_pt_corr("(@3<25)+(@3>25)*((@0==0)*(@1) + (@0>0)*(@2))",njets[0],et_%(dmname)s_%(wp)s_qcd_e_pt_corr_njet0,et_%(dmname)s_%(wp)s_qcd_e_pt_corr_njet1,e_pt[0])' % vars())
# end of new
...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/mvadm_ff_deeptauV2p1_2016_mt_ip0p5/' % vars()
...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/mvadm_ff_deeptauV2p1_2016_tt_ip0p5_nopu/' % vars()
...
#    w.factory('expr::tt_%(dmtype)s_%(wp)s_qcd_corr("(@0==0)*(@1) + (@0>0)*(@2)",njets[0], tt_%(dmtype)s_%(wp)s_qcd_corr_njet0, tt_%(dmtype)s_%(wp)s_qcd_corr_njet1)' % vars())
    ...
    w.factory('expr::tt_%(dmtype)s_%(wp)s_qcd_corr("(@0==0)*(1.22618-0.0546679*@1) + (@0>0)*(1.09292-0.0200048*@1)",njets[0], dR[2])' % vars())
