...
# ./scripts/makeDatacards_cpdecay_2016_tauID_SF.py --cfg=scripts/plot_tauid_2016.cfg -c 'mt,zmm' scripts/plot_tauid_2016.cfg -s 'cpdecay' --embedding 
...
if SCHEME == 'cpdecay':
  ...
  ADD_STRING_MT_GENERAL = '--add_wt=\"(single_l_sf/idisoweight_2)*wt_btag\" --set_alias="inclusive:(n_bjets==0&&trg_singlemuon&&pt_1>25)" --set_alias=\"baseline:(iso_1<0.15&&deepTauVsJets_medium_2>0.5&&deepTauVsEle_tight_2>0.5&&deepTauVsMu_tight_2>0.5&&leptonveto==0&&trg_singlemuon&&pt_1>23)\"  --set_alias=\"sel:(mt_1<50)\" --set_alias=\"inclusive:(n_bjets==0&&trg_singlemuon&&pt_1>25&&'
