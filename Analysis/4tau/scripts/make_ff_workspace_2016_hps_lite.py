...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/hpsdm_ff_deeptauV2p1_2016_et/' % vars()
...
w.Print()
w.writeToFile('fakefactors_ws_et_hps_lite_2016.root')
w.Delete()
...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/hpsdm_ff_deeptauV2p1_2016_mt/' % vars()
...
w.Print()
w.writeToFile('fakefactors_ws_mt_hps_lite_2016.root')
w.Delete()
...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTauRun2/hpsdm_ff_deeptauV2p1_2016_tt/' % vars()
...
w.Print()
w.writeToFile('fakefactors_ws_tt_hps_lite_2016.root')
w.Delete() 
