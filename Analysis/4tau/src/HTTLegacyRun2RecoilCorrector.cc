#include "UserCode/ICHiggsTauTau/Analysis/4tau/interface/HTTLegacyRun2RecoilCorrector.h"
...
namespace ic {
  ...
  int HTTLegacyRun2RecoilCorrector::PreAnalysis() {
    ...
    if (strategy_ ==strategy::fall15){
      process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/recoilMvaMEt_76X_newTraining_MG5.root";
      syst_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/MEtSys.root";
      ...
      process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/MvaMET_MG_2016BCD_RooT_5.2.root";
      if(met_label_ == "pfMET"){
          process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/TypeI-PFMet_Run2016BtoH.root";
      }
      syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PFMEtSys_2016.root";
      if (use_puppimet_) {
        process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/Type1_PuppiMET_2016.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PuppiMETSys_2016.root";
      }
    } else if (strategy_ == strategy::cpsummer17 || strategy_ == strategy::cpdecays17) {
      if(met_label_ == "pfMET"){
        process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/Type1_PFMET_2017.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PFMEtSys_2017.root";
      } 
      if (use_puppimet_){
        process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/Type1_PuppiMET_2017.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PuppiMETSys_2017.root";
      }

    } else if (strategy_ == strategy::cpdecays18) {
      if(met_label_ == "pfMET"){
        process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/TypeI-PFMet_Run2018.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PFMETSys_2018.root"; 
      }
      if (use_puppimet_){
        process_file = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/Type1_PuppiMET_2018.root";
        syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PuppiMETSys_2018.root";
      }
    } else{
