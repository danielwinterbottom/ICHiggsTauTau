#include "UserCode/ICHiggsTauTau/Analysis/4tau/interface/HTTEventClassifier.h"
...
namespace ic {
  ...
  int HTTEventClassifier::PreAnalysis() {
    ...
    if ((era_ == era::data_2017 || era_ == era::data_2017UL)) {
      ...
      filename_odd  = (std::string)getenv("CMSSW_BASE") +
          "/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/MVA/multi_fold0_sm_tt_tauspinner_2018_xgb.xml"; // apply to odd
    }
