...
namespace ic {
  ...
  int HTTCategories::PreAnalysis() {
    ...
    if (!is_data_) {
      ...
      if(is_embedded_) {
        if(era_ == era::data_2016) ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_embed_2016.root";
        if(era_ == era::data_2017) ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_embed_2017.root";
        else                       ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_embed_2018.root";

        if(era_ == era::data_2016) ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_embed_2016.root";
        if(era_ == era::data_2017) ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_embed_2017.root";
        else                       ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_embed_2018.root";
      } else {
        if(era_ == era::data_2016) ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_2016.root";
        if(era_ == era::data_2017) ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_2017.root";
        else                       ip_corr_filename = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ip_2018.root";

        if(era_ == era::data_2016) ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_2016.root";
        if(era_ == era::data_2017) ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_2017.root";
        else                       ip_corr_filename_elecs = TString(cmsswBase)+"/src/UserCode/ICHiggsTauTau/Analysis/4tau/input/ip_corrs/ipEle_2018.root";
      }
