...
#include "4tau/interface/HTTPairGenInfo.h"
...
#include "4tau/interface/BTagWeightLegacyRun2.h"
...
httFourTauSelector.set_gen_taus_label("genParticles");
...
// TO DO: Update MET filters for UL
if(do_met_filters){
...
//  }
// 
//  // TO DO: Check if btag efficiencies have changed for UL 
//  if(!is_data && !is_embedded){
//    TH2F bbtag_eff;
//    TH2F cbtag_eff;
//    TH2F othbtag_eff;
...
//  }
//  
//   TO DO: Unsure if this needs to change for 4tau search
//  if(!usePFMET){
