#include "UserCode/ICHiggsTauTau/Analysis/4tau/interface/HTTFakeFactorWeights.h"
...
namespace ic {
  ...
  int HTTFakeFactorWeights::PreAnalysis() {
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16 || strategy_ == strategy::cpdecays17 ) && channel_==channel::tt) {
      TFile f((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/"+ff_file_).c_str());
      ...
      TFile f_dm((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/"+hps_file_).c_str());
      ...
      TFile f_us((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/"+us_file_).c_str());
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16||strategy_==strategy::cpdecays17) && (channel_==channel::mt)) {
      TFile f_fracs((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_mt_2018.root").c_str());
      ...
      TFile f_fracs_ss((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_mt_2018_ss.root").c_str());
      ...
      TFile f_fracs_aiso((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_mt_2018_aiso.root").c_str());
      ...
      TFile f_fracs_highmt((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_mt_2018_highmt.root").c_str());
      ...
      std::string xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2018_mt.xml";
      if(strategy_ == strategy::legacy16) xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2016_mt.xml";
      if(strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpsummer17 ) xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2017_mt.xml";
    ...
    if((strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16||strategy_==strategy::cpdecays17) && (channel_==channel::et)) {
      ...
      TFile f_fracs((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_et_2018.root").c_str());
      ff_fracs_qcd_ = (TH2D*)f_fracs.Get("QCD");
      ff_fracs_wjets_ = (TH2D*)f_fracs.Get("W");
      ff_fracs_qcd_->SetDirectory(0);
      ff_fracs_wjets_->SetDirectory(0);
      ...
      TFile f_fracs_ss((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_et_2018_ss.root").c_str());
      ff_fracs_qcd_ss_ = (TH2D*)f_fracs_ss.Get("QCD");
      ff_fracs_wjets_ss_ = (TH2D*)f_fracs_ss.Get("W");
      ff_fracs_qcd_ss_->SetDirectory(0);
      ff_fracs_wjets_ss_->SetDirectory(0);
      ...
      TFile f_fracs_aiso((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_et_2018_aiso.root").c_str());
      ff_fracs_qcd_aiso_ = (TH2D*)f_fracs_aiso.Get("QCD");
      ff_fracs_wjets_aiso_ = (TH2D*)f_fracs_aiso.Get("W");
      ff_fracs_qcd_aiso_->SetDirectory(0);
      ff_fracs_wjets_aiso_->SetDirectory(0);
      ...
      TFile f_fracs_highmt((baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/mva_fract_et_2018_highmt.root").c_str());
      ff_fracs_qcd_highmt_ = (TH2D*)f_fracs_highmt.Get("QCD");
      ff_fracs_wjets_highmt_ = (TH2D*)f_fracs_highmt.Get("W");
      ff_fracs_qcd_highmt_->SetDirectory(0);
      ff_fracs_wjets_highmt_->SetDirectory(0);
...
//              ff_ws_->function(("ff_et_medium_mvadmbins"+s).c_str())->functor(ff_ws_->argSet("pt,mvadm,ipsig,njets,e_pt,os,met_var_qcd,met_var_w,mt,e_iso,pass_single,mvis,wjets_frac,qcd_frac,ttbar_frac")));   
      ...
      reader_->AddVariable( "mva_dm_2", &mva_dm_2_ );
      reader_->AddVariable( "mt_1", &mt_1_ );
      std::string xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2018_et.xml";
      if(strategy_ == strategy::legacy16) xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2016_et.xml";
      if(strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpsummer17 ) xml_file=baseDir+"UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/fractions_2017_et.xml";
      reader_->BookMVA( "BDT method", xml_file );
    ...
    for(unsigned i=0; i<category_names_.size(); ++i){
      ...
      if(strategy_ == strategy::mssmsummer16) ff_file_name = "UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/Jet2TauFakesFiles/"+ff_file_+"/"+channel+"/"+category_names_[i]+"/fakeFactors_"+ff_file_+".root";
      if(strategy_ == strategy::smsummer16 || strategy_ == strategy::cpsummer16){
        ff_file_name = "UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/Jet2TauFakesFiles2016/"+ff_file_;
      }
      if(strategy_ == strategy::cpsummer17 || strategy_ == strategy::cpdecays17){
        ff_file_name = "UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/Jet2TauFakesFilesNew/"+ff_file_;
      }
      if(strategy_ == strategy::cpdecays18){
        ff_file_name = "UserCode/ICHiggsTauTau/Analysis/4tau/input/fake_factors/Jet2TauFakesFiles2018New/"+ff_file_;
      }
