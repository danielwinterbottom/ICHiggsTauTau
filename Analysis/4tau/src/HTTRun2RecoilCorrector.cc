#include "UserCode/ICHiggsTauTau/Analysis/4tau/interface/HTTRun2RecoilCorrector.h"
...
namespace ic {
  ...
  int HTTRun2RecoilCorrector::PreAnalysis() {
    ...
    if (strategy_ ==strategy::fall15){
      ...
      syst_file    = "UserCode/ICHiggsTauTau/Analysis/4tau/input/recoilfits/PFMEtSys_2017.root"; // update when available
    } else{
