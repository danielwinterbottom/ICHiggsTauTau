...
for SYST in MUEFFUP MUEFFDOWN #central ELEEFFUP ELEEFFDOWN MUEFFUP MUEFFDOWN #JESUP JESDOWN JERBETTER JERWORSE UESUP UESDOWN #ELEEFFUP ELEEFFDOWN MUEFFUP MUEFFDOWN #NOTE TO RUN JER DOSMEAR MUST BE SET TO TRUE IN THE CONFIG
  do
  SYSTOPTIONS="--dojessyst=false --dojersyst=false"
  JOBDIRPREFIX=jobs_lighttree_160412
  JOBDIR=$JOBDIRPREFIX/
  OUTPUTPREFIX=/vols/cms02/magnan/Hinvisible/RunIILT/output_lighttree_160412
