...
#        for replinebit in replinebits:
#           print replinebit
        evoutstring="   "+replinebits[6]+" events have been processed"
        #eventlist.write("EVT_MC_"+samplename+":"+replinebits[6]+"\n")
        eventlist.write("EVT_"+datasettype+"_"+samplename+":"+replinebits[6]+"\n")
        print evoutstring
