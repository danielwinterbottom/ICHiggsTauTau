...
for SYST in JESUP JESDOWN JERBETTER JERWORSE UESUP UESDOWN ELEEFFUP ELEEFFDOWN MUEFFUP MUEFFDOWN #NOTE SYSTEMATIC RUNS WILL BE SAME AS CENTRAL BUT OUTPUT WILL GO TO SYSTEMATIC SUBDIRECTORIES
  ...
  JOBDIRPREFIX=/vols/cms/rd1715/HiggsToInv/jobs_lighttree_${PRODUCTION}_ICHEP_POGrecommendations
  #JOBDIRPREFIX=/vols/cms/rd1715/HiggsToInv/jobs_lighttree_161031_full_cut
  #JOBDIRPREFIX=jobs_lighttree_${PRODUCTION}
  JOBDIR=$JOBDIRPREFIX/
  OUTPUTPREFIX=/vols/cms/rd1715/HiggsToInv/output_lighttree_${PRODUCTION}_ICHEP_POGrecommendations
