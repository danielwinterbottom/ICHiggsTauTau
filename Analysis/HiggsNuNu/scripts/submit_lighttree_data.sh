...
for SYST in central #JESUP JESDOWN JERBETTER JERWORSE UESUP UESDOWN #NOTE SYSTEMATIC RUNS WILL BE SAME AS CENTRAL BUT OUTPUT WILL GO TO SYSTEMATIC SUBDIRECTORIES
  do
