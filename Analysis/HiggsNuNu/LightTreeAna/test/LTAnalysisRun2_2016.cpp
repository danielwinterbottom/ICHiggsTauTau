...
int main(int argc, char* argv[]){
  ...
  config.add_options()
    ...
    ("input_folder,i",           po::value<std::string>(&inputfolder)->default_value("/vols/cms/rd1715/HiggsToInv/output_lighttree_160709/"))
    ...
    ("input_params,p",           po::value<std::string>(&inputparams)->default_value("../filelists/160709/Params160709.dat"))
