...
//   if (doTight) {
//     //eta 0-0.8
//     syst[0][0] = 0.038//0.042;
//     syst[0][1] = 0.036//0.044;
//       syst[0][2] = 0.009//0.002;
//       syst[0][3] = 0.002//0.002;
//       syst[0][4] = 0.001//0.001;
//       syst[0][5] = 0.003//0.001;
//     //eta 0.8-1.442
//       syst[1][0] = 0.043//0.024;
//       syst[1][1] = 0.034//0.008;
//       syst[1][2] = //0.005;
//       syst[1][3] = //0.005;
//       syst[1][4] = //0.001;
//       syst[1][5] = //0.004;
...
//       syst[4][5] = //0.001;
//   }
//relative error on SF nb this is used as the error on the data eff for loose
    //eta 0-0.8
  syst[0][0] = 0.11;
  syst[0][1] = 0.069;
  syst[0][2] = 0.014;
