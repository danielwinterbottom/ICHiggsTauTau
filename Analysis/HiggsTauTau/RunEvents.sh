...
#./bin/HiggsTauTauTrigger --cfg=./scripts/Trigger_2016.cfg --filelist=TauTauv5.dat --channel=et --is_data=0 --output_name=RateVsEffV5/etOutput_${SGE_TASK_ID}.root --line=${SGE_TASK_ID} --l1input=InputElecTauTriggers.txt
