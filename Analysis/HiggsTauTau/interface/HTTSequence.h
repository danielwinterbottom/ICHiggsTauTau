...
class HTTSequence {
 private:
  ...
  Json::Value js;
  double tau_pt, tight_tau_pt, tau_eta, tau_iso, tau_dz;
  ...
  unsigned min_taus, tight_min_taus, new_svfit_mode, kinfit_mode, mva_met_mode, faked_tau_selector, hadronic_tau_selector;
