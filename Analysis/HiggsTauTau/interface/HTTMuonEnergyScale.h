#ifndef ICHiggsTauTau_HiggsTauTau_HTTMuonEnergyScale_h
#define ICHiggsTauTau_HiggsTauTau_HTTMuonEnergyScale_h
...
class HTTMuonEnergyScale : public ModuleBase {
 private:
  ...
  CLASS_MEMBER(HTTMuonEnergyScale, double, pos_far_endcap)
  CLASS_MEMBER(HTTMuonEnergyScale, double, near_endcap)
  CLASS_MEMBER(HTTMuonEnergyScale, double, neg_far_endcap)
