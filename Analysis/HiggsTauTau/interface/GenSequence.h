#ifndef ICHiggsTauTau_HiggsTauTau_GenSequence_h
#define ICHiggsTauTau_HiggsTauTau_GenSequence_h
...
class GenSequence {
 ...
 public:
  ...
  GenSequence(std::string & chan, std::string postf, Json::Value const& js);
  GenSequence() = default;
  ~GenSequence();
