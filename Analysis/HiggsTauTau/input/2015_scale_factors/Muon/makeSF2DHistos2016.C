void makeSF2DHistos2016(){
  TH1::AddDirectory(kFALSE);
  TFile *fMuon_Mu8_eff = TFile::Open("Muon_Mu8_eff_Spring16.root");
 ...
 fMuon_Mu8_eff->Close();
  ...
  TFile *fMuon_Mu17_eff = TFile::Open("Muon_Mu17_eff_Spring16.root");
 ...
 fMuon_Mu17_eff->Close();
  ...
  TFile *fMuon_MuonIdIso0p10_eff = TFile::Open("Muon_IdIso_eff_Spring16.root");
  ...
  ptbinsIdIso0p10[nbinsIdIso0p10] = 1000;
...
/*  TFile *fMuon_MuonIdIso0p15_eff = TFile::Open("Muon_IdIso0p15_fall15.root");
 ...
 fMuon_MuonIdIso0p15_eff->Close();*/
  ...
  TFile *fMuon_MuonSingleMu_eff = TFile::Open("Muon_IsoMu20_eff_Spring16.root");
  ...
  ptbinsSingleMu[nbinsSingleMu] = 1000;
  TH2D *muon_muSingleMu_mc = new TH2D("Muon_SingleMu20_MC_eff","Muon_SingleMu20_MC_eff",nbinseta,etabins,nbinsSingleMu,ptbinsSingleMu);
  TH2D *muon_muSingleMu_data = new TH2D("Muon_SingleMu20_Data_eff","Muon_SingleMu20_Data_eff",nbinseta,etabins,nbinsSingleMu,ptbinsSingleMu);
 ...
 fMuon_MuonSingleMu_eff->Close();
  ...
  TFile *fMuon_MuonSingleMu22_eff = TFile::Open("Muon_IsoMu22_eff_Spring16.root");
  TGraphAsymmErrors *muSingleMu22_lowetamc = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEtaLt0p9_MC"));
  TGraphAsymmErrors *muSingleMu22_medetamc = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEta0p9to1p2_MC"));
  TGraphAsymmErrors *muSingleMu22_highetamc = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEtaGt1p2_MC"));
  TGraphAsymmErrors *muSingleMu22_lowetadata = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEtaLt0p9_Data"));
  TGraphAsymmErrors *muSingleMu22_medetadata = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEta0p9to1p2_Data"));
  TGraphAsymmErrors *muSingleMu22_highetadata = dynamic_cast<TGraphAsymmErrors*>(fMuon_MuonSingleMu22_eff->Get("ZMassEtaGt1p2_Data"));

  double *muSingleMu22_lowetamc_y = muSingleMu22_lowetamc->GetY();
  double *muSingleMu22_medetamc_y = muSingleMu22_medetamc->GetY();
  double *muSingleMu22_highetamc_y = muSingleMu22_highetamc->GetY();
  double *muSingleMu22_lowetadata_y = muSingleMu22_lowetadata->GetY();
  double *muSingleMu22_medetadata_y = muSingleMu22_medetadata->GetY();
  double *muSingleMu22_highetadata_y = muSingleMu22_highetadata->GetY();
  double* MuonSingleMu22X = muSingleMu22_lowetamc->GetX();//-muSingleMu_lowetamc->GetEXlow();
  double* MuonSingleMu22EX = muSingleMu22_lowetamc->GetEXlow();
  int nbinsSingleMu22 = muSingleMu22_lowetamc->GetN();
  double ptbinsSingleMu22[nbinsSingleMu22+1];
  for(i=0;i<nbinsSingleMu22;i++){
    ptbinsSingleMu22[i] = MuonSingleMu22X[i]-MuonSingleMu22EX[i];
  } 
  ptbinsSingleMu22[nbinsSingleMu22] = 1000;
  TH2D *muon_muSingleMu22_mc = new TH2D("Muon_SingleMu22_MC_eff","Muon_SingleMu22_MC_eff",nbinseta,etabins,nbinsSingleMu,ptbinsSingleMu);
  TH2D *muon_muSingleMu22_data = new TH2D("Muon_SingleMu22_Data_eff","Muon_SingleMu22_Data_eff",nbinseta,etabins,nbinsSingleMu,ptbinsSingleMu);

  for(i=0;i<nbinsSingleMu22;i++){
   muon_muSingleMu22_mc->Fill(0.6,MuonSingleMu22X[i],muSingleMu22_lowetamc_y[i]);
   muon_muSingleMu22_mc->Fill(1,MuonSingleMu22X[i],muSingleMu22_medetamc_y[i]);
   muon_muSingleMu22_mc->Fill(2,MuonSingleMu22X[i],muSingleMu22_highetamc_y[i]);
   muon_muSingleMu22_data->Fill(0.6,MuonSingleMu22X[i],muSingleMu22_lowetadata_y[i]);
   muon_muSingleMu22_data->Fill(1,MuonSingleMu22X[i],muSingleMu22_medetadata_y[i]);
   muon_muSingleMu22_data->Fill(2,MuonSingleMu22X[i],muSingleMu22_highetadata_y[i]);
 }

 fMuon_MuonSingleMu22_eff->Close();


 TFile *Muon_2DHistos = new TFile("Muon_2DHistos_spring16.root","RECREATE");
  muon_muSingleMu_mc->Write();
  muon_muSingleMu_data->Write();
  muon_muSingleMu22_mc->Write();
  muon_muSingleMu22_data->Write();
