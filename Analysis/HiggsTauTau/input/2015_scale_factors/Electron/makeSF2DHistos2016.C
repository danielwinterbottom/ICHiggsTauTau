void makeSF2DHistos2016(){
  ...
  TFile *fElectron_Ele12_eff = TFile::Open("Electron_Ele12_eff_Spring16.root");
 ...
 fElectron_Ele12_eff->Close();
  ...
  TFile *fElectron_Ele17_eff = TFile::Open("Electron_Ele17_eff_Spring16.root");
 ...
 fElectron_Ele17_eff->Close();
  ...
  TFile *fElectron_EleIdIso0p10_eff = TFile::Open("Electron_IdIso_eff_Spring16.root");
...
*/
  ...
  TFile *fElectron_EleSingleEle_eff = TFile::Open("Electron_SingleEle23_eff_Spring16.root");
  ...
  ptbinsSingleEle[nbinsSingleEle] = 1000;
 ...
 TFile *Ele_2DHistos = new TFile("Ele_2DHistos_spring16.root","RECREATE");
