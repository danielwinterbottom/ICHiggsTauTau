...
#	 'WH_ZH_TTH_HToTauTau_M-160'
 ...
 for i in "${PATHS[@]}"
 do
  cd svfit/moriond_svfit_2012_mssm/"$i"_et_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/"$i"_mt_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_UP/"$i"_et_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_UP/"$i"_mt_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_DOWN/"$i"_et_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_DOWN/"$i"_mt_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
 done
...
for i in "${PATHS[@]}"
do
  cd svfit/moriond_svfit_2012_mssm/"$i"_em_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_UP/"$i"_em_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
  cd svfit/moriond_svfit_2012_mssm/TSCALE_DOWN/"$i"_em_2012_SVFIT
  echo `pwd`
  ./submit.sh
  cd -
done 
