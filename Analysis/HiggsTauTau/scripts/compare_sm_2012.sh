...
./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV-moriond-andrew.root htt_mt.inputs-sm-8TeV-lowsignal.root output/JoseMoriond-htt_mt.inputs-sm-8TeV.root \
--labels Wisconsin Imperial Test CERN  --category muTau_vbf --output_file=output/dc_sync/compare_moriond_vbf_mt-sm-8TeV.pdf
./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV-moriond-andrew.root htt_mt.inputs-sm-8TeV-lowsignal.root output/JoseMoriond-htt_mt.inputs-sm-8TeV.root \
--labels Wisconsin Imperial Test CERN  --category muTau_boost_high --output_file=output/dc_sync/compare_moriond_boost_high_mt-sm-8TeV.pdf
./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV-moriond-andrew.root htt_mt.inputs-sm-8TeV-lowsignal.root output/JoseMoriond-htt_mt.inputs-sm-8TeV.root \
--labels Wisconsin Imperial Test CERN  --category muTau_boost_low --output_file=output/dc_sync/compare_moriond_boost_low_mt-sm-8TeV.pdf
./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV-moriond-andrew.root htt_mt.inputs-sm-8TeV-lowsignal.root output/JoseMoriond-htt_mt.inputs-sm-8TeV.root \
--labels Wisconsin Imperial Test CERN  --category muTau_0jet_high --output_file=output/dc_sync/compare_moriond_0jet_high_mt-sm-8TeV.pdf
./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV-moriond-andrew.root htt_mt.inputs-sm-8TeV-lowsignal.root output/JoseMoriond-htt_mt.inputs-sm-8TeV.root \
--labels Wisconsin Imperial Test CERN  --category muTau_0jet_low --output_file=output/dc_sync/compare_moriond_0jet_low_mt-sm-8TeV.pdf
