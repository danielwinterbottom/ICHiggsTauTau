...
# ./bin/DatacardCompare --inputs output/Andrew-htt_mt.inputs-sm-8TeV.root htt_mt.inputs-sm-8TeV.root \
# --labels Wisconsin Imperial  --category muTau_inclusive --output_file=output/dc_sync/compare_hcp_inclusive_mt-sm-8TeV.pdf
...
# ./bin/DatacardCompare --inputs output/JoshuaHCP-htt_et.inputs-sm-8TeV.root htt_et.inputs-sm-8TeV.root \
# --labels Wisconsin Imperial --category eleTau_inclusive --output_file=output/dc_sync/compare_hcp_inclusive_et-sm-8TeV.pdf
...
# ./bin/DatacardCompare --inputs output/JoshuaMoriond-htt_et.inputs-sm-8TeV.root htt_et.inputs-sm-8TeV.root \
# --labels Wisconsin Imperial --category eleTau_inclusive --output_file=output/dc_sync/compare_moriond_inclusive_et-sm-8TeV.pdf
...
# --labels MoriondYields  --category muTau_inclusive --output_file=output/dc_sync/yields_hcp_inclusive_mt-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_mt.inputs-sm-8TeV.root \
# --labels MoriondYields  --category muTau_vbf --output_file=output/dc_sync/yields_hcp_vbf_mt-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_mt.inputs-sm-8TeV.root \
# --labels MoriondYields  --category muTau_boost_high --output_file=output/dc_sync/yields_hcp_boost_high_mt-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_mt.inputs-sm-8TeV.root \
# --labels MoriondYields  --category muTau_boost_low --output_file=output/dc_sync/yields_hcp_boost_low_mt-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_mt.inputs-sm-8TeV.root \
# --labels MoriondYields  --category muTau_0jet_high --output_file=output/dc_sync/yields_hcp_0jet_high_mt-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_mt.inputs-sm-8TeV.root \
# --labels MoriondYields  --category muTau_0jet_low --output_file=output/dc_sync/yields_hcp_0jet_low_mt-sm-8TeV.pdf



# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_inclusive --output_file=output/dc_sync/yields_hcp_inclusive_et-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_vbf --output_file=output/dc_sync/yields_hcp_vbf_et-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_boost_high --output_file=output/dc_sync/yields_hcp_boost_high_et-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_boost_low --output_file=output/dc_sync/yields_hcp_boost_low_et-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_0jet_high --output_file=output/dc_sync/yields_hcp_0jet_high_et-sm-8TeV.pdf

# ./bin/DatacardCompare --inputs Moriond-htt_et.inputs-sm-8TeV.root \
# --labels MoriondYields --category eleTau_0jet_low --output_file=output/dc_sync/yields_hcp_0jet_low_et-sm-8TeV.pdf  



# ./bin/DatacardCompare --mode=2 --inputs Moriond-htt_em.inputs-sm-8TeV.root  \
# --labels MoriondYields   --category emu_vbf --output_file=output/dc_sync/yields_hcp_vbf_em-sm-8TeV.pdf

# ./bin/DatacardCompare --mode=2 --inputs Moriond-htt_em.inputs-sm-8TeV.root  \
# --labels MoriondYields  --category emu_boost_high --output_file=output/dc_sync/yields_hcp_boost_high_em-sm-8TeV.pdf

# ./bin/DatacardCompare --mode=2 --inputs Moriond-htt_em.inputs-sm-8TeV.root  \
# --labels MoriondYields  --category emu_boost_low --output_file=output/dc_sync/yields_hcp_boost_low_em-sm-8TeV.pdf      

# ./bin/DatacardCompare --mode=2 --inputs Moriond-htt_em.inputs-sm-8TeV.root  \
# --labels MoriondYields  --category emu_0jet_high --output_file=output/dc_sync/yields_hcp_0jet_high_em-sm-8TeV.pdf

# ./bin/DatacardCompare --mode=2 --inputs Moriond-htt_em.inputs-sm-8TeV.root  \
# --labels MoriondYields  --category emu_0jet_low --output_file=output/dc_sync/yields_hcp_0jet_low_em-sm-8TeV.pdf
