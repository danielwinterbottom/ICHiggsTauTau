...
#  extra_global += ' --syst_ggh_pt="QCDscale_ggH1in"'
  ...
  #  ("8",   "db03iso0p18",    "db03iso0p18",  BINS_FINE, ''),
  #  ("8",   "db04iso0p07",    "db04iso0p07",  BINS_FINE, ''),
  #  ("8",   "db04iso0p08",    "db04iso0p08",  BINS_FINE, ''),
  #  ("8",   "db04iso0p09",    "db04iso0p09",  BINS_FINE, ''),
  #  ("8",   "db04iso0p1",    "db04iso0p1",  BINS_FINE, ''),
  #  ("8",   "db04iso0p11",    "db04iso0p11",  BINS_FINE, ''),
  #  ("8",   "db04iso0p12",    "db04iso0p12",  BINS_FINE, ''),
  #  ("8",   "db04iso0p13",    "db04iso0p13",  BINS_FINE, ''),
  #  ("8",   "db04iso0p14",    "db04iso0p14",  BINS_FINE, ''),
  #  ("8",   "db04iso0p15",    "db04iso0p15",  BINS_FINE, ''),
  #  ("8",   "db04iso0p16",    "db04iso0p16",  BINS_FINE, ''),
  #  ("8",   "db04iso0p17",    "db04iso0p17",  BINS_FINE, ''),
  #  ("8",   "db04iso0p18",    "db04iso0p18",  BINS_FINE, ''),
  ...
  #  ("8",   "db03allchiso0p14",    "db03allchiso0p14",  BINS_FINE, ''),
  #  ("8",   "db03allchiso0p15",    "db03allchiso0p15",  BINS_FINE, ''),
  #  ("8",   "db03allchiso0p16",    "db03allchiso0p16",  BINS_FINE, ''),
  #  ("8",   "db03allchiso0p17",    "db03allchiso0p17",  BINS_FINE, ''),
  #  ("8",   "db03allchiso0p18",    "db03allchiso0p18",  BINS_FINE, ''),
...
#    ("8",   "inclusive",    "inclusive",  BINS_FINE,  '')
     ("8",   "trk03iso0p02", "trk03iso0p02", BINS_FINE, ''),
     ("8",   "trk03iso0p03", "trk03iso0p03",BINS_FINE, ''),
     ("8",   "trk03iso0p04","trk03iso0p04",BINS_FINE, ''),
     ("8",   "trk03iso0p05","trk03iso0p05",BINS_FINE,''),
     ("8",   "trk03iso0p06","trk03iso0p06",BINS_FINE,''),
     ("8",   "puw03iso0p05","puw03iso0p05",BINS_FINE,''),
     ("8",   "puw03iso0p1","puw03iso0p1",BINS_FINE,''),
     ("8",   "puw03iso0p15","puw03iso0p15",BINS_FINE,''),
     ("8",   "puw04iso0p05","puw04iso0p05",BINS_FINE,''),
     ("8",   "puw04iso0p1","puw04iso0p1",BINS_FINE,''),
     ("8",   "puw04iso0p15","puw04iso0p15",BINS_FINE,''),
#    ("8",   "db03iso0p07",    "db03iso0p07",  BINS_FINE, ''),
#    ("8",   "db03iso0p08",    "db03iso0p08",  BINS_FINE, ''),
#    ("8",   "db03iso0p09",    "db03iso0p09",  BINS_FINE, ''),
#    ("8",   "db03iso0p1",    "db03iso0p1",  BINS_FINE, ''),
...
#    ("8",   "db04iso0p17",    "db04iso0p17",  BINS_FINE, ''),
#    ("8",   "db04iso0p18",    "db04iso0p18",  BINS_FINE, ''),
#    ("8",   "trk03iso0p07",    "trk03iso0p07",  BINS_FINE, ''),
#    ("8",   "trk03iso0p08",    "trk03iso0p08",  BINS_FINE, ''),
#    ("8",   "trk03iso0p09",    "trk03iso0p09",  BINS_FINE, ''),
#    ("8",   "trk03iso0p1",    "trk03iso0p1",  BINS_FINE, ''),
#    ("8",   "trk03iso0p11",    "trk03iso0p11",  BINS_FINE, ''),
#    ("8",   "trk03iso0p12",    "trk03iso0p12",  BINS_FINE, ''),
#    ("8",   "trk03iso0p13",    "trk03iso0p13",  BINS_FINE, ''),
#    ("8",   "trk03iso0p14",    "trk03iso0p14",  BINS_FINE, ''),
#    ("8",   "trk03iso0p15",    "trk03iso0p15",  BINS_FINE, ''),
#    ("8",   "trk03iso0p16",    "trk03iso0p16",  BINS_FINE, ''),
#    ("8",   "trk03iso0p17",    "trk03iso0p17",  BINS_FINE, ''),
#    ("8",   "trk03iso0p18",    "trk03iso0p18",  BINS_FINE, ''),
#    ("5",   "vbf",          "vbf",        BINS,       ' --set_alias="W_Shape_Sample:Special_5_WJetsToLNuSoup"'),
#    ("0",   "0jet_low",     "0jet_low",   BINS_FINE,  ''),
#    ("1",   "0jet_high",    "0jet_high",  BINS_FINE,  ''),
...
#    ("3",   "1jet_high",    "boost_high", BINS_FINE,  ' --set_alias="w_shape_os:1"')
  ...
  scheme_em = [
    ("8", "mtrk03iso0p05", "mtrk03iso0p05", BINS_FINE, ''),
    ("8", "mtrk03iso0p06", "mtrk03iso0p06", BINS_FINE, ''),
    ("8", "mtrk03iso0p07", "mtrk03iso0p07", BINS_FINE, ''),
    ("8", "mtrk03iso0p08", "mtrk03iso0p08", BINS_FINE, ''),
    ("8", "mtrk03iso0p08", "mtrk03iso0p08", BINS_FINE, ''),
    ("8", "mpuw03iso0p05", "mpuw03iso0p05", BINS_FINE, ''),
    ("8", "mpuw03iso0p1", "mpuw03iso0p1", BINS_FINE, ''),
    ("8", "mpuw03iso0p15", "mpuw03iso0p15", BINS_FINE, ''),
    ("8", "mpuw04iso0p05", "mpuw04iso0p05", BINS_FINE, ''),
    ("8", "mpuw04iso0p1", "mpuw04iso0p1", BINS_FINE, ''),
    ("8", "mpuw04iso0p15", "mpuw04iso0p15", BINS_FINE, ''),
#    ("8",   "inclusive",    "inclusive",  BINS_FINE, '')
  #  ("8",   "edb03iso0p1",    "edb03iso0p1",  BINS_FINE, ''),
  #  ("8",   "edb03iso0p11",    "edb03iso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "edb04iso0p1",    "edb04iso0p1",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p11",    "edb04iso0p11",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p12",    "edb04iso0p12",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p13",    "edb04iso0p13",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p14",    "edb04iso0p14",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p15",    "edb04iso0p15",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p16",    "edb04iso0p16",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p17",    "edb04iso0p17",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p18",    "edb04iso0p18",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p19",    "edb04iso0p19",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p20",    "edb04iso0p20",  BINS_FINE, ''),
  #  ("8",   "edb04iso0p21",    "edb04iso0p21",  BINS_FINE, ''),
  #  ("8",   "mdb03iso0p1",    "mdb03iso0p1",  BINS_FINE, ''),
  #  ("8",   "mdb03iso0p11",    "mdb03iso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "eea03iso0p1",    "eea03iso0p1",  BINS_FINE, ''),
  #  ("8",   "eea03iso0p11",    "eea03iso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "mea03iso0p1",    "mea03iso0p1",  BINS_FINE, ''),
  #  ("8",   "mea03iso0p11",    "mea03iso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "edb03allchiso0p1",    "edb03allchiso0p1",  BINS_FINE, ''),
  #  ("8",   "edb03allchiso0p11",    "edb03allchiso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "mdb03allchiso0p1",    "mdb03allchiso0p1",  BINS_FINE, ''),
  #  ("8",   "mdb03allchiso0p11",    "mdb03allchiso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "edb04allchiso0p1",    "edb04allchiso0p1",  BINS_FINE, ''),
  #  ("8",   "edb04allchiso0p11",    "edb04allchiso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "mdb04allchiso0p1",    "mdb04allchiso0p1",  BINS_FINE, ''),
  #  ("8",   "mdb04allchiso0p11",    "mdb04allchiso0p11",  BINS_FINE, ''),
  ...
  #  ("8",   "mdb04iso0p1",    "mdb04iso0p1",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p11",    "mdb04iso0p11",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p12",    "mdb04iso0p12",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p13",    "mdb04iso0p13",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p14",    "mdb04iso0p14",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p15",    "mdb04iso0p15",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p16",    "mdb04iso0p16",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p17",    "mdb04iso0p17",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p18",    "mdb04iso0p18",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p19",    "mdb04iso0p19",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p20",    "mdb04iso0p20",  BINS_FINE, ''),
  #  ("8",   "mdb04iso0p21",    "mdb04iso0p21",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p1",    "mtrk03iso0p1",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p11",    "mtrk03iso0p11",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p12",    "mtrk03iso0p12",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p13",    "mtrk03iso0p13",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p14",    "mtrk03iso0p14",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p15",    "mtrk03iso0p15",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p16",    "mtrk03iso0p16",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p17",    "mtrk03iso0p17",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p18",    "mtrk03iso0p18",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p19",    "mtrk03iso0p19",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p20",    "mtrk03iso0p20",  BINS_FINE, ''),
  #  ("8",   "mtrk03iso0p21",    "mtrk03iso0p21",  BINS_FINE, ''),
#
