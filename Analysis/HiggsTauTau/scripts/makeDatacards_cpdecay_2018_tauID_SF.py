...
if SCHEME == 'cpdecay':
  ...
  ADD_STRING_ZMM = '--add_wt=single_l_sf  --set_alias "sel:(mt_1<40)" ' 
  
  scheme_zmm = [
    ("8",   "inclusive",  "2018_inclusive",        VAR_H_ZMM,         ' {} '),
  ]
  
  scheme_mt = [
    ("12",   "MVADM0_Pt20to40",      "2018_MVADM0_Pt20to40",       VAR_H_MT,  ''),
    ("12",   "MVADM0_PtMoreThan40",  "2018_MVADM0_PtMoreThan40",   VAR_H_MT,  ''),
    ("12",   "MVADM1_Pt20to40",      "2018_MVADM1_Pt20to40",       VAR_H_MT,  ''),
    ("12",   "MVADM1_PtMoreThan40",  "2018_MVADM1_PtMoreThan40",   VAR_H_MT,  ''),
    ("12",   "MVADM2_Pt20to40",      "2018_MVADM2_Pt20to40",       VAR_H_MT,  ''),
    ("12",   "MVADM2_PtMoreThan40",  "2018_MVADM2_PtMoreThan40",   VAR_H_MT,  ''),
    ("12",   "MVADM10_Pt20to40",     "2018_MVADM10_Pt20to40",      VAR_H_MT,  ''),
    ("12",   "MVADM10_PtMoreThan40", "2018_MVADM10_PtMoreThan40",  VAR_H_MT,  ''),
    ("12",   "MVADM11_Pt20to40",     "2018_MVADM11_Pt20to40",      VAR_H_MT,  ''),
    ("12",   "MVADM11_PtMoreThan40", "2018_MVADM11_PtMoreThan40",  VAR_H_MT,  ''),
