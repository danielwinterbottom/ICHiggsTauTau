...
do
  ...
  do
    ...
    export input="/vols/cms/dw515/Offline/output/PartonShower/"$i"HToTauTau_M-125_"$j"_2016.root"
  
    #for k in "${var[@]}"
    #do
    #  ./bin/TheoryUncertainties --doScale=0 --doPDF=0 --doAlphaS=1 --doGen=0 --input=$input --variable=$k --RecreateRenorm=0 --makePlots=1 --channel=$j --outputDirname=$output 
    #done
    #
