...
#'2'
 ...
 do
   ...
   do
     echo "$i"
     ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/$i/electauSkim/filelist.dat --mode=0 --output="$i"_ElecTau_2011.root >> mc_2011_ElecTau.log &
     ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/$i/mutauSkim/filelist.dat --mode=1 --output="$i"_MuTau_2011.root >> mc_2011_MuTau.log &
     wait
   done
 done
 ...
 for j in "${TSCALE[@]}"
 do
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/DYJetsToLL/electauSkim/filelist.dat --mode=0 \
   ...
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/DYJetsToLL/mutauSkim/filelist.dat --mode=1 \
 ...
 for j in "${TSCALE[@]}"
 do
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/DYJetsToTauTau/electauSkim/filelist.dat --mode=0 \
   ...
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/DYJetsToTauTau/mutauSkim/filelist.dat --mode=1 \
 ...
 for j in "${TSCALE[@]}"
 do
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/WJetsToLNuSoup/electauSkim/filelist.dat --mode=0 \
   ...
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/WJetsToLNuSoup/mutauSkim/filelist.dat --mode=1 \
 ...
 for j in "${TSCALE[@]}"
 do
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/TTJets/electauSkim/filelist.dat --mode=0 \
   --special_mode=7 --svfit_override=TTJets_ElecTau_2011.root --output=TTJets_ElecTau_2011.root >> mc_2011_ElecTau.log &
   ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/TTJets/mutauSkim/filelist.dat --mode=1 \
 ...
 echo "Special_$i"
   ...
   do
     ...
     ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/$i/electauSkim/filelist.dat --mode=0 \
       --special_mode=7 --svfit_override="$i"_ElecTau_2011.root --output="$i"_ElecTau_2011.root >> mc_2011_ElecTau.log &
     ../bin/HiggsTauTau --cfg=$CONFIG --tau_scale_mode=$j --filelist=$SOURCE/$i/mutauSkim/filelist.dat --mode=1 \
