...
./bin/DatacardCompare --mode=$2 --inputs $3 $4  \
--labels $7 $8  --show_errs=$6 --category "$1"_1jet_high --output_file=output/dc_sync/compare_1jet_high_$5.pdf
./bin/DatacardCompare --mode=$2 --inputs $3 $4  \
--labels $7 $8  --show_errs=$6 --category "$1"_1jet_low --output_file=output/dc_sync/compare_1jet_low_$5.pdf      
./bin/DatacardCompare --mode=$2 --inputs $3 $4  \
