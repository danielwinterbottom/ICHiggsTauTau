...
PATHS=(
     'Embedded-ET-2012A-13Jul2012-v1'
     'Embedded-ET-2012A-recover-06Aug2012-v1'
     'Embedded-ET-2012B-13Jul2012-v1'
     'Embedded-ET-2012C-24Aug2012-v1'
     'Embedded-ET-2012C-PromptReco-v2'
     )
for i in "${PATHS[@]}"
do
    eval `scramv1 runtime -sh`
...
PATHS=(
     'Embedded-MT-2012A-13Jul2012-v1'
     'Embedded-MT-2012A-recover-06Aug2012-v1'
     'Embedded-MT-2012B-13Jul2012-v1'
     'Embedded-MT-2012C-24Aug2012-v1'
     'Embedded-MT-2012C-PromptReco-v2'
     )
for i in "${PATHS[@]}"
do
    eval `scramv1 runtime -sh`
