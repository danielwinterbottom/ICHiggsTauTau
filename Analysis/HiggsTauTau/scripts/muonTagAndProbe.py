...
trees = {
    'DYJetsToLL': analysis.TTreeEvaluator('ZmmTP', 'output/HTT2016Studies_July19/DYJetsToLL.root'),
    'Data': analysis.TTreeEvaluator('ZmmTP', 'output/HTT2016Studies_July19/SingleMuon.root')
}
