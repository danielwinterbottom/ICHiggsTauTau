...
w.factory('expr::l_pt_bounded120("min(119.9,@0)",m_pt[21])' % vars()) # change me for et channel!!

f = ROOT.TFile('us_fakefactors/ff_files_mt_2018/uncorrected_fakefactors_mt.root')
func = f.Get('rawFF_mt_qcd_0jetSSloose')

loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTau/us_fakefactors/ff_files_mt_2018/' % vars()
...
for uncert in ['','_unc1_up','_unc1_down','_unc2_up','_unc2_down']:
  ...
  w.factory('expr::ff_mt_%(wp)s_wjets%(uncert)s("@0*@1*@2",rawFF_mt_w%(uncert)s, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
...
w.factory('expr::ff_mt_%(wp)s_qcd_l_pt_down("@0*1.1",rawFF_mt_qcd)' % vars())
w.factory('expr::ff_mt_%(wp)s_qcd_l_pt_up("@0*(1+2*(@1-1))*1.1",rawFF_mt_qcd, closure_l_pt_mt_qcd)' % vars())
w.factory('expr::ff_mt_%(wp)s_wjets_l_pt_down("@0*@1",rawFF_mt_w, closure_mt_mt_w_bounded)' % vars())
w.factory('expr::ff_mt_%(wp)s_wjets_l_pt_up("@0*(1+2*(@1-1))*@2",rawFF_mt_w, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
w.factory('expr::ff_mt_%(wp)s_ttbar_l_pt_down("@0",mc_rawFF_mt_tt)' % vars())
w.factory('expr::ff_mt_%(wp)s_ttbar_l_pt_up("@0*(1+2*(@1-1))",mc_rawFF_mt_tt, closure_l_pt_mt_ttmc)' % vars())

w.factory('expr::ff_mt_%(wp)s_qcd_osss_down("@0*@1*1.1*0.9",rawFF_mt_qcd9, closure_l_pt_mt_qcd)' % vars())
w.factory('expr::ff_mt_%(wp)s_qcd_osss_up("@0*@1*1.1*1.1",rawFF_mt_qcd, closure_l_pt_mt_qcd)' % vars())

w.factory('expr::ff_mt_%(wp)s_wjets_mt_unc1_up("@0*@1*@2",rawFF_mt_w_unc1_up, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
w.factory('expr::ff_mt_%(wp)s_wjets_mt_unc1_down("@0*@1*@2",rawFF_mt_w_unc1_down, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
w.factory('expr::ff_mt_%(wp)s_wjets_mt_unc2_up("@0*@1*@2",rawFF_mt_w_unc2_up, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
w.factory('expr::ff_mt_%(wp)s_wjets_mt_unc2_down("@0*@1*@2",rawFF_mt_w_unc2_down, closure_l_pt_mt_w, closure_mt_mt_w_bounded)' % vars())
...
# scale uncerts by fractions

# check qcd OS/SS, add met corr for Wjets 

w.Print()
w.writeToFile('fakefactors_us_ws_mt_lite_2018.root')
w.Delete()
...
loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTau/us_fakefactors/ff_files_tt_2018/' % vars()
...
w.Print()
w.writeToFile('fakefactors_us_ws_tt_lite_2018.root')
w.Delete() 
