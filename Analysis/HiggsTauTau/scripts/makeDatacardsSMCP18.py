...
#./scripts/makeDatacardsSMCP18.py --cfg=scripts/plot_sm_2018.cfg -c 'em,et,mt,tt' scripts/Params_2018_v1.json -s 'cp18_ff' --regional_jes --embedding --total_jes
...
if SCHEME == 'cp18_ff':
  ...
  scheme_et = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_LT, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "boosted",    "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_DIJET, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_ET_LO_HI, '--set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_DIJET, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_ET_TI_HI, '--set_alias="sel:mt_1<50" --do_ff_systs ')
  ]
  scheme_mt = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_LT, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "boosted",    "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_DIJET, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_DIJET, '--set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_DIJET, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_DIJET, '--set_alias="sel:mt_1<50" --do_ff_systs ')

  ]
  scheme_tt = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_TT, ' --do_ff_systs '),
    ("17",   "boosted", "2018_boosted",  VAR_BOOSTED_TT, ' --do_ff_systs '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_DIJET, ' --do_ff_systs '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_TT_LO_HI, ' --do_ff_systs '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_DIJET, ' --do_ff_systs '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_TT_TI_HI, ' --do_ff_systs ')
  ]
  scheme_em = [
...
if SCHEME == 'cp18_ff_newbins':
  ...
  scheme_et = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_LT, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "boosted",    "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_ET_LO_LO, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_ET_LO_HI, '--set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_ET_TI_LO, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_ET_TI_HI, '--set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire ')
  ]
  scheme_mt = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_LT, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "boosted",    "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_MT_LO_LO, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_DIJET, '--set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_MT_TI_LO, ' --set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_DIJET, '--set_alias="sel:mt_1<50" --do_ff_systs --add_wt=wt_prefire ')

  ]
  scheme_tt = [
    ("17",   "0jet",    "2018_0jet",  VAR_0JET_TT, ' --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "boosted", "2018_boosted",  VAR_BOOSTED_TT, ' --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_TT_LO_LO, ' --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_TT_LO_HI, ' --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_TT_TI_LO, ' --do_ff_systs --add_wt=wt_prefire '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_TT_TI_HI, ' --do_ff_systs --add_wt=wt_prefire ')
  ]
  scheme_em = [
    ("19",   "0jet",    "2018_0jet",  VAR_0JET_EM, ' --set_alias="sel:pzeta>-35" --add_wt=wt_prefire '),
    ("19",   "boosted", "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:pzeta>-35" --add_wt=wt_prefire '),
    ("19",   "inclusive",    "2018_ttbar",  'm_sv[50,300]', ' --set_alias="sel:pzeta<-50" --set_alias="inclusive:(n_jets>0)" --add_wt=wt_prefire '),
    ("19",   "dijet_loosemjj_lowboost",     "2018_dijet_loosemjj_lowboost",  VAR_EM_LO_LO, ' --set_alias="sel:pzeta>-10" --add_wt=wt_prefire '),
    ("19",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_EM_LO_HI, ' --set_alias="sel:pzeta>-10" --add_wt=wt_prefire '),
    ("19",   "dijet_tightmjj_lowboost",     "2018_dijet_tightmjj_lowboost",  VAR_EM_TI_LO, ' --set_alias="sel:pzeta>-10" --add_wt=wt_prefire '),
    ("19",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_DIJET, ' --set_alias="sel:pzeta>-10" --add_wt=wt_prefire ')
  ]
  bkg_schemes = {
    'et' : 'et_default',
    'mt' : 'mt_with_zmm',
...
if SCHEME == 'cp18_ff_mvis':
  ...
  scheme_mt = [
    ("17",   "0jet",                       "2018_0jet",  VAR_0JET_LT, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "boosted",                    "2018_boosted",  VAR_BOOSTED, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_lowboost",    "2018_dijet_loosemjj_lowboost", VAR_DIJET_MT_1, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_loosemjj_boosted",     "2018_dijet_loosemjj_boosted",  VAR_DIJET_MT_2, '--set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_lowboost",    "2018_dijet_tightmjj_lowboost", VAR_DIJET_MT_1, ' --set_alias="sel:mt_1<50" --do_ff_systs '),
    ("17",   "dijet_tightmjj_boosted",     "2018_dijet_tightmjj_boosted",  VAR_DIJET_MT_2, '--set_alias="sel:mt_1<50" --do_ff_systs ')
