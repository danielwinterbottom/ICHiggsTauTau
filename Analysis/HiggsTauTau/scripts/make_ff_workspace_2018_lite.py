...
for wp in wps:
  ...
  loc = '%(cmssw_base)s/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTau/mvadm_ff_deeptauV2p1_2018_et/' % vars()
  ...
  for dm in dm_bins:
    for njet in ['0','1','2','0_crosstrg','1_crosstrg','2_crosstrg']:
      ...
      hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dm)s_njets%(njet)s_pt_2_ff_qcd_uncert' % vars())
...
# systematic shifts for ttbar
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    # met correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_wjets_fit' % vars())
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_wjets_uncert' % vars())
    ...
    # pt_1 correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_wjets_fit' % vars())
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_wjets_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
    ...
    # m_vis correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_mvis_corr_wjets_mc_fit' % vars())
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    # met correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_qcd_fit' % vars())
    func_met_corr = str(func.GetExpFormula('p')).replace('x','@0').replace('y','@1')
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_qcd_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
    ...
    # pt_1 correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_qcd_fit' % vars())
    func_e_pt_corr = str(func.GetExpFormula('p')).replace('x','@0').replace('y','@1')
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_qcd_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
    ...
    # OS/SS correction
    func = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_osss_closure_qcd_fit' % vars())
...
# systematic shifts for ttbar
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_met_closure_wjets_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_wjets_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_met_closure_qcd_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_qcd_uncert' % vars())
    (hist_up, hist_down) = wsptools.UncertsFrom2DHist(hist_nom,0.,2.)
