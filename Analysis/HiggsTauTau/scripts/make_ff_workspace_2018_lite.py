...
# systematic shifts for ttbar
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_wjets' % vars())
    hist_nom.Smooth()
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_wjets' % vars())
    hist_nom.Smooth()
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_met_closure_qcd' % vars())
    hist_nom.Smooth()
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_et_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_qcd' % vars())
    hist_nom.Smooth()
...
# systematic shifts for ttbar
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_met_closure_wjets' % vars())
    hist_nom.Smooth()
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_wjets' % vars())
    hist_nom.Smooth()
  ...
  for dmtype in ['mvadm','mvadm_nosig','dm']:
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_met_closure_qcd' % vars())
    hist_nom.Smooth()
    ...
    hist_nom = GetFromTFile(loc+'fakefactor_fits_mt_%(wp)s_2018.root:%(dmtype)s_pt_1_closure_qcd' % vars())
    hist_nom.Smooth()
