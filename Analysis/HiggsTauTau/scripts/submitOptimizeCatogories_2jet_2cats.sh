...
export dirname="2Jet/2/Cats/tight/"$channel"_"$now
mkdir -p $dirname
...
export dirname="2Jet/2/Cats/loose/"$channel"_"$now
mkdir -p $dirname
rm $dirname/cutsInputTemp_$channel.txt
declare -a dEta_loose=( 3 3.5 )
declare -a Mjj_loose=( 400 450 500 550 600 )
declare -a HPt_loose=( 0 10 20 30 40 50 60 )
declare -a dEta=( 3.5 4 )
declare -a Mjj=( 600 650 700 750 800 )
declare -a HPt=( 70 80 90 100 110 120 130 )
declare -a btag=("&& n_bjets==0")
