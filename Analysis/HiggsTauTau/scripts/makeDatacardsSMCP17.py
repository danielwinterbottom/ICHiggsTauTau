...
common_shape_systematics=' --syst_eff_b=CMS_eff_b_13TeV --syst_qcd_scale="CMS_scale_gg_13TeV" --syst_quarkmass="CMS_FiniteQuarkMass_13TeV" --syst_ps="CMS_PS_ggH_13TeV" --syst_ue="CMS_UE_ggH_13TeV" ' 
