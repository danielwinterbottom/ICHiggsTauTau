...
if options.channel == 'tt':
    ...
    mva_highMjj_ggh =      '(IC_highMjj_Sep07_4_max_index==0)'
    mva_highMjj_jetFakes = '(IC_highMjj_Sep07_4_max_index==1)'
    mva_highMjj_qqh =      '(IC_highMjj_Sep07_4_max_index==2)'
    mva_highMjj_zttEmbed = '(IC_highMjj_Sep07_4_max_index==3)'
...
if options.channel in ['et','mt']:
    ...
    mva_highMjj_ggh =      '(IC_highMjj_Sep07_2_max_index==0)'
    mva_highMjj_jetFakes = '(IC_highMjj_Sep07_2_max_index==1)'
    mva_highMjj_qqh =      '(IC_highMjj_Sep07_2_max_index==2)'
    mva_highMjj_tt =       '(IC_highMjj_Sep07_2_max_index==3)'
    mva_highMjj_zll      = '(IC_highMjj_Sep07_2_max_index==4)'
    mva_highMjj_zttEmbed = '(IC_highMjj_Sep07_2_max_index==5)'
    ...
    cats['ggh_highMjj'] =  '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_ggh)
    # cats['misc_highMjj'] = '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_misc)
    cats['qqh_highMjj'] =  '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_qqh)
    cats['tt_highMjj'] =   '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_tt)
    # cats['ztt_highMjj'] =  '({} && n_jets>=2 && mjj>300)'.format(mva_highMjj_ztt)
    cats['zll_highMjj'] =  '({} && n_jets>=2 && mjj>300)'.format(mva_highMjj_zll)
    cats['zttEmbed_highMjj'] =  '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_zttEmbed)
    cats['jetFakes_highMjj'] =  '({} && n_jets>=2 && mjj>350)'.format(mva_highMjj_jetFakes)
...
if options.era in ['smsummer16','cpsummer16']: # Remove the False when finished!!!!!
    if options.channel in ['et','mt'] and options.cat in ['boosted','vbf','dijet','dijet_lowboost','dijet_boosted',
            ...
            'ggh_highMjj','ggh_tight_highMjj','qqh_highMjj','misc_highMjj','qcd_highMjj','qqh_highMjj','tt_highMjj','zll_highMjj','ztt_highMjj','fake_highMjj','jetFakes_highMjj','zttEmbed_highMjj']:
...
if options.syst_qcd_scale != '' and options.cat in ['0jet','boosted','vbf','dijet','dijet_lowboost','dijet_boosted',
            'ggh_lowMjj','qqh_lowMjj','misc_lowMjj','qcd_lowMjj','qqh_lowMjj','tt_lowMjj','zll_lowMjj','ztt_lowMjj','fake_lowMjj','jetFakes_lowMjj','zttEmbed_lowMjj',
            'ggh_highMjj','ggh_tight_highMjj','qqh_highMjj','misc_highMjj','qcd_highMjj','qqh_highMjj','tt_highMjj','zll_highMjj','ztt_highMjj','fake_highMjj','jetFakes_highMjj','zttEmbed_highMjj'] and options.channel in ['em','et','mt','tt'] and options.era == 'smsummer16': 
