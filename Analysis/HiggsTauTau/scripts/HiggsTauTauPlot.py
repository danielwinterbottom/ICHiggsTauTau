...
if options.channel == 'tt':
    ...
    # old is Feb13_fix1
    mva_ggh                = '(IC_Jun13_max_index==0)'
    mva_jetFakes           = '(IC_Jun13_max_index==1)'
    mva_zttEmbed           = '(IC_Jun13_max_index==2)'
...
while len(systematics) > 0:
  ...
  for index, systematic in enumerate(list(systematics.keys())[:max_systs_per_pass]):
      ...
      if options.channel == "tt" and options.era in ['smsummer16','cpsummer16','cpdecay16','mvadm2016']: weight+='*wt_tau_id_tight'
