...
if options.channel == 'tt':
    ...
    mva_highMjj_ggh =      '(IC_highMjj_Sep04_4_max_index==0)'
    mva_highMjj_jetFakes = '(IC_highMjj_Sep04_4_max_index==1)'
    # mva_highMjj_qqh =      '(IC_highMjj_Sep04_3_max_index==2)'
    mva_highMjj_zttEmbed = '(IC_highMjj_Sep04_4_max_index==2)'
...
if options.syst_qcd_scale != '' and options.cat in ['0jet','boosted','vbf','dijet','dijet_lowboost','dijet_boosted',
            'ggh_lowMjj','qqh_lowMjj','misc_lowMjj','qcd_lowMjj','qqh_lowMjj','tt_lowMjj','zll_lowMjj','ztt_lowMjj','fake_lowMjj',
            'ggh_highMjj','qqh_highMjj','misc_highMjj','qcd_highMjj','qqh_highMjj','tt_highMjj','zll_highMjj','ztt_highMjj','fake_highMjj','jetFakes_highMjj','zttEmbed_highMjj'] and options.channel in ['em','et','mt','tt'] and options.era == 'smsummer16': 
    ...
    if options.channel != "tt":
        if options.channel == 'mt':
            if options.era == 'smsummer16' or options.era == 'cpsummer16': 
              anti_isolated_sel = '(mva_olddm_tight_2<0.5 && mva_olddm_vloose_2>0.5 && iso_1<0.15 && antiele_2 && antimu_2 && !leptonveto && pt_2>30 && (trg_singlemuon*(pt_1>23) || trg_mutaucross*(pt_1<23)))'
            elif options.era == 'cpsummer17': 
              anti_isolated_sel = '(mva_olddm_tight_2<0.5 && mva_olddm_vloose_2>0.5 && iso_1<0.15 && antiele_2 && antimu_2 && !leptonveto && pt_1>25 && trg_singlemuon &&pt_2>30)'
            else: 
