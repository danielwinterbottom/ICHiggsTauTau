...
if options.method in [17,18,20] and options.do_ff_systs and options.channel in ['et','mt','tt']:
    processes = ['tt','w','qcd']
    dms = ['dm0', 'dm1']
    njets = ['njet0','njet1']
...
def RunPlotting(ana, cat='',cat_data='', sel='', add_name='', wt='wt', do_data=True, samples_to_skip=[], outfile='output.root',ff_syst_weight=None):
    ...
    if options.method in [17,20] and options.channel != "em":
        doVVJ=False
        doTTJ=False
