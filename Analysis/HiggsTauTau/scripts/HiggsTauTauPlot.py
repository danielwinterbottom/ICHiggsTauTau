...
#systematics['id_up']   = ('' , '_IDUp', 'wt*id_wt_up', [])
#systematics['id_down'] = ('' , '_IDDown', 'wt*id_wt_down', []) 
#systematics['iso_up']   = ('' , '_IsoUp', 'wt*iso_wt_up', [])
#systematics['iso_down'] = ('' , '_IsoDown', 'wt*iso_wt_down', [])  
#systematics['trg_up']   = ('' , '_TrgUp', 'wt*trg_wt_up', [])
#systematics['trg_down'] = ('' , '_TrgDown', 'wt*trg_wt_down', [])  
#systematics['es_up'] = ('TSCALE_UP' , '_ESUp', 'wt', []) 
#systematics['es_down'] = ('TSCALE_DOWN' , '_ESDown', 'wt', [])
