...
FOLDER=./output/Moriond_2013


./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg --folder=./output/Moriond_2013 --tau_scale_mode=0 --channel=et --rebin=1  \
...
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg --folder=./output/Moriond_2013 --tau_scale_mode=0 --channel=mt --rebin=1  \
  --method=8 --category="inclusive" --plot_name="m_vis_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
  --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=false --norm_bins=true --verbose=true \
  --paramfile=scripts/moriond_params_2012.dat
