...
FOLDER="--folder=./output/Paper_2012/"
...
# for i in "${CATS[@]}"
# do
#   ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER   --tau_scale_mode=0 --channel=et --rebin=1  \
...
#   ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER   --tau_scale_mode=0 --channel=mt --rebin=1 \
#     --method="$i" --plot_name="m_sv_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#     --blind=false --x_blind_min=100 --x_blind_max=160 --norm_bins=true --verbose=false \
#     --paramfile=$PARAMS --draw_ss=true
# done
...
#### pTtt
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=et --rebin=2 \
  --method=8 --category="inclusive" --plot_name="pt_tt"  \
  --x_axis_label="Visible di-tau + E_{T}^{miss} p_{T} [GeV]" --norm_bins=false \
  --paramfile=$PARAMS $SCALE_ET_INC --use_ztt_mc=false --draw_ratio=true --log_y=true --signal_no_stack=true

./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=mt --rebin=2 \
  --method=8 --category="inclusive" --plot_name="pt_tt"  \
  --x_axis_label="Visible di-tau + E_{T}^{miss} p_{T} [GeV]" --norm_bins=false \
  --paramfile=$PARAMS $SCALE_MT_INC  --use_ztt_mc=false --draw_ratio=true --log_y=true --signal_no_stack=true

./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=em --rebin=2 \
  --method=8 --category="inclusive" --plot_name="pt_tt" \
  --x_axis_label="Visible di-tau + E_{T}^{miss} p_{T} [GeV]" --norm_bins=false \
  --paramfile=$PARAMS --use_ztt_mc=false --draw_ratio=true --log_y=true --signal_no_stack=true
...
#### MET
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=et --rebin=1 --non_mass_plot=true \
...
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=em  --rebin=1 --non_mass_plot=true \
  --method=8 --category="inclusive" --plot_name="met"  --x_axis_label="E_{T}^{miss} [GeV]" \
  --custom_x_axis_range=true --x_axis_min=0 --x_axis_max=100 \
  --paramfile=$PARAMS --extra_pad=1.1

#### pt_1
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=et --rebin=2 --non_mass_plot=true  \
...
./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg $FOLDER  --channel=em --rebin=2 --non_mass_plot=true \
  --method=8 --category="inclusive" --plot_name="pt_1"  --x_axis_label="Electron p_{T} [GeV]" \
  --custom_x_axis_range=true --x_axis_min=0 --x_axis_max=150 \
  --paramfile=$PARAMS
