...
sample_list = [
   ...
   'GluGluToHToTauTau_NOPOL',
   'GluGluToHToTauTau_NOPOL2',
   'GluGluToHToTauTau_PS_NOPOL',
   'GluGluToHToTauTau_PS_NOPOL2',
   'GluGluToHToTauTau_SM',
   'GluGluToHToTauTau_PS',
   'GluGluToHToTauTau_NOPOL3',
   'GluGluToHToTauTau_NOPOL4',
   'VBFHToTauTau_M125_nospinner',
   'GluGluHToTauTau_M125_nospinner',
   'GluGluToHToTauTau_MM',
   'GluGluToHToTauTau_PS-v2',
