...
# python scripts/makeDatacardsSMCPDecays16.py --cfg=scripts/plot_cpdecays_2016.cfg -c 'et,mt,tt' scripts/Params_2016_cpdecays16.json -s 'mlcpdecays16_new' --embedding --total_jes --batch
...
if SCHEME == 'mlcpdecays16_new':
    ...
    # change from Feb13_fix1 tag to Oct07_tauspinnerPS for checks
    VAR_H_TT              = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"
    VAR_H_TT_MVADM        = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.5,0.6,0.8],(14,0,6.28319)"
    VAR_ZTTEMBED_TT       = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"
    VAR_JETFAKES_TT       = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"

    # finish adding these
    VAR_GGH_TT            = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.4,0.5,0.6],(14,0,6.28319)"
    VAR_QQH_TT            = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.4,0.6],(14,0,6.28319)"
    VAR_GGH_TT_MVADM      = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.3,0.4,0.5,0.6],(14,0,6.28319)"
    VAR_QQH_TT_MVADM      = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.4,0.6],(14,0,6.28319)"
    VAR_GGH_TT_A1         = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.4,0.5,0.6],(14,0,6.28319)"
    VAR_QQH_TT_A1         = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.4,0.6],(14,0,6.28319)"
    VAR_GGH_TT_A1_MVADM   = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.3,0.4,0.5,0.6],(14,0,6.28319)"
    VAR_QQH_TT_A1_MVADM   = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.4,0.6],(14,0,6.28319)"
    VAR_GGH_OTHER_TT      = "IC_Oct07_tauspinnerSM_split_max_score[0.0,0.4,0.5,0.6,0.7,1.0]"
    VAR_QQH_OTHER_TT      = "IC_Oct07_tauspinnerSM_split_max_score[0.0,0.4,0.5,0.6,0.7,0.8,1.0]"

    VAR_H_TT_A1           = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"
    VAR_ZTTEMBED_TT_A1    = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"
    VAR_JETFAKES_TT_A1    = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_1[0.0,0.5,0.6,0.7,0.8],(14,0,6.28319)"

    VAR_H_OTHER_TT        = "IC_Oct07_tauspinnerSM_split_max_score[0.0,0.5,0.6,0.7,0.8,0.9,1.0]"
    VAR_ZTTEMBED_OTHER_TT = "IC_Oct07_tauspinnerSM_split_max_score[0.0,0.5,0.6,0.7,0.8,0.9,1.0]"
    VAR_JETFAKES_OTHER_TT = "IC_Oct07_tauspinnerSM_split_max_score[0.0,0.5,0.6,0.7,0.8,0.9,1.0]"

    VAR_IDG0p5_TT         = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.5,0.7],(14,0,6.28319)"
    VAR_H_IDG0p5_TT       = "IC_Oct07_tauspinnerSM_split_max_score,aco_angle_mod[0.0,0.6],(14,0,6.28319)"
    ...
    scheme_tt = [
        ...
        ("17", "ggh_mvarho",            "ggh_mvarho",            VAR_GGH_TT,                   ' {} '.format(addString_TT)),
        ("17", "qqh_mvarho",            "qqh_mvarho",            VAR_QQH_TT,                   ' {} '.format(addString_TT)),
        ...
        ("17", "ggh_mvaa1rho",            "ggh_mvaa1rho",            VAR_GGH_TT_A1,            ' {} '.format(addString_TT)),
        ("17", "qqh_mvaa1rho",            "qqh_mvaa1rho",            VAR_QQH_TT_A1,            ' {} '.format(addString_TT)),
        ...
        ("17", "ggh_mvaother",      "ggh_mvaother",      VAR_GGH_OTHER_TT,                     ' {} '.format(addString_TT)),
        ("17", "qqh_mvaother",      "qqh_mvaother",      VAR_QQH_OTHER_TT,                     ' {} '.format(addString_TT)),
...
if SCHEME == 'mlcpdecays16_nn_vienna':
    ...
    scheme_mt = []
    scheme_tt = [
    #     ("17", "NN_sm_higgs_rho",          "higgs_rho",          VAR_H_TT,              ' {} '.format(addString_TT)),
    #     ("17", "NN_sm_ggh_rho",            "ggh_rho",            VAR_GGH_TT,            ' {} '.format(addString_TT)),
    #     ("17", "NN_sm_qqh_rho",            "qqh_rho",            VAR_QQH_TT,            ' {} '.format(addString_TT)),
    #     ("17", "NN_sm_zttEmbed_rho",       "zttEmbed_rho",       VAR_ZTTEMBED_TT,       ' {} '.format(addString_TT)),
    #     ("17", "NN_sm_jetFakes_rho",       "jetFakes_rho",       VAR_JETFAKES_TT,       ' {} '.format(addString_TT)),
    #     ("17", "NN_sm_misc_rho",           "misc_rho",           VAR_MISC_TT,           ' {} '.format(addString_TT)),

    #     ("17", "NN_sm_higgs_a1rho",          "higgs_a1rho",          VAR_H_TT_A1RHO,              ' {} '),
    #     ("17", "NN_sm_ggh_a1rho",            "ggh_a1rho",            VAR_GGH_TT_A1RHO,            ' {} '),
    #     ("17", "NN_sm_qqh_a1rho",            "qqh_a1rho",            VAR_QQH_TT_A1RHO,            ' {} '),
    #     ("17", "NN_sm_zttEmbed_a1rho",       "zttEmbed_a1rho",       VAR_ZTT_A1RHOEMBED_TT_A1RHO, ' {} '),
    #     ("17", "NN_sm_jetFakes_a1rho",       "jetFakes_a1rho",       VAR_JETFAKES_TT_A1RHO,       ' {} '),
    #     ("17", "NN_sm_misc_a1rho",           "misc_a1rho",           VAR_MISC_TT_A1RHO,           ' {} '),

    #     ("17", "NN_sm_higgs_other",    "higgs_other",    VAR_H_OTHER_TT,        ' {} '),
    #     ("17", "NN_sm_ggh_other",      "ggh_other",      VAR_GGH_OTHER_TT,      ' {} '),
    #     ("17", "NN_sm_qqh_other",      "qqh_other",      VAR_QQH_OTHER_TT,      ' {} '),
    #     ("17", "NN_sm_zttEmbed_other", "zttEmbed_other", VAR_ZTTEMBED_OTHER_TT, ' {} '),
    #     ("17", "NN_sm_jetFakes_other", "jetFakes_other", VAR_JETFAKES_OTHER_TT, ' {} '),
    #     ("17", "NN_sm_misc_other",     "misc_other",     VAR_MISC_OTHER_TT,     ' {} '),


    ("17", "NN_sm_higgs_mvarho",          "higgs_mvarho",          VAR_H_TT,                     ' {} '.format(addString_TT)),
    ("17", "NN_sm_ggh_mvarho",            "ggh_mvarho",            VAR_GGH_TT,                   ' {} '.format(addString_TT)),
    ("17", "NN_sm_qqh_mvarho",            "qqh_mvarho",            VAR_QQH_TT,                   ' {} '.format(addString_TT)),
    ("17", "NN_sm_zttEmbed_mvarho",       "zttEmbed_mvarho",       VAR_ZTTEMBED_TT,              ' {} '.format(addString_TT)),
    ("17", "NN_sm_jetFakes_mvarho",       "jetFakes_mvarho",       VAR_JETFAKES_TT,              ' {} '.format(addString_TT)),
    ("17", "NN_sm_misc_mvarho",           "misc_mvarho",           VAR_MISC_TT,                  ' {} '.format(addString_TT)),

    ("17", "NN_sm_higgs_mvaa1rho",          "higgs_a1rho",          VAR_H_TT_A1RHO,              ' {} '.format(addString_TT)),
    ("17", "NN_sm_ggh_mvaa1rho",            "ggh_a1rho",            VAR_GGH_TT_A1RHO,            ' {} '.format(addString_TT)),
    ("17", "NN_sm_qqh_mvaa1rho",            "qqh_a1rho",            VAR_QQH_TT_A1RHO,            ' {} '.format(addString_TT)),
    ("17", "NN_sm_zttEmbed_mvaa1rho",       "zttEmbed_a1rho",       VAR_ZTT_A1RHOEMBED_TT_A1RHO, ' {} '.format(addString_TT)),
    ("17", "NN_sm_jetFakes_mvaa1rho",       "jetFakes_a1rho",       VAR_JETFAKES_TT_A1RHO,       ' {} '.format(addString_TT)),
    ("17", "NN_sm_misc_mvaa1rho",           "misc_a1rho",           VAR_MISC_TT_A1RHO,           ' {} '.format(addString_TT)),

    ("17", "NN_sm_higgs_mvaother",    "higgs_mvaother",    VAR_H_OTHER_TT,                       ' {} '.format(addString_TT)),
    ("17", "NN_sm_ggh_mvaother",      "ggh_mvaother",      VAR_GGH_OTHER_TT,                     ' {} '.format(addString_TT)),
    ("17", "NN_sm_qqh_mvaother",      "qqh_mvaother",      VAR_QQH_OTHER_TT,                     ' {} '.format(addString_TT)),
    ("17", "NN_sm_zttEmbed_mvaother", "zttEmbed_mvaother", VAR_ZTTEMBED_OTHER_TT,                ' {} '.format(addString_TT)),
    ("17", "NN_sm_jetFakes_mvaother", "jetFakes_mvaother", VAR_JETFAKES_OTHER_TT,                ' {} '.format(addString_TT)),
    ("17", "NN_sm_misc_mvaother",     "misc_mvaother",     VAR_MISC_OTHER_TT,                    ' {} '.format(addString_TT)),
    ]
...
if SCHEME == 'control_plots':
    addString_TT = ' --do_ff_systs --add_wt=wt_prefire '
    scheme_mt=[]
    scheme_et=scheme_mt
    scheme_tt=[
      # ("17", "inclusive", "dR", 'dR(30,0.5,5.)', '{}'.format(addString_TT)),
      ("17", "inclusive", "n_jets", 'n_jets(10,0.,10.)', '{}'.format(addString_TT)),
