...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=1  \
#       --method="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true --norm_bins=true --verbose=false \
#       --paramfile=$PARAMS

#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=1 \
#       --method="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true  --norm_bins=true --verbose=false \
#       --paramfile=$PARAMS
#   done
...
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=1  \
#       --method="$i" --plot_name="svfit_sm"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true --norm_bins=true --verbose=false \
#       --paramfile=$PARAMS
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=1  \
...
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=1 \
#       --method="$i" --plot_name="svfit_mssm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=1500 --make_datacard=true  --norm_bins=true
#   done
#   CATS=(
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=0 --channel=et --rebin=1  \
...
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=0 --channel=mt --rebin=1 \
#       --method="$i" --plot_name="vis_sm_fine"  --x_axis_label="Visible Mass [GeV]"  --log_y=false --signal_no_stack=false \
#       --blind=false --x_blind_min=60 --x_blind_max=1500 --make_datacard=false  --norm_bins=true
#   done
#   CATS=(
