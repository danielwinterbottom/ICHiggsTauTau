...
CHANNELS_2016 = ['zee', 'zmm','wmnu','tp-zee','tp-zmm']
...
parser.add_option("-c", "--channels", dest="channels", type='string', action='callback',callback=split_callback,
                  help="A comma separated list of channels to ignore.  Supported channels: For data_2016 %(CHANNELS_2016)s" % vars())
...
CONFIG='scripts/Zll_config2016.json'
...
if options.proc_data or options.proc_all:
  data_samples = [
#   'SingleMuon-2016B-17Jul',
#   'MuonEG-2016B-17Jul',
#   'SingleElectron-2016B-17Jul',
#   'Tau-2016B-17Jul',
   'SingleMuonB',
   'SingleElectronB',
   'SingleMuonC',
...
#				#Don't run these for emu channel:
    ...
    JOB='DYJetsToTauTau-L%s_2016' % (sp)
    ...
    file_persamp.write("%s %d\n" %(JOB, int(math.ceil(float(nfiles)/float(nperjob)))))
#
#    #JOB='DYJetsToTauTau10-50%s_2016' % (sp)
...
#    JOB='DYJetsToLL10-50-L%s_2016' % (sp)
...
#    JOB='DYJetsToLL10-50-J%s_2016' % (sp)
...
#    JOB='DYJetsToTauTau10-50-L%s_2016' % (sp)
...
#    file_persamp.write("%s %d\n" %(JOB, int(math.ceil(float(nfiles)/float(nperjob)))))
    ...
    JOB='DYJetsToTauTau-JJ%s_2016' % (sp)
...
#
#             
#    JOB='DYJetsToTauTau10-50-JJ%s_2016' % (sp)
