...
# Data
 echo "Data"
 ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/Data_electauSkim_IC_filelist.dat  --mode=0  --output=Data_ElecTau_2011.root  >> data_2011_ElecTau.log &
 ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/Data_mutauSkim_IC_filelist.dat    --mode=1  --output=Data_MuTau_2011.root >> data_2011_MuTau.log &
 wait
