...
PATHS=(
 ...
 do
     ...
     ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/"$i"_filelist.dat --channel=em --output_folder=./ --output_name=Dummy.root \
     --do_skim=true --skim_path=$SKIMPATH/$i/em_skim/ --svfit_mode=0 --special_mode=20 --input_prefix=$PREFIX
     ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/"$i"_filelist.dat --channel=em --output_folder=./ --output_name=Dummy.root \
     --do_skim=true --skim_path=$SKIMPATH/$i/em_skim/ --svfit_mode=0 --special_mode=21 --input_prefix=$PREFIX
     ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/"$i"_filelist.dat --channel=em --output_folder=./ --output_name=Dummy.root \
     --do_skim=true --skim_path=$SKIMPATH/$i/em_skim/ --svfit_mode=0 --special_mode=22 --input_prefix=$PREFIX
     ./bin/HiggsTauTau --cfg=$CONFIG --filelist=$FILELIST/"$i"_filelist.dat --channel=em --output_folder=./ --output_name=Dummy.root \
     --do_skim=true --skim_path=$SKIMPATH/$i/em_skim/ --svfit_mode=0 --special_mode=23 --input_prefix=$PREFIX
     wait
     ...
     cd -
     cd $SKIMPATH/Special_20_$i/em_skim/
     hadd -O TempTree.root EventTree*
     rm EventTree*.root
     mv TempTree.root EventTree_All.root
     cd -
     cd $SKIMPATH/Special_21_$i/em_skim/
     hadd -O TempTree.root EventTree*
     rm EventTree*.root
     mv TempTree.root EventTree_All.root
     cd -
     cd $SKIMPATH/Special_22_$i/em_skim/
     hadd -O TempTree.root EventTree*
     rm EventTree*.root
     mv TempTree.root EventTree_All.root
     cd -
     cd $SKIMPATH/Special_23_$i/em_skim/
     hadd -O TempTree.root EventTree*
     rm EventTree*.root
     mv TempTree.root EventTree_All.root
     cd -
