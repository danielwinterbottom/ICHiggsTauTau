...
infileDY = "/afs/cern.ch/work/a/adewit/private/CMSSW_8_2_0/src/UserCode/ICHiggsTauTau/Analysis/HiggsTauTau/output/DYJetsToLL-200PU_mt_0.root"
...
legend.AddEntry(htt_msv,'VBF H#rightarrow#tau#tau','L')
legend.Draw()
...
plot.DrawTitle(pads[0], "14 TeV, 200PU", 3)

canv.SaveAs('msv_comparison_200PU.pdf')
canv.Print('msv_comparison_200PU.png')
...
plot.DrawCMSLogo(pads_mvis[0], 'CMS Phase-2', 'Simulation', 11, 0.045, 0.035, 1.2, '', 0.8)
#plot.DrawCMSLogo(pads[0], 'CMS Phase-2', 'Simulation Preliminary', 11, 0.045, 0.035, 1.2, '', 0.8)
plot.DrawTitle(pads_mvis[0], "#mu#tau_{h} channel", 1)
plot.DrawTitle(pads_mvis[0], "14 TeV, 200PU", 3)

canv_mvis.SaveAs('mvis_comparison_200PU.pdf')
canv_mvis.Print('mvis_comparison_200PU.png')
