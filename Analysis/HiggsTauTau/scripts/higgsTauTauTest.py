...
PREFIXDATA="--is_data=1 --input_prefix="+PREFIXOVERRIDE+"/Feb15/Data_53X/"
PREFIXMC="--is_data=0 --input_prefix="+PREFIXOVERRIDE+"/Feb15/MC_53X/"
YR='2012'
if options.do_2011:
...
FILELIST='filelists/Feb15_Data_53X'
...
FILELIST='filelists/Feb15_MC_53X'
