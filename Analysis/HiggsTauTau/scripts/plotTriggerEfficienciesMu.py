...
treemuD.Draw("pt_2>>mu2Deta0p9Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<0.9&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>mu1Deta0p9Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<0.9&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>mu2Deta0p9Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<0.9&&tag_trigger_match_1>0.5&&probe_trigger_match_2")
treemuD.Draw("pt_1>>mu1Deta0p9Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<0.9&&tag_trigger_match_2>0.5&&probe_trigger_match_1")
...
treemuD.Draw("pt_2>>mu2Deta0p9to1p2Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)>0.9&&abs(eta_2)<1.2&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>mu1Deta0p9to1p2Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<1.2&&abs(eta_1)>0.9&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>mu2Deta0p9to1p2Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)>0.9&&abs(eta_2)<1.2&&tag_trigger_match_1>0.5&&probe_trigger_match_2")
treemuD.Draw("pt_1>>mu1Deta0p9to1p2Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<1.2&&abs(eta_1)>0.9&&tag_trigger_match_2>0.5&&probe_trigger_match_1")
...
treemuD.Draw("pt_2>>mu2Deta1p2Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>mu1Deta1p2Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<2.1&&abs(eta_1)>1.2&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>mu2Deta1p2Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_1>0.5&&probe_trigger_match_2")
treemuD.Draw("pt_1>>mu1Deta1p2Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_2>0.5&&probe_trigger_match_1")
...
treemuD.Draw("pt_2>>singlemu2Deta0p9Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<0.9&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>singlemu1Deta0p9Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<0.9&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>singlemu2Deta0p9Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<0.9&&tag_trigger_match_1>0.5&&tag_trigger_match_2")
treemuD.Draw("pt_1>>singlemu1Deta0p9Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<0.9&&tag_trigger_match_2>0.5&&tag_trigger_match_1")
...
treemuD.Draw("pt_2>>singlemu2Deta0p9to1p2Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)>0.9&&abs(eta_2)<1.2&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>singlemu1Deta0p9to1p2Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<1.2&&abs(eta_1)>0.9&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>singlemu2Deta0p9to1p2Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)>0.9&&abs(eta_2)<1.2&&tag_trigger_match_1>0.5&&tag_trigger_match_2")
treemuD.Draw("pt_1>>singlemu1Deta0p9to1p2Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<1.2&&abs(eta_1)>0.9&&tag_trigger_match_2>0.5&&tag_trigger_match_1")
...
treemuD.Draw("pt_2>>singlemu2Deta1p2Denom","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_1>0.5")
treemuD.Draw("pt_1>>singlemu1Deta1p2Denom","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<2.1&&abs(eta_1)>1.2&&tag_trigger_match_2>0.5")
treemuD.Draw("pt_2>>singlemu2Deta1p2Num","pt_1>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_1)<2.1&&abs(eta_2)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_1>0.5&&tag_trigger_match_2")
treemuD.Draw("pt_1>>singlemu1Deta1p2Num","pt_2>23&&m_vis>75&&m_vis<105&&id_1>0.5&&id_2>0.5&&iso_1<0.15&&iso_2<0.15&&abs(eta_2)<2.1&&abs(eta_1)<2.1&&abs(eta_2)>1.2&&tag_trigger_match_2>0.5&&tag_trigger_match_1")
