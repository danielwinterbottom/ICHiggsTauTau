...
PATHS=(
 ...
 do
     ...
     --do_skim=true --skim_path=$SKIMPATH/$i/et_skim/ --svfit_mode=0 --input_prefix=$PREFIX &> jobs/$JOB.log" jobs/$JOB.sh
     ...
     --do_skim=true --skim_path=$SKIMPATH/$i/mt_skim/ --svfit_mode=0 --input_prefix=$PREFIX &> jobs/$JOB.log" jobs/$JOB.sh
     $JOBSUBMIT jobs/$JOB.sh
