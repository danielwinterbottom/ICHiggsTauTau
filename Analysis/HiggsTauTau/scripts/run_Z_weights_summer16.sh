...
for cat in "${cats[@]}"; do
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>50 && m_vis<80)"  --method=8 --cat="$cat" --var="pt_tt[$bins1]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129  #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>80 && m_vis<90)"  --method=8 --cat="$cat" --var="pt_tt[$bins2]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129 #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>90 && m_vis<100)"  --method=8 --cat="$cat" --var="pt_tt[$bins3]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129  #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>100 && m_vis<120)"  --method=8 --cat="$cat" --var="pt_tt[$bins4]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129  #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>120 && m_vis<160)"  --method=8 --cat="$cat" --var="pt_tt[$bins5]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129 #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>160 && m_vis<200)"  --method=8 --cat="$cat" --var="pt_tt[$bins6]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129 #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>200 && m_vis<400)"  --method=8 --cat="$cat" --var="pt_tt[$bins7]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129 #--syst_tau_scale=ES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(m_vis>400)"  --method=8 --cat="$cat" --var="pt_tt[$bins8]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down*wt_mur0p5_muf0p5*1.11129 #--syst_tau_scale=ES
