...
for cat in "${cats[@]}"; do
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(pt_1>40&&pt_2>40&&m_vis>50 && m_vis<80)"  --method=8 --cat="$cat" --var="pt_tt[$bins1]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down #--syst_scale_j=JES --syst_tau_scale=TES
  ...
  python scripts/HiggsTauTauPlot.py --cfg=scripts/new_plot_mssm_2016_NewPlotting.cfg --channel=zmm --set_alias="sel:(pt_1>40&&pt_2>40&&m_vis>400 && m_vis<800)"  --method=8 --cat="$cat" --var="pt_tt[$bins8]"  --x_title="Z pt [GeV]" --y_title="Entries" --datacard="$cat" --extra_pad=0.5 --log_y --outputfolder="./" --ratio --add_wt=wt_zpt_down #--syst_scale_j=JES --syst_tau_scale=TES
