...
#         'Special_2_TauPlusX-2011A-May10ReReco-v1'
#         'Special_2_TauPlusX-2011A-PromptReco-v4'
#         'Special_2_TauPlusX-2011A-05Aug2011-v1'
#         'Special_2_TauPlusX-2011A-03Oct2011-v1'
#         'Special_2_TauPlusX-2011B-PromptReco-v1'
#      )

# SOURCE_PATH=/Volumes/Storage/Oct2/Data_53X
# PATHS=( 
...
# SOURCE_PATH=/Volumes/Storage/Oct2/MC_53X
# PATHS=( 
#         'DYJetsToTauTau'
#         'DYJetsToLL'
#         'WJetsToLNu-v1'
...
# # # Then copy these filelists into the new central location (Data)
...
#  # Then copy these filelists into the new central location (MC)
#  # cp $SOURCE_PATH/"$i"/electauSkim/IC_filelist.dat filelists/Sept11/MC_42X/"$i"_electauSkim_IC_filelist.dat
#  # cp $SOURCE_PATH/"$i"/mutauSkim/IC_filelist.dat filelists/Sept11/MC_42X/"$i"_mutauSkim_IC_filelist.dat
#  # cp $SOURCE_PATH/"$i"/elecmuSkim/IC_filelist.dat filelists/Sept11/MC_42X/"$i"_elecmuSkim_IC_filelist.dat


#  # Then copy these filelists into the new central location (Data)
#  # cp $SOURCE_PATH/"$i"/electauSkim/IC_filelist.dat filelists/Oct2/Data_53X/"$i"_electauSkim_IC_filelist.dat
#  # cp $SOURCE_PATH/"$i"/mutauSkim/IC_filelist.dat filelists/Oct2/Data_53X/"$i"_mutauSkim_IC_filelist.dat

#  # Then copy these filelists into the new central location (Data)
#  cp $SOURCE_PATH/"$i"/electauSkim/IC_filelist.dat filelists/Oct2/MC_53X/"$i"_electauSkim_IC_filelist.dat
#  cp $SOURCE_PATH/"$i"/mutauSkim/IC_filelist.dat filelists/Oct2/MC_53X/"$i"_mutauSkim_IC_filelist.dat
# done
