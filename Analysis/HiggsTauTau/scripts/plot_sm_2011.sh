...
# ## Just for the MSSM plots, no datacards
#  TSCALE=(
#  '0'
#  )
...
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --mode=0 --rebin=1  \
#         --category="$i" --plot_name="svfit_mssm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false --norm_bins=true
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --mode=1 --rebin=1  \
#         --category="$i" --plot_name="svfit_mssm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false --norm_bins=true   
...
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=0 --mode=0 --rebin=1  \
#         --category="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false --norm_bins=true
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=0 --mode=1 --rebin=1 \
#         --category="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false  --norm_bins=true
...
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --mode=0 --rebin=1  \
#         --category="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false --norm_bins=true --log_y=false --signal_no_stack=false
#       ./bin/HiggsTauTauPlot2 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --mode=1 --rebin=1 \
#         --category="$i" --plot_name="svfit_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#         --make_datacard=false  --norm_bins=true --log_y=false --signal_no_stack=false
