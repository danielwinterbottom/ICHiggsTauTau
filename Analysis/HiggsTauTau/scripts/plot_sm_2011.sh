PARAMS=./scripts/default_params_2011.dat
TSCALE=(
  '1' 
  '2' 
  '0'
...
do
  ...
  for i in "${CATS[@]}"
  do
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=$j --channel=et --rebin=1  \
    ...
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=$j --channel=mt --rebin=1 \
      --method="$i" --plot_name="m_sv_sm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
      --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true  --norm_bins=true --verbose=false \
      --paramfile=$PARAMS
  done
...
do
  ...
  do
    ...
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=$j --channel=mt --rebin=1 \
      ...
      --blind=false --x_blind_min=60 --x_blind_max=120 --make_datacard=true  --norm_bins=true \
      --paramfile=$PARAMS
    # ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2011.cfg  --tau_scale_mode=$j --channel=em --rebin=1 \
    #   --method="$i" --plot_name="m_vis_sm_fine"  --x_axis_label="Visible Mass [GeV]" \
    #   --blind=false --x_blind_min=60 --x_blind_max=120 --make_datacard=true  --norm_bins=true \
    #   --paramfile=$PARAMS
  done
...
rm datacard_muTau_*.root
# hadd -f htt_em.inputs-sm-7TeV-mvis.root datacard_emu_*.root
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=$j --channel=et --rebin=1  \
...
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=$j --channel=mt --rebin=1 \
#       --method="$i" --plot_name="svfit_mssm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=1500 --make_datacard=true  --norm_bins=true
#   done
#   CATS=(
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --channel=et --rebin=1  \
...
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2011.cfg  --tau_scale_mode=0 --channel=mt --rebin=1 \
#       --method="$i" --plot_name="vis_sm_fine"  --x_axis_label="Visible Mass [GeV]"  --log_y=false --signal_no_stack=false \
#       --blind=false --x_blind_min=60 --x_blind_max=1500 --make_datacard=false  --norm_bins=true
#   done
#   CATS=(
