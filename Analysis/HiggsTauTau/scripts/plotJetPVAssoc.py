...
jetpvtree.Draw("abs(jet_eta)>>vbf_all_jets","jet_flav!=0&&jet_flav!=21")
jetpvtree.Draw("abs(jet_eta)>>vbf_pvassoc_jets","jet_flav!=0&&jet_flav!=21&&jet_beta>0.1")
...
canv.SaveAs('jetpvassoc.pdf')
canv.Print('jetpvassoc.png')
