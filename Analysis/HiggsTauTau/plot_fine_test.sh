...
do
  ...
  do
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=5  \
      ...
      --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true --norm_bins=true --draw_ratio=true \
      --custom_x_axis_range=true --x_axis_min=30 --x_axis_max=200 \
      --paramfile=$PARAMS
  ...
  for i in "${CATS[@]}"
  do
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=10  \
      --method="$i" --plot_name="m_sv"  --x_axis_label="m_{#tau#tau} [GeV]" \
      --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true --norm_bins=true --draw_ratio=true \
      --custom_x_axis_range=true --x_axis_min=30 --x_axis_max=200 \
      --paramfile=$PARAMS

    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=10 \
      --method="$i" --plot_name="m_sv"  --x_axis_label="m_{#tau#tau} [GeV]" \
      --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true  --norm_bins=true --draw_ratio=true \
      --custom_x_axis_range=true --x_axis_min=30 --x_axis_max=200 \
      --paramfile=$PARAMS

    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=em --rebin=10 \
      --method="$i" --plot_name="m_sv"  --x_axis_label="m_{#tau#tau} [GeV]" \
      --blind=false --x_blind_min=100 --x_blind_max=160 --make_datacard=true  --norm_bins=true --draw_ratio=true \
      --custom_x_axis_range=true --x_axis_min=30 --x_axis_max=200 \
...
hadd -f htt_et.inputs-sm-8TeV-binning-5-10.root datacard_eleTau_*.root
rm datacard_eleTau_*.root
hadd -f htt_mt.inputs-sm-8TeV-binning-5-10.root datacard_muTau_*.root
rm datacard_muTau_*.root
hadd -f htt_em.inputs-sm-8TeV-binning-5-10.root datacard_emu_*.root
...
do
  ...
  do
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=5  \
      ...
      --blind=false --x_blind_min=60 --x_blind_max=120 --make_datacard=true --norm_bins=true --draw_ratio=true \
      --custom_x_axis_range=true --x_axis_min=0 --x_axis_max=170 \
      --paramfile=$PARAMS
    ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_sm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=5 \
      --method="$i" --plot_name="m_vis"  --x_axis_label="Visible Mass [GeV]" \
      --blind=false --x_blind_min=60 --x_blind_max=120 --make_datacard=true  --norm_bins=true --draw_ratio=true \
...
hadd -f htt_et.inputs-sm-8TeV-mvis-binning-5-10.root datacard_eleTau_*.root
rm datacard_eleTau_*.root
hadd -f htt_mt.inputs-sm-8TeV-mvis-binning-5-10.root datacard_muTau_*.root
rm datacard_muTau_*.root
hadd -f htt_em.inputs-sm-8TeV-mvis-binning-5-10.root datacard_emu_*.root
rm datacard_emu_*.root
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=$j --channel=et --rebin=10  \
...
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=10 \
#       --method="$i" --plot_name="svfit_mssm_fine"  --x_axis_label="m_{#tau#tau} [GeV]" \
#       --blind=false --x_blind_min=100 --x_blind_max=1500 --make_datacard=true  --norm_bins=true
#   done
#   CATS=(
...
#       --blind=false --x_blind_min=100 --x_blind_max=1500 --make_datacard=true --norm_bins=true --extra_pad=1.4
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=$j --channel=mt --rebin=10 \
#       --method="$i" --plot_name="svfit_sm"  --x_axis_label="m_{#tau#tau} [GeV]"  --log_y=false --signal_no_stack=false \
#       --blind=false --x_blind_min=100 --x_blind_max=1500 --make_datacard=true  --norm_bins=true --extra_pad=1.2
#   done
# done
...
#   for i in "${CATS[@]}"
#   do
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=0 --channel=et --rebin=10  \
#       --method="$i" --plot_name="vis_sm_fine"  --x_axis_label="Visible Mass [GeV]"  --log_y=false --signal_no_stack=false \
#       --blind=false --x_blind_min=60 --x_blind_max=1500 --make_datacard=true --norm_bins=true
#     ./bin/HiggsTauTauPlot3 --cfg=scripts/plot_mssm_2012.cfg  --tau_scale_mode=0 --channel=mt --rebin=10 \
#       --method="$i" --plot_name="vis_sm_fine"  --x_axis_label="Visible Mass [GeV]"  --log_y=false --signal_no_stack=false \
#       --blind=false --x_blind_min=60 --x_blind_max=1500 --make_datacard=true  --norm_bins=true
#   done
#   CATS=(
