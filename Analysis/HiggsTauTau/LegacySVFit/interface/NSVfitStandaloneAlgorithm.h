...
#include "HiggsTauTau/LegacySVFit/interface/NSVfitStandaloneLikelihood.h"
#include "HiggsTauTau/LegacySVFit/interface/MarkovChainIntegrator.h"
#include "HiggsTauTau/LegacySVFit/interface/svFitAuxFunctions.h"
