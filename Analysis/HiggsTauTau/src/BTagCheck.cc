  ...
  int BTagCheck::Execute(TreeEvent *event) {
    ...
    if(channel_ == channel::et) { 
        ...
        if(era_ != era::data_2016 && era_ != era::data_2017 && era_ != era::data_2018){
          ...
          if(strategy_ == strategy::mssmsummer16 || strategy_ == strategy::smsummer16 || strategy_ == strategy::cpsummer16 ||  strategy_type == strategy::legacy16 ||  strategy_type == strategy::legacy16 ||  strategy_ == strategy::cpdecays16) iso_2 = tau->GetTauID("byLooseIsolationMVArun2v1DBoldDMwLT");
    ...
    if(channel_ == channel::mt) { 
        ...
        if(era_ != era::data_2016 && era_ != era::data_2017 && era_ != era::data_2018){
          ...
          iso_1 = PF04IsolationVal(muon, 0.5, 0);
          if(strategy_ == strategy::mssmsummer16 || strategy_ == strategy::smsummer16 || strategy_ == strategy::cpsummer16 ||  strategy_type == strategy::legacy16 || strategy_ == strategy::cpdecays16) iso_2 = tau->GetTauID("byLooseIsolationMVArun2v1DBoldDMwLT");
          else iso_2 = tau->GetTauID("byMediumIsolationMVArun2v1DBoldDMwLT");
        }
   ...
   if(pass_presel&&!leptonveto){
      for (unsigned i = 0; i<embed_jets.size(); ++i){
        ...
        double tight_wp = 0.8;
        if(strategy_ == strategy::mssmsummer16 || strategy_ == strategy::smsummer16 || strategy_ == strategy::cpsummer16 ||  strategy_type == strategy::legacy16 ||  strategy_ == strategy::cpdecays16) tight_wp = 0.8484;
