...
//	output_folder="HTTSequenceSyncfilesNEW/";
 ...
 if (channel_str == "mt"){
  ...
  if (era_type == era::data_2015 || era_type == era::data_2016){
    if(js["store_hltpaths"].asBool()){
      muon_pt = 18.0;//Up from 18 to avoid trigger turn on in new data trigger
      muon_eta = 2.4;
      tau_pt = 20;
      tau_eta = 2.3;
      min_taus = 1;
...
// Defining good-lumi jsons
  ...
  if (era_type == era::data_2016)  data_json= "input/json/Cert_271036-275125_13TeV_PromptReco_Collisions16_JSON.txt";
