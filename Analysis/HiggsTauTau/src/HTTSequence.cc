...
if(strategy_type == strategy::mssmsummer16&&channel!=channel::wmnu){
   ...
   TH2D z_pt_weights = GetFromTFile<TH2D>("input/zpt_weights/z_weights_scale_nom2.root","/","zptmass_histo");
   TH2D z_pt_weights_esup = GetFromTFile<TH2D>("input/zpt_weights/z_weights_scale_nom2.root","/","zptmass_histo_ESUp");
   TH2D z_pt_weights_esdown = GetFromTFile<TH2D>("input/zpt_weights/z_weights_scale_nom2.root","/","zptmass_histo_ESDown");
   ...
   HTTWeights httWeights = HTTWeights("HTTWeights")   
    ...
    .set_z_pt_mass_hist(new TH2D(z_pt_weights))
    .set_z_pt_mass_hist_esdown(new TH2D(z_pt_weights_esdown))
    .set_z_pt_mass_hist_esup(new TH2D(z_pt_weights_esup))
