...
void HTTSequence::BuildSequence(){
  ...
  if (channel == channel::em && (strategy_type == strategy::smsummer16 || strategy_type == strategy::cpsummer16 || strategy_type == strategy::cpsummer17)) jlepton_fake = true;
   ...
   if(output_name.find("SUSYGluGluToHToTauTau_M") != output_name.npos){
     ...
     if(channel!=channel::tpzee&&channel!=channel::tpzmm&&channel!=channel::tpmt&&channel != channel::tpem){
       HTTStitching httStitching = HTTStitching("HTTStitching")  
          ...
          if ((output_name.find("DY") != output_name.npos && output_name.find("JetsToLL-LO") != output_name.npos && !(output_name.find("JetsToLL-LO-5-50") != output_name.npos && !(output_name.find("JetsToLL-LO-10-50") != output_name.npos))){
            httStitching.set_do_dy_soup(true);
            ...
            httStitching.SetDYInputYields(48574276.0+49082157.0,34833034.0, 88795.0+9691457.0, 5740168.0 + 1147725.0, 4336026.0);
          }
