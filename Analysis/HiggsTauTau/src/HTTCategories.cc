      ...
      if (do_ff_weights_ && (channel_ == channel::et || channel_ == channel::mt || channel_ == channel::tt)){
        ...
        if (strategy_ == strategy::smsummer16 || strategy_ == strategy::cpsummer16 || strategy_ == strategy::legacy16  || strategy_ == strategy::cpdecays16 || strategy_ == strategy::cpsummer17 || strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays18) {
          ...
          if(channel_ == channel::tt) {
            outtree_->Branch("wt_ff_2"  , &wt_ff_2_);  
            outtree_->Branch("wt_ff_us_2", &wt_ff_us_2_);
            outtree_->Branch("wt_ff_dmbins_2"  , &wt_ff_dmbins_2_);
          }
          ...
          if(do_ff_systematics_){
            ...
            outtree_->Branch("wt_ff_qcd_stat_met_down_1"  , &wt_ff_qcd_stat_met_down_1_);
            ...
            outtree_->Branch("wt_ff_dmbins_qcd_stat_met_up_1"  , &wt_ff_dmbins_qcd_stat_met_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_met_down_1"  , &wt_ff_dmbins_qcd_stat_met_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_l_pt_up_1"  , &wt_ff_dmbins_qcd_stat_l_pt_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_l_pt_down_1"  , &wt_ff_dmbins_qcd_stat_l_pt_down_1_);
            ...
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm0_up_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm0_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm0_down_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm0_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm0_up_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm0_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm0_down_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm0_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm0_up_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm0_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm0_down_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm0_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm1_up_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm1_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm1_down_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm1_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm1_up_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm1_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm1_down_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm1_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm1_up_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm1_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm1_down_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm1_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm10_up_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm10_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm10_down_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm10_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm10_up_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm10_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm10_down_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm10_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm10_up_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm10_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm10_down_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm10_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm11_up_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm11_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm11_down_1"  , &wt_ff_dmbins_qcd_stat_njet0_dm11_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm11_up_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm11_up_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm11_down_1"  , &wt_ff_dmbins_qcd_stat_njet1_dm11_down_1_);
            outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm11_up_1"  , &wt_ff_dmbins_qcd_stat_njet2_dm11_up_1_);
            ...
            if(channel_ == channel::mt || channel_ == channel::et) {
              ...
              outtree_->Branch("wt_ff_wjets_stat_met_down_1"  , &wt_ff_wjets_stat_met_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_l_pt_up_1"  , &wt_ff_wjets_stat_l_pt_up_1_);
              ...
              outtree_->Branch("wt_ff_dmbins_wjets_stat_l_pt_down_1"  , &wt_ff_dmbins_wjets_stat_l_pt_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_up_1"  , &wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_down_1"  , &wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_up_1"  , &wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_down_1"  , &wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_up_1"  , &wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_down_1"  , &wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_up_1"  , &wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_down_1"  , &wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_up_1"  , &wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_down_1"  , &wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_up_1"  , &wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_down_1"  , &wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm1_up_1"  , &wt_ff_wjets_stat_njet0_mvadm1_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm1_down_1"  , &wt_ff_wjets_stat_njet0_mvadm1_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm1_up_1"  , &wt_ff_wjets_stat_njet1_mvadm1_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm1_down_1"  , &wt_ff_wjets_stat_njet1_mvadm1_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm1_up_1"  , &wt_ff_wjets_stat_njet2_mvadm1_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm1_down_1"  , &wt_ff_wjets_stat_njet2_mvadm1_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm2_up_1"  , &wt_ff_wjets_stat_njet0_mvadm2_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm2_down_1"  , &wt_ff_wjets_stat_njet0_mvadm2_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm2_up_1"  , &wt_ff_wjets_stat_njet1_mvadm2_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm2_down_1"  , &wt_ff_wjets_stat_njet1_mvadm2_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm2_up_1"  , &wt_ff_wjets_stat_njet2_mvadm2_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm2_down_1"  , &wt_ff_wjets_stat_njet2_mvadm2_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm10_up_1"  , &wt_ff_wjets_stat_njet0_mvadm10_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm10_down_1"  , &wt_ff_wjets_stat_njet0_mvadm10_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm10_up_1"  , &wt_ff_wjets_stat_njet1_mvadm10_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm10_down_1"  , &wt_ff_wjets_stat_njet1_mvadm10_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm10_up_1"  , &wt_ff_wjets_stat_njet2_mvadm10_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm10_down_1"  , &wt_ff_wjets_stat_njet2_mvadm10_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm11_up_1"  , &wt_ff_wjets_stat_njet0_mvadm11_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet0_mvadm11_down_1"  , &wt_ff_wjets_stat_njet0_mvadm11_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm11_up_1"  , &wt_ff_wjets_stat_njet1_mvadm11_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet1_mvadm11_down_1"  , &wt_ff_wjets_stat_njet1_mvadm11_down_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm11_up_1"  , &wt_ff_wjets_stat_njet2_mvadm11_up_1_);
              outtree_->Branch("wt_ff_wjets_stat_njet2_mvadm11_down_1"  , &wt_ff_wjets_stat_njet2_mvadm11_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm0_up_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm0_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm0_down_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm0_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm0_up_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm0_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm0_down_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm0_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm0_up_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm0_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm0_down_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm0_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm1_up_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm1_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm1_down_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm1_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm1_up_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm1_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm1_down_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm1_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm1_up_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm1_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm1_down_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm1_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm10_up_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm10_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm10_down_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm10_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm10_up_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm10_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm10_down_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm10_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm10_up_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm10_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm10_down_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm10_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm11_up_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm11_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet0_dm11_down_1"  , &wt_ff_dmbins_wjets_stat_njet0_dm11_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm11_up_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm11_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet1_dm11_down_1"  , &wt_ff_dmbins_wjets_stat_njet1_dm11_down_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm11_up_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm11_up_1_);
              outtree_->Branch("wt_ff_dmbins_wjets_stat_njet2_dm11_down_1"  , &wt_ff_dmbins_wjets_stat_njet2_dm11_down_1_);
            }
            if(channel_ == channel::tt) {
              outtree_->Branch("wt_ff_qcd_syst_up_2"  , &wt_ff_qcd_syst_up_2_);
              outtree_->Branch("wt_ff_qcd_syst_down_2"  , &wt_ff_qcd_syst_down_2_);
              outtree_->Branch("wt_ff_wjets_syst_up_2"  , &wt_ff_wjets_syst_up_2_);
              outtree_->Branch("wt_ff_wjets_syst_down_2"  , &wt_ff_wjets_syst_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_met_up_2"  , &wt_ff_qcd_stat_met_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_met_down_2"  , &wt_ff_qcd_stat_met_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_2"  , &wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_2"  , &wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_2"  , &wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_2"  , &wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_2"  , &wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_2"  , &wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_2"  , &wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_2"  , &wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_2"  , &wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_2"  , &wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_2"  , &wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_2"  , &wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm1_up_2"  , &wt_ff_qcd_stat_njet0_mvadm1_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm1_down_2"  , &wt_ff_qcd_stat_njet0_mvadm1_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm1_up_2"  , &wt_ff_qcd_stat_njet1_mvadm1_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm1_down_2"  , &wt_ff_qcd_stat_njet1_mvadm1_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm1_up_2"  , &wt_ff_qcd_stat_njet2_mvadm1_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm1_down_2"  , &wt_ff_qcd_stat_njet2_mvadm1_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm2_up_2"  , &wt_ff_qcd_stat_njet0_mvadm2_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm2_down_2"  , &wt_ff_qcd_stat_njet0_mvadm2_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm2_up_2"  , &wt_ff_qcd_stat_njet1_mvadm2_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm2_down_2"  , &wt_ff_qcd_stat_njet1_mvadm2_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm2_up_2"  , &wt_ff_qcd_stat_njet2_mvadm2_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm2_down_2"  , &wt_ff_qcd_stat_njet2_mvadm2_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm10_up_2"  , &wt_ff_qcd_stat_njet0_mvadm10_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm10_down_2"  , &wt_ff_qcd_stat_njet0_mvadm10_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm10_up_2"  , &wt_ff_qcd_stat_njet1_mvadm10_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm10_down_2"  , &wt_ff_qcd_stat_njet1_mvadm10_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm10_up_2"  , &wt_ff_qcd_stat_njet2_mvadm10_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm10_down_2"  , &wt_ff_qcd_stat_njet2_mvadm10_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm11_up_2"  , &wt_ff_qcd_stat_njet0_mvadm11_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet0_mvadm11_down_2"  , &wt_ff_qcd_stat_njet0_mvadm11_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm11_up_2"  , &wt_ff_qcd_stat_njet1_mvadm11_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet1_mvadm11_down_2"  , &wt_ff_qcd_stat_njet1_mvadm11_down_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm11_up_2"  , &wt_ff_qcd_stat_njet2_mvadm11_up_2_);
              outtree_->Branch("wt_ff_qcd_stat_njet2_mvadm11_down_2"  , &wt_ff_qcd_stat_njet2_mvadm11_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm0_up_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm0_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm0_down_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm0_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm0_up_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm0_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm0_down_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm0_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm0_up_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm0_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm0_down_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm0_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm1_up_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm1_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm1_down_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm1_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm1_up_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm1_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm1_down_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm1_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm1_up_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm1_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm1_down_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm1_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm10_up_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm10_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm10_down_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm10_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm10_up_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm10_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm10_down_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm10_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm10_up_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm10_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm10_down_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm10_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm11_up_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm11_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet0_dm11_down_2"  , &wt_ff_dmbins_qcd_stat_njet0_dm11_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm11_up_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm11_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet1_dm11_down_2"  , &wt_ff_dmbins_qcd_stat_njet1_dm11_down_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm11_up_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm11_up_2_);
              outtree_->Branch("wt_ff_dmbins_qcd_stat_njet2_dm11_down_2"  , &wt_ff_dmbins_qcd_stat_njet2_dm11_down_2_);

              outtree_->Branch("wt_ff_us_qcd_stat_njets0_up_1", &wt_ff_us_qcd_stat_njets0_up_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets0_up_2", &wt_ff_us_qcd_stat_njets0_up_2_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets0_down_1", &wt_ff_us_qcd_stat_njets0_down_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets0_down_2", &wt_ff_us_qcd_stat_njets0_down_2_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets1_up_1", &wt_ff_us_qcd_stat_njets1_up_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets1_up_2", &wt_ff_us_qcd_stat_njets1_up_2_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets1_down_1", &wt_ff_us_qcd_stat_njets1_down_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets1_down_2", &wt_ff_us_qcd_stat_njets1_down_2_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets2_up_1", &wt_ff_us_qcd_stat_njets2_up_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets2_up_2", &wt_ff_us_qcd_stat_njets2_up_2_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets2_down_1", &wt_ff_us_qcd_stat_njets2_down_1_);
              outtree_->Branch("wt_ff_us_qcd_stat_njets2_down_2", &wt_ff_us_qcd_stat_njets2_down_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets0_up_1", &wt_ff_us_qcd_syst_closure_njets0_up_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets0_up_2", &wt_ff_us_qcd_syst_closure_njets0_up_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets0_down_1", &wt_ff_us_qcd_syst_closure_njets0_down_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets0_down_2", &wt_ff_us_qcd_syst_closure_njets0_down_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets1_up_1", &wt_ff_us_qcd_syst_closure_njets1_up_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets1_up_2", &wt_ff_us_qcd_syst_closure_njets1_up_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets1_down_1", &wt_ff_us_qcd_syst_closure_njets1_down_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets1_down_2", &wt_ff_us_qcd_syst_closure_njets1_down_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets2_up_1", &wt_ff_us_qcd_syst_closure_njets2_up_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets2_up_2", &wt_ff_us_qcd_syst_closure_njets2_up_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets2_down_1", &wt_ff_us_qcd_syst_closure_njets2_down_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_closure_njets2_down_2", &wt_ff_us_qcd_syst_closure_njets2_down_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_osss_up_1", &wt_ff_us_qcd_syst_osss_up_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_osss_up_2", &wt_ff_us_qcd_syst_osss_up_2_);
              outtree_->Branch("wt_ff_us_qcd_syst_osss_down_1", &wt_ff_us_qcd_syst_osss_down_1_);
              outtree_->Branch("wt_ff_us_qcd_syst_osss_down_2", &wt_ff_us_qcd_syst_osss_down_2_);
            }
          }
         }
      }
...
//      synctree_->Branch("passiso_1", &lPassIso1, "lPassIso1/B");
      ...
      synctree_->Branch("tDeepTau2017v2p1VSjetraw_2",      &deepTauVsJets_iso_2_);
      ...
      // which is no longer used in the analysis, but retained for legacy
      // reasons
      synctree_->Branch("iso_2", &deepTauVsJets_iso_2_);
      // Transverse (x-y) impact parameter w.r.t to the primary vertex
  ...
  int HTTCategories::Execute(TreeEvent *event) {
    ...
    rand_ = rand->Uniform();
      ...
      if (do_ff_weights_ && (channel_ == channel::et || channel_ == channel::mt || channel_ == channel::tt)){
        ...
        if (strategy_ == strategy::cpdecays18 || strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays16 || strategy_ == strategy::legacy16) {
        ...
        wt_ff_us_2_ = event->Exists("wt_ff_us_2") ? event->Get<double>("wt_ff_us_2") : 0.0;
        ...
        if(do_ff_systematics_){
          ...
          wt_ff_us_qcd_stat_njets0_up_2_ = event->Exists("wt_ff_us_qcd_stat_njets0_up_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets0_up_2") : 0.0;
          ...
          wt_ff_us_qcd_stat_njets0_down_2_ = event->Exists("wt_ff_us_qcd_stat_njets0_down_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets0_down_2") : 0.0;
          ...
          wt_ff_us_qcd_stat_njets1_up_2_ = event->Exists("wt_ff_us_qcd_stat_njets1_up_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets1_up_2") : 0.0;
          ...
          wt_ff_us_qcd_stat_njets1_down_2_ = event->Exists("wt_ff_us_qcd_stat_njets1_down_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets1_down_2") : 0.0;
          ...
          wt_ff_us_qcd_stat_njets2_up_2_ = event->Exists("wt_ff_us_qcd_stat_njets2_up_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets2_up_2") : 0.0;
          ...
          wt_ff_us_qcd_stat_njets2_down_2_ = event->Exists("wt_ff_us_qcd_stat_njets2_down_2") ? event->Get<double>("wt_ff_us_qcd_stat_njets2_down_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets0_up_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets0_up_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets0_up_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets0_down_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets0_down_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets0_down_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets1_up_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets1_up_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets1_up_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets1_down_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets1_down_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets1_down_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets2_up_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets2_up_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets2_up_2") : 0.0;
          ...
          wt_ff_us_qcd_syst_closure_njets2_down_2_ = event->Exists("wt_ff_us_qcd_syst_closure_njets2_down_2") ? event->Get<double>("wt_ff_us_qcd_syst_closure_njets2_down_2") : 0.0;
          wt_ff_us_qcd_syst_osss_up_2_ = event->Exists("wt_ff_us_qcd_syst_osss_up_2") ? event->Get<double>("wt_ff_us_qcd_syst_osss_up_2") : 0.0;
          wt_ff_us_qcd_syst_osss_down_1_ = event->Exists("wt_ff_us_qcd_syst_osss_down_1") ? event->Get<double>("wt_ff_us_qcd_syst_osss_down_1") : 0.0;
          wt_ff_us_qcd_syst_osss_down_2_ = event->Exists("wt_ff_us_qcd_syst_osss_down_2") ? event->Get<double>("wt_ff_us_qcd_syst_osss_down_2") : 0.0;
          ...
          wt_ff_wjets_stat_met_down_1_ = event->Exists("wt_ff_wjets_stat_met_down_1") ? event->Get<double>("wt_ff_wjets_stat_met_down_1") : 0.0;
          wt_ff_wjets_stat_l_pt_up_1_ = event->Exists("wt_ff_wjets_stat_l_pt_up_1") ? event->Get<double>("wt_ff_wjets_stat_l_pt_up_1") : 0.0;
          wt_ff_wjets_stat_l_pt_down_1_ = event->Exists("wt_ff_wjets_stat_l_pt_down_1") ? event->Get<double>("wt_ff_wjets_stat_l_pt_down_1") : 0.0;
          ...
          wt_ff_dmbins_wjets_stat_met_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_met_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_met_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_met_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_met_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_met_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_l_pt_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_l_pt_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_l_pt_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_l_pt_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_l_pt_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_l_pt_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm1_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm1_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm1_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm1_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm1_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm1_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm1_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm1_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm1_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm1_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm1_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm1_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm1_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm1_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm1_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm1_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm1_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm1_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm2_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm2_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm2_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm2_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm2_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm2_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm2_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm2_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm2_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm2_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm2_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm2_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm2_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm2_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm2_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm2_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm2_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm2_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm10_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm10_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm10_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm10_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm10_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm10_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm10_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm10_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm10_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm10_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm10_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm10_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm10_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm10_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm10_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm10_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm10_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm10_down_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm11_up_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm11_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm11_up_1") : 0.0;
          wt_ff_wjets_stat_njet0_mvadm11_down_1_ = event->Exists("wt_ff_wjets_stat_njet0_mvadm11_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet0_mvadm11_down_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm11_up_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm11_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm11_up_1") : 0.0;
          wt_ff_wjets_stat_njet1_mvadm11_down_1_ = event->Exists("wt_ff_wjets_stat_njet1_mvadm11_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet1_mvadm11_down_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm11_up_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm11_up_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm11_up_1") : 0.0;
          wt_ff_wjets_stat_njet2_mvadm11_down_1_ = event->Exists("wt_ff_wjets_stat_njet2_mvadm11_down_1") ? event->Get<double>("wt_ff_wjets_stat_njet2_mvadm11_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm0_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm0_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm0_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm0_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm0_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm0_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm0_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm0_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm0_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm0_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm0_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm0_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm1_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm1_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm1_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm1_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm1_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm1_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm1_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm1_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm1_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm1_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm1_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm1_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm10_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm10_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm10_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm10_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm10_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm10_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm10_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm10_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm10_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm10_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm10_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm10_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm11_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm11_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet0_dm11_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet0_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet0_dm11_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm11_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm11_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet1_dm11_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet1_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet1_dm11_down_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm11_up_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm11_up_1") : 0.0;
          wt_ff_dmbins_wjets_stat_njet2_dm11_down_1_ = event->Exists("wt_ff_dmbins_wjets_stat_njet2_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_wjets_stat_njet2_dm11_down_1") : 0.0;
          ...
          wt_ff_qcd_stat_met_up_1_ = event->Exists("wt_ff_qcd_stat_met_up_1") ? event->Get<double>("wt_ff_qcd_stat_met_up_1") : 0.0;
          wt_ff_qcd_stat_met_down_1_ = event->Exists("wt_ff_qcd_stat_met_down_1") ? event->Get<double>("wt_ff_qcd_stat_met_down_1") : 0.0;
          wt_ff_qcd_stat_l_pt_up_1_ = event->Exists("wt_ff_qcd_stat_l_pt_up_1") ? event->Get<double>("wt_ff_qcd_stat_l_pt_up_1") : 0.0;
          wt_ff_qcd_stat_l_pt_down_1_ = event->Exists("wt_ff_qcd_stat_l_pt_down_1") ? event->Get<double>("wt_ff_qcd_stat_l_pt_down_1") : 0.0;
          ...
          wt_ff_dmbins_qcd_stat_met_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_met_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_met_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_met_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_met_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_met_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_l_pt_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_l_pt_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_l_pt_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_l_pt_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_l_pt_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_l_pt_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_down_1") : 0.0;
          wt_ff_qcd_syst_up_1_ = event->Exists("wt_ff_qcd_syst_up_1") ? event->Get<double>("wt_ff_qcd_syst_up_1") : 0.0;
          wt_ff_qcd_syst_down_1_ = event->Exists("wt_ff_qcd_syst_down_1") ? event->Get<double>("wt_ff_qcd_syst_down_1") : 0.0;
          wt_ff_wjets_syst_up_1_ = event->Exists("wt_ff_wjets_syst_up_1") ? event->Get<double>("wt_ff_wjets_syst_up_1") : 0.0;
          wt_ff_wjets_syst_down_1_ = event->Exists("wt_ff_wjets_syst_down_1") ? event->Get<double>("wt_ff_wjets_syst_down_1") : 0.0;
          wt_ff_qcd_stat_met_up_1_ = event->Exists("wt_ff_qcd_stat_met_up_1") ? event->Get<double>("wt_ff_qcd_stat_met_up_1") : 0.0;
          wt_ff_qcd_stat_met_down_1_ = event->Exists("wt_ff_qcd_stat_met_down_1") ? event->Get<double>("wt_ff_qcd_stat_met_down_1") : 0.0;
          wt_ff_qcd_syst_up_2_ = event->Exists("wt_ff_qcd_syst_up_2") ? event->Get<double>("wt_ff_qcd_syst_up_2") : 0.0;
          wt_ff_qcd_syst_down_2_ = event->Exists("wt_ff_qcd_syst_down_2") ? event->Get<double>("wt_ff_qcd_syst_down_2") : 0.0;
          wt_ff_wjets_syst_up_2_ = event->Exists("wt_ff_wjets_syst_up_2") ? event->Get<double>("wt_ff_wjets_syst_up_2") : 0.0;
          wt_ff_wjets_syst_down_2_ = event->Exists("wt_ff_wjets_syst_down_2") ? event->Get<double>("wt_ff_wjets_syst_down_2") : 0.0;
          wt_ff_qcd_stat_met_up_2_ = event->Exists("wt_ff_qcd_stat_met_up_2") ? event->Get<double>("wt_ff_qcd_stat_met_up_2") : 0.0;
          wt_ff_qcd_stat_met_down_2_ = event->Exists("wt_ff_qcd_stat_met_down_2") ? event->Get<double>("wt_ff_qcd_stat_met_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_lt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_lt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_lt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm0_sig_gt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm0_sig_gt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm0_sig_gt3_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm1_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm1_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm1_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm1_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm1_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm1_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm1_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm1_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm1_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm2_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm2_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm2_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm2_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm2_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm2_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm2_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm2_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm2_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm10_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm10_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm10_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm10_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm10_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm10_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm10_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm10_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm10_down_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_down_1") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_up_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_up_2") : 0.0;
          wt_ff_qcd_stat_njet0_mvadm11_down_2_ = event->Exists("wt_ff_qcd_stat_njet0_mvadm11_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet0_mvadm11_down_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_down_1") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_up_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_up_2") : 0.0;
          wt_ff_qcd_stat_njet1_mvadm11_down_2_ = event->Exists("wt_ff_qcd_stat_njet1_mvadm11_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet1_mvadm11_down_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_up_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_up_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_up_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_down_1_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_down_1") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_down_1") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_up_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_up_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_up_2") : 0.0;
          wt_ff_qcd_stat_njet2_mvadm11_down_2_ = event->Exists("wt_ff_qcd_stat_njet2_mvadm11_down_2") ? event->Get<double>("wt_ff_qcd_stat_njet2_mvadm11_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm0_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm0_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm0_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm0_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm0_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm0_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm0_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm0_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm0_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm1_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm1_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm1_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm1_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm1_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm1_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm1_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm1_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm1_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm10_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm10_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm10_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm10_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm10_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm10_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm10_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm10_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm10_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet0_dm11_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet0_dm11_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet0_dm11_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet1_dm11_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet1_dm11_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet1_dm11_down_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_up_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_up_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_up_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_down_1_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_down_1") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_down_1") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_up_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_up_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_up_2") : 0.0;
          wt_ff_dmbins_qcd_stat_njet2_dm11_down_2_ = event->Exists("wt_ff_dmbins_qcd_stat_njet2_dm11_down_2") ? event->Get<double>("wt_ff_dmbins_qcd_stat_njet2_dm11_down_2") : 0.0;
...
//  if (event->Exists("isoweight_2")) isoweight_2_ = event->Get<double>("isoweight_2"); else isoweight_2_ = 0.0;
  ...
  if (eventInfo->weight_defined("ggh")) {
    ...
    // NEW
    if (era_ == era::data_2017 || era_ == era::data_2018 || era_ == era::data_2016) {
...
*/
   ...
   if (event->Exists("svfitMT")){
    ...
    if (channel_ == channel::tt && strategy_ == strategy::fall15){
    ...
    } else if (era_ == era::data_2016 || era_ == era::data_2017 || era_ == era::data_2018) {
        // full Run2 legacy
        // add medium WP (called it tight) btags
      if (n_btag_ >= 1) {
        bpt_1_ = btag[0]->pt();
        brawf_1_ = btag[0]->uncorrected_energy()/btag[0]->energy();//* (jets[0]->pt() / jets[0]->energy());
        beta_1_ = btag[0]->eta();
        bphi_1_ = btag[0]->phi();
      ...
      if (n_btag_ >= 2) {
        bpt_2_ = btag[1]->pt();
        brawf_2_ = btag[1]->uncorrected_energy()/btag[1]->energy();//* (jets[0]->pt() / jets[0]->energy());
        beta_2_ = btag[1]->eta();
        bphi_2_ = btag[1]->phi();
      ...
      if (n_loose_btag_ >= 1) {
        ...
        brawf_1_ = loose_btag[0]->uncorrected_energy()/loose_btag[0]->energy();//* (jets[0]->pt() / jets[0]->energy());
      ...
      if (n_loose_btag_ >= 2) {
        ...
        brawf_2_ = loose_btag[1]->uncorrected_energy()/loose_btag[1]->energy();//* (jets[0]->pt() / jets[0]->energy());
