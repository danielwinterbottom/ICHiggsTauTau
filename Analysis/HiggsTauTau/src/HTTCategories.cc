...
/*      outtree_->Branch("leading_lepton_match_pt", &leading_lepton_match_pt_);
      ...
      if(do_jes_vars_){
        ...
        outtree_->Branch("jdphi_1",     &jdphi_1_    );
        outtree_->Branch("jdphi_2",     &jdphi_2_    );
        outtree_->Branch("jdphi_3",     &jdphi_3_    );
        outtree_->Branch("jdphi_4",     &jdphi_4_    );
        outtree_->Branch("jdphi_5",     &jdphi_5_    );
        outtree_->Branch("jdphi_6",     &jdphi_6_    );
        outtree_->Branch("jdphi_7",     &jdphi_7_    );
        outtree_->Branch("jdphi_8",     &jdphi_8_    );
        outtree_->Branch("jdphi_9",     &jdphi_9_    );
        outtree_->Branch("jdphi_10",    &jdphi_10_   );
        outtree_->Branch("jdphi_11",    &jdphi_11_   );
        outtree_->Branch("jdphi_12",    &jdphi_12_   );
        outtree_->Branch("jdphi_13",    &jdphi_13_   );
        outtree_->Branch("jdphi_14",    &jdphi_14_   );
        outtree_->Branch("jdphi_15",    &jdphi_15_   );
        outtree_->Branch("jdphi_16",    &jdphi_16_   );
        outtree_->Branch("jdphi_17",    &jdphi_17_   );
        outtree_->Branch("jdphi_18",    &jdphi_18_   );
        outtree_->Branch("jdphi_19",    &jdphi_19_   );
        outtree_->Branch("jdphi_20",    &jdphi_20_   );
        outtree_->Branch("jdphi_21",    &jdphi_21_   );
        outtree_->Branch("jdphi_22",    &jdphi_22_   );
        outtree_->Branch("jdphi_23",    &jdphi_23_   );
        outtree_->Branch("jdphi_24",    &jdphi_24_   );
        outtree_->Branch("jdphi_25",    &jdphi_25_   );
...
*/
   ...
   if (event->Exists("svfitMT")){
    ...
    if(do_jes_vars_){
      ...
      jdphi_1_     = event->Exists("jdphi_1")     ? event->Get<double>("jdphi_1")    : -9999;
      jdphi_2_     = event->Exists("jdphi_2")     ? event->Get<double>("jdphi_2")    : -9999;
      jdphi_3_     = event->Exists("jdphi_3")     ? event->Get<double>("jdphi_3")    : -9999;
      jdphi_4_     = event->Exists("jdphi_4")     ? event->Get<double>("jdphi_4")    : -9999;
      jdphi_5_     = event->Exists("jdphi_5")     ? event->Get<double>("jdphi_5")    : -9999;
      jdphi_6_     = event->Exists("jdphi_6")     ? event->Get<double>("jdphi_6")    : -9999;
      jdphi_7_     = event->Exists("jdphi_7")     ? event->Get<double>("jdphi_7")    : -9999;
      jdphi_8_     = event->Exists("jdphi_8")     ? event->Get<double>("jdphi_8")    : -9999;
      jdphi_9_     = event->Exists("jdphi_9")     ? event->Get<double>("jdphi_9")    : -9999;
      jdphi_10_    = event->Exists("jdphi_10")    ? event->Get<double>("jdphi_10")   : -9999;
      jdphi_11_    = event->Exists("jdphi_11")    ? event->Get<double>("jdphi_11")   : -9999;
      jdphi_12_    = event->Exists("jdphi_12")    ? event->Get<double>("jdphi_12")   : -9999;
      jdphi_13_    = event->Exists("jdphi_13")    ? event->Get<double>("jdphi_13")   : -9999;
      jdphi_14_    = event->Exists("jdphi_14")    ? event->Get<double>("jdphi_14")   : -9999;
      jdphi_15_    = event->Exists("jdphi_15")    ? event->Get<double>("jdphi_15")   : -9999;
      jdphi_16_    = event->Exists("jdphi_16")    ? event->Get<double>("jdphi_16")   : -9999;
      jdphi_17_    = event->Exists("jdphi_17")    ? event->Get<double>("jdphi_17")   : -9999;
      jdphi_18_    = event->Exists("jdphi_18")    ? event->Get<double>("jdphi_18")   : -9999;
      jdphi_19_    = event->Exists("jdphi_19")    ? event->Get<double>("jdphi_19")   : -9999;
      jdphi_20_    = event->Exists("jdphi_20")    ? event->Get<double>("jdphi_20")   : -9999;
      jdphi_21_    = event->Exists("jdphi_21")    ? event->Get<double>("jdphi_21")   : -9999;
      jdphi_22_    = event->Exists("jdphi_22")    ? event->Get<double>("jdphi_22")   : -9999;
      jdphi_23_    = event->Exists("jdphi_23")    ? event->Get<double>("jdphi_23")   : -9999;
      jdphi_24_    = event->Exists("jdphi_24")    ? event->Get<double>("jdphi_24")   : -9999;
      jdphi_25_    = event->Exists("jdphi_25")    ? event->Get<double>("jdphi_25")   : -9999;
      jdphi_26_    = event->Exists("jdphi_26")    ? event->Get<double>("jdphi_26")   : -9999;
      jdphi_27_    = event->Exists("jdphi_27")    ? event->Get<double>("jdphi_27")   : -9999;
      jdphi_28_    = event->Exists("jdphi_28")    ? event->Get<double>("jdphi_28")   : -9999;
    }
