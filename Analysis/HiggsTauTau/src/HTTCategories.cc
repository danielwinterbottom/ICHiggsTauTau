...
*/
    ...
    if (channel_ == channel::et) {
      ...
      if(strategy_ == strategy::spring15) {
        ...
        lbyLoosePileupWeightedIsolation_2 = tau->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_2 = tau->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_2 = tau->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyLoosePileupWeightedIsolation_2 = tau->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_2 = tau->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_2 = tau->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyVLooseIsolationMVA3newDMwLT_2 = tau->HasTauID("byVLooseIsolationMVA3newDMwLT") ? tau->GetTauID("byVLooseIsolationMVA3newDMwLT") : 0.;
        lbyLooseIsolationMVA3newDMwLT_2 = tau->HasTauID("byLooseIsolationMVA3newDMwLT") ? tau->GetTauID("byLooseIsolationMVA3newDMwLT") : 0.;
        lbyMediumIsolationMVA3newDMwLT_2 = tau->HasTauID("byMediumIsolationMVA3newDMwLT") ? tau->GetTauID("byMediumIsolationMVA3newDMwLT") : 0.;
        lbyVTightIsolationMVA3newDMwLT_2 = tau->HasTauID("byVTightIsolationMVA3newDMwLT") ? tau->GetTauID("byVTightIsolationMVA3newDMwLT") : 0.;
        lbyTightIsolationMVA3newDMwLT_2 = tau->HasTauID("byTightIsolationMVA3newDMwLT") ? tau->GetTauID("byTightIsolationMVA3newDMwLT") : 0.;
        antiele_2_ = lagainstElectronTightMVA5_2;
        antimu_2_ = lagainstMuonLoose3_2;
      }
    ...
    if (channel_ == channel::tt) {
      ...
      if(strategy_ == strategy::phys14 || strategy_ == strategy::spring15) {
        ...
        lbyLoosePileupWeightedIsolation_1 = tau1->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau1->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_1 = tau1->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau1->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_1 = tau1->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau1->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyLoosePileupWeightedIsolation_1 = tau1->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau1->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_1 = tau1->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau1->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_1 = tau1->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau1->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyVLooseIsolationMVA3newDMwLT_1 = tau1->HasTauID("byVLooseIsolationMVA3newDMwLT") ? tau1->GetTauID("byVLooseIsolationMVA3newDMwLT") : 0.;
        lbyLooseIsolationMVA3newDMwLT_1 = tau1->HasTauID("byLooseIsolationMVA3newDMwLT") ? tau1->GetTauID("byLooseIsolationMVA3newDMwLT") : 0.;
        lbyMediumIsolationMVA3newDMwLT_1 = tau1->HasTauID("byMediumIsolationMVA3newDMwLT") ? tau1->GetTauID("byMediumIsolationMVA3newDMwLT") : 0.;
        lbyVTightIsolationMVA3newDMwLT_1 = tau1->HasTauID("byVTightIsolationMVA3newDMwLT") ? tau1->GetTauID("byVTightIsolationMVA3newDMwLT") : 0.;
        lbyTightIsolationMVA3newDMwLT_1 = tau1->HasTauID("byTightIsolationMVA3newDMwLT") ? tau1->GetTauID("byTightIsolationMVA3newDMwLT") : 0.;
        ...
        lbyLoosePileupWeightedIsolation_2 = tau2->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau2->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_2 = tau2->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau2->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_2 = tau2->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau2->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyLoosePileupWeightedIsolation_2 = tau2->HasTauID("byLoosePileupWeightedIsolation3Hits") ? tau2->GetTauID("byLoosePileupWeightedIsolation3Hits") : 0.; 
        lbyMediumPileupWeightedIsolation_2 = tau2->HasTauID("byMediumPileupWeightedIsolation3Hits") ? tau2->GetTauID("byMediumPileupWeightedIsolation3Hits") : 0.; 
        lbyTightPileupWeightedIsolation_2 = tau2->HasTauID("byTightPileupWeightedIsolation3Hits") ? tau2->GetTauID("byTightPileupWeightedIsolation3Hits") : 0.;
        lbyVLooseIsolationMVA3newDMwLT_2 = tau2->HasTauID("byVLooseIsolationMVA3newDMwLT") ? tau2->GetTauID("byVLooseIsolationMVA3newDMwLT") : 0.;
        lbyLooseIsolationMVA3newDMwLT_2 = tau2->HasTauID("byLooseIsolationMVA3newDMwLT") ? tau2->GetTauID("byLooseIsolationMVA3newDMwLT") : 0.;
        lbyMediumIsolationMVA3newDMwLT_2 = tau2->HasTauID("byMediumIsolationMVA3newDMwLT") ? tau2->GetTauID("byMediumIsolationMVA3newDMwLT") : 0.;
        lbyVTightIsolationMVA3newDMwLT_2 = tau2->HasTauID("byVTightIsolationMVA3newDMwLT") ? tau2->GetTauID("byVTightIsolationMVA3newDMwLT") : 0.;
        lbyTightIsolationMVA3newDMwLT_2 = tau2->HasTauID("byTightIsolationMVA3newDMwLT") ? tau2->GetTauID("byTightIsolationMVA3newDMwLT") : 0.;
