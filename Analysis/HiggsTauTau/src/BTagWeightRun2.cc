...
namespace ic {
  ...
  int BTagWeightRun2::PreAnalysis() {
    ...
    else if ((strategy_ == strategy::cpsummer17 || strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays18) && use_deep_csv_) csv_file_path = "./input/btag_sf/DeepCSV_94XSF_V3_B_F.csv";
    else if ((strategy_ == strategy::cpsummer17 || strategy_ == strategy::cpdecays17 || strategy_ == strategy::cpdecays18) && !use_deep_csv_) csv_file_path = "./input/btag_sf/CSVv2_94XSF_V2_B_F.csv";
