...
//-------------------------------------leading tau--------------------
    ...
    //New variables by Mohammad
     ...
     //------------------EnergyFraction-------------------- 
        ...
        if(gammas1.size()>=1) Ptgamma1_1_ = gammas1[0]->pt();
        if(gammas1.size()>=2) Ptgamma2_1_ = gammas1[1]->pt();
        if(gammas1.size()>=3) Ptgamma3_1_ = gammas1[2]->pt();
        if(gammas1.size()>=4) Ptgamma4_1_ = gammas1[3]->pt();
