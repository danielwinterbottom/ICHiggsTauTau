...
def main(args):
    ...
    for channel in channels:
        with PdfPages("outputs/SF_plots_{}Channel_{}_{}DM_{}.pdf".format(channel, args.year ,args.DM_type, args.pred_using)) as pdf:
            for num in DM_nums:    
                datacard_pass = ROOT.TFile.Open("{}/{}/{}/datacard_pt_2_pass_{}DM{}_mt_{}.root".format(channel, args.pred_using, args.year, args.DM_type, num, args.year), "READ")
                datacard_total = ROOT.TFile.Open("{}/{}/{}/datacard_pt_2_total_{}DM{}_mt_{}.root".format(channel, args.pred_using, args.year, args.DM_type, num, args.year), "READ")
                ...
                title = "Turn-ons: {} DM {}  Channel".format(args.DM_type.upper(), num)
