...
int main(int argc, char* argv[]){
  ...
  infile1.open("ZeroBias3Eta3.dat");
  ...
  infile2.open("ZeroBias3Eta5.dat");
  ...
  std::string outputfilename = Form("/vols/cms02/dw515/l1t-integration-v58pt1/ZeroBias/BothSumRanges/EventTree3_%d.root", num);
