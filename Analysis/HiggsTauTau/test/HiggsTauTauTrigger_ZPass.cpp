...
#include "Modules/interface/ZPass.h"
...
*/
  ...
  ZPass zTotal = ZPass("ZPass", channel_str, fs, l1Cuts, L1_Muon_branch, "Total");
  ZPass zPass = ZPass("ZPass", channel_str, fs, l1Cuts, L1_Muon_branch, "Pass");
  // ------------------------------------------------------------------------------------
