...
int main(int argc, char* argv[]){
  ...
  infile1.open("chi200_stau195_lsp190_Eta3.dat");
  ...
  infile2.open("chi200_stau195_lsp190_Eta5.dat");
  ...
  std::string outputfilename = Form("/vols/cms02/dw515/l1t-integration-v58pt1/SusyVBF/chi200_stau195_lsp190/BothSumRanges/EventTree_%d.root", num);
