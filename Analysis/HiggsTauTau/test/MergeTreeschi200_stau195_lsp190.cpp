...
int main(int argc, char* argv[]){
  ...
  infile1.open("chi200_stau195_lsp190Eta3.dat");
  ...
  infile2.open("chi200_stau195_lsp190Eta5.dat");
  ...
  std::string outputfilename = Form("/vols/cms02/dw515/l1t-tsg-v5/SusyVBF/chi200_stau195_lsp190/BothSumRanges/EventTree_%d.root", num);
