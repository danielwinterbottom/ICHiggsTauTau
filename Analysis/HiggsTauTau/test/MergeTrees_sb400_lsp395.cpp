...
int main(int argc, char* argv[]){
  ...
  infile1.open("sb400_lsp395Eta3.dat");
  ...
  infile2.open("sb400_lsp395Eta5.dat");
  ...
  std::string outputfilename = Form("/vols/cms02/dw515/l1t-tsg-v5/SusyVBF/sb400_lsp395/BothSumRanges/EventTree_%d.root", num);
