...
int main(int argc, char* argv[]){
  ...
  infile1.open("ZeroBias0Eta3.dat");
  ...
  infile2.open("ZeroBias0Eta5.dat");
  ...
  std::string outputfilename = Form("/vols/cms02/dw515/l1t-integration-v58pt1/ZeroBias/BothSumRanges/EventTree0_%d.root", num);
