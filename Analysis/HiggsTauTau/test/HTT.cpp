...
//  analysis.DoSkimming("./skim/");
  ...
  for (unsigned i = 0; i < js["job"]["channels"].size(); ++i) {
    ...
    if(is_data &&  ( (channel_str.find("em") != channel_str.npos && output_name.find("MuonEG")==output_name.npos )|| (channel_str.find("mt") != channel_str.npos && output_name.find("SingleMuon") == output_name.npos ) || (channel_str.find("et") != channel_str.npos && output_name.find("SingleEle") == output_name.npos ) || (channel_str.find("tt") != channel_str.npos && output_name.find("Tau") == output_name.npos) || (channel_str.find("zmm") != channel_str.npos && output_name.find("SingleMuon") == output_name.npos ) || (channel_str.find("tpzmm") != channel_str.npos && output_name.find("SingleMuon") == output_name.npos ) || (channel_str.find("zee") != channel_str.npos && output_name.find("SingleEle") == output_name.npos ) || (channel_str.find("tpzee") != channel_str.npos && output_name.find("SingleEle") == output_name.npos ) )) continue; 
    
    if(is_embedded &&  ( (channel_str.find("em") != channel_str.npos && output_name.find("EmbeddingElMu")==output_name.npos )|| (channel_str.find("mt") != channel_str.npos && output_name.find("EmbeddingMuTau") == output_name.npos ) || (channel_str.find("et") != channel_str.npos && output_name.find("EmbeddingElTau") == output_name.npos ) || (channel_str.find("tt") != channel_str.npos && output_name.find("EmbeddingTauTau") == output_name.npos) || (channel_str.find("tpzmm") != channel_str.npos && output_name.find("EmbeddingMuMu") == output_name.npos ) ||  (channel_str.find("tpzee") != channel_str.npos && output_name.find("EmbeddingElEl") == output_name.npos ) )) continue; 
