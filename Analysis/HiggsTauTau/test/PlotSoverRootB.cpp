...
//  double iso_cuts[10]={0.12,0.13,0.14,0.15,0.16,0.17,0.18,0.19,0.20,0.21};
 ...
 //double iso_cuts[12];
 if(channel!="em"){
   double iso_cuts_fill[3]={0.05,0.1,0.15};
...
if(channel!="em"){
  ztt_sig_db04[0] = calcSoverRootB(file, (channel+"_puw04iso0p05").c_str(),true).first;
  ztt_sig_db04[1] = calcSoverRootB(file, (channel+"_puw04iso0p1").c_str(),true).first;
  ztt_sig_db04[2] = calcSoverRootB(file, (channel+"_puw04iso0p15").c_str(),true).first;

  ztt_sig_err_db04[0] = calcSoverRootB(file, (channel+"_puw04iso0p05").c_str(),true).second;
  ztt_sig_err_db04[1] = calcSoverRootB(file, (channel+"_puw04iso0p1").c_str(),true).second;
  ztt_sig_err_db04[2] = calcSoverRootB(file, (channel+"_puw04iso0p15").c_str(),true).second;

  ztt_sig_db03[0] = calcSoverRootB(file, (channel+"_puw03iso0p05").c_str(),true).first;
  ztt_sig_db03[1] = calcSoverRootB(file, (channel+"_puw03iso0p1").c_str(),true).first;
  ztt_sig_db03[2] = calcSoverRootB(file, (channel+"_puw03iso0p15").c_str(),true).first;

  ztt_sig_err_db03[0] = calcSoverRootB(file, (channel+"_puw03iso0p05").c_str(),true).second;
  ztt_sig_err_db03[1] = calcSoverRootB(file, (channel+"_puw03iso0p1").c_str(),true).second;
  ztt_sig_err_db03[2] = calcSoverRootB(file, (channel+"_puw03iso0p15").c_str(),true).second;
...
/*  ztt_sig_ea03[0] = calcSoverRootB(file, (channel+"_trk03iso0p02").c_str(),true).first;
  ...
  ztt_sig_ea03[4] = calcSoverRootB(file, (channel+"_trk03iso0p06").c_str(),true).first;

  ztt_sig_err_ea03[0] = calcSoverRootB(file, (channel+"_trk03iso0p02").c_str(),true).second;
  ztt_sig_err_ea03[1] = calcSoverRootB(file, (channel+"_trk03iso0p03").c_str(),true).second;
...
*/
  ...
  ztt_sig_db04[0] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p05").c_str(),true).first;
  ztt_sig_db04[1] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p1").c_str(),true).first;
  ztt_sig_db04[2] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p15").c_str(),true).first;

  ztt_sig_err_db04[0] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p05").c_str(),true).second;
  ztt_sig_err_db04[1] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p1").c_str(),true).second;
  ztt_sig_err_db04[2] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw04iso0p15").c_str(),true).second;

  ztt_sig_db03[0] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p05").c_str(),true).first;
  ztt_sig_db03[1] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p1").c_str(),true).first;
  ztt_sig_db03[2] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p15").c_str(),true).first;

  ztt_sig_err_db03[0] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p05").c_str(),true).second;
  ztt_sig_err_db03[1] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p1").c_str(),true).second;
  ztt_sig_err_db03[2] = calcSoverRootB(file, (channel+"_"+e_or_m+"puw03iso0p15").c_str(),true).second;
...
if(channel=="et"){
  ...
  ztt_sig_db04_graph->GetYaxis()->SetRangeUser(50,66);
}
...
// ztt_sig_db03_graph->SetTitle(";Isolation cut;S/#sqrt{B}");
...
/*  leg->AddEntry(ztt_sig_loosem_graph,"antiMuLoose","p");
  ...
  leg->AddEntry(ztt_sig_db04_graph,"PF weighted (cs 0.4)","p");
/*  if(channel=="et"||(channel=="em" && e_or_m=="e")){
 ...
 // leg->AddEntry(ztt_sig_db04allch_graph,"DBeta corr, allcharged (cs 0.4)","p");
  ...
  leg->AddEntry(ztt_sig_db03_graph,"PF weighted (cs 0.3)","p");
 ...
 // plot_canv.SetGrid(1,1);
  ...
  plot_canv.SaveAs(("s_over_root_b_"+channel+"_"+e_or_m+"PUW.pdf").c_str());
 } else{
  if(!iso_opt){
    hempty.Draw();
