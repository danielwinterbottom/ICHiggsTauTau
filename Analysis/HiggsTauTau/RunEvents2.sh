...
#./bin/HiggsTauTauTrigger --cfg=./scripts/Trigger_2016.cfg --filelist=ZeroBiasv5.dat --channel=tt --is_data=0 --output_name=RateVsEffV5/ZBttOutput_${SGE_TASK_ID}.root --line=${SGE_TASK_ID} --zb=1 --l1input=InputTauTauTriggers.txt
...
#./bin/HiggsTauTauTrigger --cfg=./scripts/Trigger_2016.cfg --filelist=ZeroBiasv5.dat --channel=et --is_data=0 --output_name=RateVsEffV5/ZBetOutput_${SGE_TASK_ID}.root --line=${SGE_TASK_ID} --zb=1 --l1input=InputTauElecTriggers.txt
