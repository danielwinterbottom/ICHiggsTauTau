...
void RecoilCorrector::metDistributionType2(double &iMet,double &iMPhi,double iGenPt,double iGenPhi,
  ...
  if(iFluc != 0 || iScale != 0) { 
    ...
    // double lEUS1_1  = getError(iGenPt,iU1S1ZDatFit,PFS1U1); // unused
    // double lEUS1_2  = getError(iGenPt,iU1S2ZDatFit,PFS2U1); // unused
    double lEU1Frac = getError(iGenPt,iU1MSZDatFit,PFMSU1);
    // double lEUS2_1  = getError(iGenPt,iU2S1ZDatFit,PFS1U2); // unused
    // double lEUS2_2  = getError(iGenPt,iU2S2ZDatFit,PFS2U2); // unused
    double lEU2Frac = getError(iGenPt,iU2MSZDatFit,PFMSU2);
  ...
  // double pTU1Diff        = pU1Diff; // unused
