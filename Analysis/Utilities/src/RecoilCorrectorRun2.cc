...
RecoilCorrectorRun2::RecoilCorrectorRun2(TString fileName) {
...
RecoilCorrectorRun2::~RecoilCorrectorRun2() {

}

void RecoilCorrectorRun2::InitMEtWeights(TFile * _file,
				     TString  _perpZStr,
				     TString  _paralZStr,
				     int nZPtBins,
				     float * ZPtBins,
...
void RecoilCorrectorRun2::InitMEtWeights(TFile * _fileMet,
...
void RecoilCorrectorRun2::Correct(float MetPx,
			      float MetPy,
			      float genVPx, 
			      float genVPy,
			      float visVPx,
...
float RecoilCorrectorRun2::CorrectionsBySampling(float x, TF1 * funcMC, TF1 * funcData) {
...
void RecoilCorrectorRun2::U1U2CorrectionsByWidth(float & U1, 
					     float & U2,
					     int ZptBin,
					     int njets) {
...
float RecoilCorrectorRun2::rescale(float x,
			       float meanData, 
			       float meanMC,
...
void RecoilCorrectorRun2::CalculateU1U2FromMet(float metPx,
					   float metPy,
					   float genZPx,
					   float genZPy,
					   float diLepPx,
