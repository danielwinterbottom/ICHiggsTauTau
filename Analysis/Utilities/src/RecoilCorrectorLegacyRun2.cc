...
RecoilCorrectorLegacyRun2::RecoilCorrectorLegacyRun2(TString fileName) {
...
RecoilCorrectorLegacyRun2::~RecoilCorrectorLegacyRun2() {

}

void RecoilCorrectorLegacyRun2::InitMEtWeights(TFile * _file,
                     TString  _perpZStr,
                     TString  _paralZStr,
                     int nZPtBins,
                     float * ZPtBins,
...
void RecoilCorrectorLegacyRun2::InitMEtWeights(TFile * _fileMet,
...
void RecoilCorrectorLegacyRun2::CorrectWithHist(float MetPx,
                  float MetPy,
                  float genVPx, 
                  float genVPy,
                  float visVPx,
...
void RecoilCorrectorLegacyRun2::CorrectByMeanResolution(float MetPx,
                          float MetPy,
                          float genVPx, 
                          float genVPy,
                          float visVPx,
...
float RecoilCorrectorLegacyRun2::CorrectionsBySampling(float x, TF1 * funcMC, TF1 * funcData) {
...
void RecoilCorrectorLegacyRun2::U1U2CorrectionsByWidth(Double_t & U1, 
                         Double_t & U2,
                         int ZptBin,
                         int njets) {
...
float RecoilCorrectorLegacyRun2::rescale(float x,
                   float meanData, 
                   float meanMC,
...
void RecoilCorrectorLegacyRun2::CalculateU1U2FromMet(float metPx,
                       float metPy,
                       float genZPx,
                       float genZPy,
                       float diLepPx,
...
void RecoilCorrectorLegacyRun2::CalculateMetFromU1U2(float U1,
                       float U2,
                       float genZPx,
                       float genZPy,
                       float diLepPx,
