...
ROOT::Math::SMatrix<double,3,3, ROOT::Math::MatRepStd< double, 3, 3 >> ImpactParameter::CalculatePCACovariance(ROOT::Math::SMatrix<double,5,5, ROOT::Math::MatRepSym<double,5>> helixCovariance, SMatrixSym3D primaryVertexCovariance)
{
	...
	*/
	...
	ROOT::Math::SMatrix<double,3,5, ROOT::Math::MatRepStd< double, 3, 5 >> jacobiOprime;
	/*
	...
	*/
	...
	ROOT::Math::SMatrix<double,3,3, ROOT::Math::MatRepStd< double, 3, 3 >> OprimeCovariance = jacobiOprime * helixCovariance * ROOT::Math::Transpose(jacobiOprime);

	///
	ROOT::Math::SMatrix<double,4,5, ROOT::Math::MatRepStd< double, 4, 5 >> jacobiHelixpar;
	/* dRadius/dqOverP */
	...
	ROOT::Math::SMatrix<double,4,4, ROOT::Math::MatRepStd< double, 4, 4 >> parameterCovariance_ = jacobiHelixpar * helixCovariance * ROOT::Math::Transpose(jacobiHelixpar);

	ROOT::Math::SMatrix<double,7,7, ROOT::Math::MatRepSym< double, 7 >> parameterCovariance;
	...
	ROOT::Math::SMatrix<double,3,7, ROOT::Math::MatRepStd< double, 3, 7 >> jacobiPointOnHelix;
	...
	ROOT::Math::SMatrix<double,3,3, ROOT::Math::MatRepStd< double, 3, 3 >> pointOnHelixCovariance = jacobiPointOnHelix * parameterCovariance * ROOT::Math::Transpose(jacobiPointOnHelix);
