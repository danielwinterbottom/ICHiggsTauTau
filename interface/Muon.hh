...
namespace ic {
  ...
  class Muon : public Candidate {
    ...
    public:
      ...
      inline void set_gen_particles(
          std::vector<std::size_t> const& gen_particles) {
        gen_particles_ = gen_particles;
      }

      inline Point const& ref_point() const { return ref_point_; }
      inline void set_ref_point(Point const& ref_point) {
      ...
      inline void set_is_global(bool const& is_global) {
      ...
      inline void set_dr03_hcal_tower_sum_et(
          float const& dr03_hcal_tower_sum_et) {
      ...
      inline void set_dr03_pfiso_charged_all(
          float const& dr03_pfiso_charged_all) {
      ...
      inline void set_dr04_pfiso_charged_all(
          float const& dr04_pfiso_charged_all) {
      ...
      inline void set_dz_vertex(double const& dz_vertex) {
        dz_vertex_ = dz_vertex;
      }
