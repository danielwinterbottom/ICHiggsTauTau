...
class Electron : public Candidate {
 ...
 public:
  ...
  /** PF isolation, using all charged particles in a cone with \f$ \Delta R
   * = 0.3 \f$ */
  ...
  /** PF isolation, using charged hadrons in a cone with \f$ \Delta R = 0.3
   * \f$ */
  ...
  /** PF isolation, using neutral hadrons in a cone with \f$ \Delta R = 0.3
   * \f$ */
  ...
  /** PF isolation, using charged pileup in a cone with \f$ \Delta R = 0.3
   * \f$ */
  ...
  /** PF isolation, using charged hadrons in a cone with \f$ \Delta R = 0.4
   * \f$ */
  ...
  /** PF isolation, using neutral hadrons in a cone with \f$ \Delta R = 0.4
   * \f$ */
  ...
  /** PF isolation, using charged pileup in a cone with \f$ \Delta R = 0.4
   * \f$ */
