...
icEventInfoProducer = cms.EDProducer('ICEventInfoProducer',
  ...
  lheSource           = cms.string("externalLHEProducer"),
  includeLHEWeights   = cms.bool(False),
  includeGenWeights   = cms.bool(False),
  includenpNLO        = cms.bool(False),
  includeHTXS         = cms.bool(False),
  includeEmbeddingWeights = cms.bool(False),
