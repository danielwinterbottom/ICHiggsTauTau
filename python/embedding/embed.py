...
# with command line options: UserCode/ICHiggsTauTau/PFEmbeddingSource_Wemb_cff.py --customise=UserCode/ICHiggsTauTau/pf_01_customizeAll.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v3,RAW2DIGI,RECO --no_exec --conditions auto:startup_7E33v3 --fileout=embedded.root --python_filename=embed.py -n -1
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/a/amagnan/CMSSW_5_3_11_patch6/src/UserCode/ICHiggsTauTau/python/skimmed.root')
)
