...
# with command line options: UserCode/ICHiggsTauTau/PFEmbeddingSource_Wemb_cff.py --customise=UserCode/ICHiggsTauTau/pf_01_customizeAll.py -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,RECO --no_exec --conditions auto:startup_7E33v3 --fileout=embedded_data.root --python_filename=skimAndEmbed_data.py -n 1000
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/a/amagnan/CMSSW_5_3_11_patch6/src/UserCode/ICHiggsTauTau/python/testFile_run2012A.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('UserCode/ICHiggsTauTau/PFEmbeddingSource_Wemb_cff.py nevts:1000'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('embedded_data.root'),
...
process.generator = cms.EDProducer("MCParticleReplacer",
    src = cms.InputTag("adaptedMuonsFromWmunu","wMusExtracted"),
    beamSpotSrc = cms.InputTag("dummy"),
    hepMcMode = cms.string('new'),
    verbose = cms.bool(False),
    algorithm = cms.string('ZTauTau'),
