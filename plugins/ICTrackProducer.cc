...
void ICTrackProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  for (iter = ptr_set.begin(); iter != ptr_set.end(); ++iter) {
    ...
    cand_vec->push_back(ic::Track());
    ic::Track & cand = cand_vec->back();
    //Set candidate data
...
void ICTrackProducer::beginRun(edm::Run&, edm::EventSetup const&) {
}

// ------------ method called when ending the processing of a run  ------------
void ICTrackProducer::endRun(edm::Run&, edm::EventSetup const&) {
}

// ------------ method called when starting to processes a luminosity block  ------------
void ICTrackProducer::beginLuminosityBlock(edm::LuminosityBlock&, 
                                             edm::EventSetup const&) {
}

// ------------ method called when ending the processing of a luminosity block  ------------
void ICTrackProducer::endLuminosityBlock(edm::LuminosityBlock&, 
                                           edm::EventSetup const&) {
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
ICTrackProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
